...
const btnOpenAccountRecords = document.getElementById(
  'btn-open-account-records'
)
...
const accountRecordsPageLabel = document.getElementById(
  'account-records-page-label'
)
const btnAccountRecordsPrev = document.getElementById(
  'btn-account-records-prev'
)
const btnAccountRecordsNext = document.getElementById(
  'btn-account-records-next'
)
const btnCloseAccountRecords = document.getElementById(
  'btn-close-account-records'
)
const btnClearAccountRecords = document.getElementById(
  'btn-clear-account-records'
)
const btnToggleAccountRecordsSelection = document.getElementById(
  'btn-toggle-account-records-selection'
)
const btnDeleteSelectedAccountRecords = document.getElementById(
  'btn-delete-selected-account-records'
)
...
const inputContributionNickname = document.getElementById(
  'input-contribution-nickname'
)
const inputContributionQq = document.getElementById('input-contribution-qq')
const contributionOauthStatus = document.getElementById(
  'contribution-oauth-status'
)
const contributionCallbackStatus = document.getElementById(
  'contribution-callback-status'
)
const contributionModeSummary = document.getElementById(
  'contribution-mode-summary'
)
const btnStartContribution = document.getElementById('btn-start-contribution')
const btnOpenContributionUpload = document.getElementById(
  'btn-open-contribution-upload'
)
const btnExitContributionMode = document.getElementById(
  'btn-exit-contribution-mode'
)
...
const contributionUpdateLayer = document.getElementById(
  'contribution-update-layer'
)
const contributionUpdateHint = document.getElementById(
  'contribution-update-hint'
)
const contributionUpdateHintText = document.getElementById(
  'contribution-update-hint-text'
)
const btnDismissContributionUpdateHint = document.getElementById(
  'btn-dismiss-contribution-update-hint'
)
...
const btnAutoCancelSchedule = document.getElementById(
  'btn-auto-cancel-schedule'
)
...
const inputImportSettingsFile = document.getElementById(
  'input-import-settings-file'
)
...
const localCpaStep9ModeButtons = Array.from(
  document.querySelectorAll('[data-local-cpa-step9-mode]')
)
...
const inputSub2ApiDefaultProxy = document.getElementById(
...
const btnToggleIpProxySection = document.getElementById(
  'btn-toggle-ip-proxy-section'
)
const ipProxyEnabledStatus = document.getElementById('ip-proxy-enabled-status')
const ipProxyEnabledStatusDot = document.getElementById(
  'ip-proxy-enabled-status-dot'
)
const ipProxyEnabledStatusText = document.getElementById(
  'ip-proxy-enabled-status-text'
)
const ipProxyEnabledButtons = Array.from(
  document.querySelectorAll('[data-ip-proxy-enabled]')
)
...
const btnIpProxyServiceLogin = document.getElementById(
  'btn-ip-proxy-service-login'
)
const rowIpProxyMode = document.getElementById('row-ip-proxy-mode')
const ipProxyModeButtons = Array.from(
  document.querySelectorAll('[data-ip-proxy-mode]')
)
...
const btnToggleIpProxyApiUrl = document.getElementById(
  'btn-toggle-ip-proxy-api-url'
)
const rowIpProxyAccountList = document.getElementById(
  'row-ip-proxy-account-list'
)
const inputIpProxyAccountList = document.getElementById(
  'input-ip-proxy-account-list'
)
const rowIpProxyAccountSessionPrefix = document.getElementById(
  'row-ip-proxy-account-session-prefix'
)
const inputIpProxyAccountSessionPrefix = document.getElementById(
  'input-ip-proxy-account-session-prefix'
)
const rowIpProxyAccountLifeMinutes = document.getElementById(
  'row-ip-proxy-account-life-minutes'
)
const inputIpProxyAccountLifeMinutes = document.getElementById(
  'input-ip-proxy-account-life-minutes'
)
const rowIpProxyPoolTargetCount = document.getElementById(
  'row-ip-proxy-pool-target-count'
)
const inputIpProxyPoolTargetCount = document.getElementById(
  'input-ip-proxy-pool-target-count'
)
const rowIpProxyAutoSyncEnabled = document.getElementById(
  'row-ip-proxy-auto-sync-enabled'
)
const inputIpProxyAutoSyncEnabled = document.getElementById(
  'input-ip-proxy-auto-sync-enabled'
)
const rowIpProxyAutoSyncInterval = document.getElementById(
  'row-ip-proxy-auto-sync-interval'
)
const inputIpProxyAutoSyncIntervalMinutes = document.getElementById(
  'input-ip-proxy-auto-sync-interval-minutes'
)
...
const selectIpProxyProtocol = document.getElementById(
  'select-ip-proxy-protocol'
)
...
const btnToggleIpProxyUsername = document.getElementById(
  'btn-toggle-ip-proxy-username'
)
...
const btnToggleIpProxyPassword = document.getElementById(
  'btn-toggle-ip-proxy-password'
)
...
const rowIpProxyRuntimeStatus = document.getElementById(
...
const ipProxyRuntimeDetails = document.getElementById(
  'ip-proxy-runtime-details'
)
const ipProxyRuntimeDetailsText = document.getElementById(
...
const inputCodex2ApiAdminKey = document.getElementById(
  'input-codex2api-admin-key'
)
...
const selectPlusPaymentMethod = document.getElementById(
  'select-plus-payment-method'
)
const btnGpcCardKeyPurchase = document.getElementById(
  'btn-gpc-card-key-purchase'
)
const plusPaymentMethodCaption = document.getElementById(
  'plus-payment-method-caption'
)
...
const btnGpcHelperConvertApiKey = document.getElementById(
  'btn-gpc-helper-convert-api-key'
)
const rowGpcHelperCardKey = document.getElementById('row-gpc-helper-card-key')
const inputGpcHelperCardKey = document.getElementById(
  'input-gpc-helper-card-key'
)
const btnToggleGpcHelperCardKey = document.getElementById(
  'btn-toggle-gpc-helper-card-key'
)
const btnGpcHelperBalance = document.getElementById('btn-gpc-helper-balance')
const displayGpcHelperBalance = document.getElementById(
  'display-gpc-helper-balance'
)
const rowGpcHelperPhoneMode = document.getElementById(
  'row-gpc-helper-phone-mode'
)
const selectGpcHelperPhoneMode = document.getElementById(
  'select-gpc-helper-phone-mode'
)
const rowGpcHelperCountryCode = document.getElementById(
  'row-gpc-helper-country-code'
)
const selectGpcHelperCountryCode = document.getElementById(
  'select-gpc-helper-country-code'
)
...
const rowGpcHelperOtpChannel = document.getElementById(
  'row-gpc-helper-otp-channel'
)
const selectGpcHelperOtpChannel = document.getElementById(
  'select-gpc-helper-otp-channel'
)
const rowGpcHelperLocalSmsEnabled = document.getElementById(
  'row-gpc-helper-local-sms-enabled'
)
const inputGpcHelperLocalSmsEnabled = document.getElementById(
  'input-gpc-helper-local-sms-enabled'
)
const rowGpcHelperLocalSmsUrl = document.getElementById(
  'row-gpc-helper-local-sms-url'
)
const inputGpcHelperLocalSmsUrl = document.getElementById(
...
const btnToggleGpcHelperPin = document.getElementById(
  'btn-toggle-gpc-helper-pin'
)
const rowGoPayCountryCode = document.getElementById('row-gopay-country-code')
const selectGoPayCountryCode = document.getElementById(
  'select-gopay-country-code'
)
...
const rowCustomMailProviderPool = document.getElementById(
  'row-custom-mail-provider-pool'
)
const inputCustomMailProviderPool = document.getElementById(
  'input-custom-mail-provider-pool'
)
const rowMail2925Mode = document.getElementById('row-mail-2925-mode')
const rowMail2925PoolSettings = document.getElementById(
  'row-mail2925-pool-settings'
)
const mail2925ModeButtons = Array.from(
  document.querySelectorAll('[data-mail2925-mode]')
)
...
const btnCustomEmailPoolRefresh = document.getElementById(
  'btn-custom-email-pool-refresh'
)
const btnCustomEmailPoolClearUsed = document.getElementById(
  'btn-custom-email-pool-clear-used'
)
const btnCustomEmailPoolDeleteAll = document.getElementById(
  'btn-custom-email-pool-delete-all'
)
const inputCustomEmailPoolImport = document.getElementById(
  'input-custom-email-pool-import'
)
const btnCustomEmailPoolImport = document.getElementById(
  'btn-custom-email-pool-import'
)
const customEmailPoolSummary = document.getElementById(
  'custom-email-pool-summary'
)
const inputCustomEmailPoolSearch = document.getElementById(
  'input-custom-email-pool-search'
)
const selectCustomEmailPoolFilter = document.getElementById(
  'select-custom-email-pool-filter'
)
const checkboxCustomEmailPoolSelectAll = document.getElementById(
  'checkbox-custom-email-pool-select-all'
)
const customEmailPoolSelectionSummary = document.getElementById(
  'custom-email-pool-selection-summary'
)
const btnCustomEmailPoolBulkUsed = document.getElementById(
  'btn-custom-email-pool-bulk-used'
)
const btnCustomEmailPoolBulkUnused = document.getElementById(
  'btn-custom-email-pool-bulk-unused'
)
const btnCustomEmailPoolBulkEnable = document.getElementById(
  'btn-custom-email-pool-bulk-enable'
)
const btnCustomEmailPoolBulkDisable = document.getElementById(
  'btn-custom-email-pool-bulk-disable'
)
const btnCustomEmailPoolBulkDelete = document.getElementById(
...
const inputTempEmailBaseUrl = document.getElementById(
  'input-temp-email-base-url'
)
const rowTempEmailAdminAuth = document.getElementById(
  'row-temp-email-admin-auth'
)
const inputTempEmailAdminAuth = document.getElementById(
  'input-temp-email-admin-auth'
)
const rowTempEmailCustomAuth = document.getElementById(
  'row-temp-email-custom-auth'
)
const inputTempEmailCustomAuth = document.getElementById(
  'input-temp-email-custom-auth'
)
const rowTempEmailReceiveMailbox = document.getElementById(
  'row-temp-email-receive-mailbox'
)
const inputTempEmailReceiveMailbox = document.getElementById(
  'input-temp-email-receive-mailbox'
)
const rowTempEmailRandomSubdomainToggle = document.getElementById(
  'row-temp-email-random-subdomain-toggle'
)
const inputTempEmailUseRandomSubdomain = document.getElementById(
  'input-temp-email-use-random-subdomain'
)
const rowTempEmailDomain = document.getElementById('row-temp-email-domain')
const selectTempEmailDomain = document.getElementById(
  'select-temp-email-domain'
)
const tempEmailDomainPickerRoot = document.getElementById(
  'temp-email-domain-picker'
)
const btnTempEmailDomainMenu = document.getElementById(
  'btn-temp-email-domain-menu'
)
const tempEmailDomainCurrent = document.getElementById(
  'temp-email-domain-current'
)
...
const btnTempEmailDomainMode = document.getElementById(
  'btn-temp-email-domain-mode'
)
const cloudflareTempEmailSection = document.getElementById(
  'cloudflare-temp-email-section'
)
const btnCloudflareTempEmailUsageGuide = document.getElementById(
  'btn-cloudflare-temp-email-usage-guide'
)
const btnCloudflareTempEmailGithub = document.getElementById(
  'btn-cloudflare-temp-email-github'
)
...
const rowCloudMailAdminEmail = document.getElementById(
  'row-cloud-mail-admin-email'
)
const rowCloudMailAdminPassword = document.getElementById(
  'row-cloud-mail-admin-password'
)
const rowCloudMailReceiveMailbox = document.getElementById(
  'row-cloud-mail-receive-mailbox'
)
const rowCloudMailDomain = document.getElementById('row-cloud-mail-domain')
const inputCloudMailBaseUrl = document.getElementById(
  'input-cloud-mail-base-url'
)
const inputCloudMailAdminEmail = document.getElementById(
  'input-cloud-mail-admin-email'
)
const inputCloudMailAdminPassword = document.getElementById(
  'input-cloud-mail-admin-password'
)
const inputCloudMailReceiveMailbox = document.getElementById(
...
const selectIcloudHostPreference = document.getElementById(
  'select-icloud-host-preference'
)
const rowIcloudTargetMailboxType = document.getElementById(
  'row-icloud-target-mailbox-type'
)
const selectIcloudTargetMailboxType = document.getElementById(
  'select-icloud-target-mailbox-type'
)
const rowIcloudForwardMailProvider = document.getElementById(
  'row-icloud-forward-mail-provider'
)
...
const checkboxIcloudSelectAll = document.getElementById(
  'checkbox-icloud-select-all'
)
const icloudSelectionSummary = document.getElementById(
  'icloud-selection-summary'
)
...
const btnIcloudBulkPreserve = document.getElementById(
  'btn-icloud-bulk-preserve'
)
const btnIcloudBulkUnpreserve = document.getElementById(
  'btn-icloud-bulk-unpreserve'
)
const btnIcloudBulkDelete = document.getElementById('btn-icloud-bulk-delete')
const rowHotmailServiceMode = document.getElementById(
  'row-hotmail-service-mode'
)
const hotmailServiceModeButtons = Array.from(
  document.querySelectorAll('[data-hotmail-service-mode]')
)
const rowHotmailRemoteBaseUrl = document.getElementById(
  'row-hotmail-remote-base-url'
)
const inputHotmailRemoteBaseUrl = document.getElementById(
  'input-hotmail-remote-base-url'
)
const rowHotmailLocalBaseUrl = document.getElementById(
  'row-hotmail-local-base-url'
)
const inputHotmailLocalBaseUrl = document.getElementById(
...
const inputHotmailRefreshToken = document.getElementById(
  'input-hotmail-refresh-token'
)
...
const btnImportHotmailAccounts = document.getElementById(
  'btn-import-hotmail-accounts'
)
...
const btnClearUsedHotmailAccounts = document.getElementById(
  'btn-clear-used-hotmail-accounts'
)
const btnDeleteAllHotmailAccounts = document.getElementById(
  'btn-delete-all-hotmail-accounts'
)
...
const btnAddMail2925Account = document.getElementById(
  'btn-add-mail2925-account'
)
const btnToggleMail2925Form = document.getElementById(
  'btn-toggle-mail2925-form'
)
const btnImportMail2925Accounts = document.getElementById(
  'btn-import-mail2925-accounts'
)
const btnDeleteAllMail2925Accounts = document.getElementById(
  'btn-delete-all-mail2925-accounts'
)
const btnToggleMail2925List = document.getElementById(
  'btn-toggle-mail2925-list'
)
...
const selectLuckmailEmailType = document.getElementById(
  'select-luckmail-email-type'
)
...
const btnLuckmailDisableUsed = document.getElementById(
  'btn-luckmail-disable-used'
)
...
const checkboxLuckmailSelectAll = document.getElementById(
  'checkbox-luckmail-select-all'
)
const luckmailSelectionSummary = document.getElementById(
  'luckmail-selection-summary'
)
const btnLuckmailBulkUsed = document.getElementById('btn-luckmail-bulk-used')
const btnLuckmailBulkUnused = document.getElementById(
  'btn-luckmail-bulk-unused'
)
const btnLuckmailBulkPreserve = document.getElementById(
  'btn-luckmail-bulk-preserve'
)
const btnLuckmailBulkUnpreserve = document.getElementById(
  'btn-luckmail-bulk-unpreserve'
)
const btnLuckmailBulkDisable = document.getElementById(
  'btn-luckmail-bulk-disable'
)
const btnLuckmailBulkEnable = document.getElementById(
  'btn-luckmail-bulk-enable'
)
...
const selectMail2925PoolAccount = document.getElementById(
  'select-mail2925-pool-account'
)
const inputMail2925UseAccountPool = document.getElementById(
  'input-mail2925-use-account-pool'
)
const labelMail2925UseAccountPool = document.getElementById(
  'label-mail2925-use-account-pool'
)
...
const inputAutoSkipFailures = document.getElementById(
  'input-auto-skip-failures'
)
const inputAutoSkipFailuresThreadIntervalMinutes = document.getElementById(
  'input-auto-skip-failures-thread-interval-minutes'
)
const inputStep6CookieCleanupEnabled = document.getElementById(
  'input-step6-cookie-cleanup-enabled'
)
const inputAutoDelayEnabled = document.getElementById(
  'input-auto-delay-enabled'
)
const inputAutoDelayMinutes = document.getElementById(
  'input-auto-delay-minutes'
)
const inputAutoStepDelaySeconds = document.getElementById(
  'input-auto-step-delay-seconds'
)
const inputOperationDelayEnabled = document.getElementById(
  'input-operation-delay-enabled'
)
const inputOAuthFlowTimeoutEnabled = document.getElementById(
  'input-oauth-flow-timeout-enabled'
)
const inputVerificationResendCount = document.getElementById(
  'input-verification-resend-count'
)
const rowPhoneVerificationEnabled = document.getElementById(
  'row-phone-verification-enabled'
)
const btnTogglePhoneVerificationSection = document.getElementById(
  'btn-toggle-phone-verification-section'
)
const rowPhoneVerificationFold = document.getElementById(
  'row-phone-verification-fold'
)
const inputPhoneVerificationEnabled = document.getElementById(
  'input-phone-verification-enabled'
)
...
const signupMethodButtons = Array.from(
  document.querySelectorAll('[data-signup-method]')
)
const selectPhoneSmsProvider = document.getElementById(
  'select-phone-sms-provider'
)
...
const rowHeroSmsCountryFallback = document.getElementById(
  'row-hero-sms-country-fallback'
)
const rowHeroSmsAcquirePriority = document.getElementById(
  'row-hero-sms-acquire-priority'
)
...
const rowPhoneSmsProviderOrder = document.getElementById(
  'row-phone-sms-provider-order'
)
const rowPhoneSmsProviderOrderActions = document.getElementById(
  'row-phone-sms-provider-order-actions'
)
...
const rowFiveSimCountryFallback = document.getElementById(
  'row-five-sim-country-fallback'
)
...
const rowNexSmsCountryFallback = document.getElementById(
  'row-nex-sms-country-fallback'
)
...
const rowSmsbowerCountryOrder = document.getElementById(
  'row-smsbower-country-order'
)
const rowSmsbowerServiceCode = document.getElementById(
  'row-smsbower-service-code'
)
const rowSmsbowerMaxPrice = document.getElementById('row-smsbower-max-price')
const rowHeroSmsRuntimePair = document.getElementById(
  'row-hero-sms-runtime-pair'
)
const rowHeroSmsCurrentNumber = document.getElementById(
  'row-hero-sms-current-number'
)
const rowHeroSmsCurrentCountdown = document.getElementById(
  'row-hero-sms-current-countdown'
)
const rowHeroSmsPriceTiers = document.getElementById('row-hero-sms-price-tiers')
const rowHeroSmsCurrentCode = document.getElementById(
  'row-hero-sms-current-code'
)
const rowHeroSmsPreferredActivation = document.getElementById(
  'row-hero-sms-preferred-activation'
)
const rowPhoneCodeSettingsGroup = document.getElementById(
  'row-phone-code-settings-group'
)
const rowPhoneVerificationResendCount = document.getElementById(
  'row-phone-verification-resend-count'
)
const rowPhoneReplacementLimit = document.getElementById(
  'row-phone-replacement-limit'
)
const rowPhoneCodeWaitSeconds = document.getElementById(
  'row-phone-code-wait-seconds'
)
const rowPhoneCodeTimeoutWindows = document.getElementById(
  'row-phone-code-timeout-windows'
)
const rowPhoneCodePollIntervalSeconds = document.getElementById(
  'row-phone-code-poll-interval-seconds'
)
const rowPhoneCodePollMaxRounds = document.getElementById(
  'row-phone-code-poll-max-rounds'
)
const rowFreePhoneReuseEnabled = document.getElementById(
  'row-free-phone-reuse-enabled'
)
const rowFreePhoneReuseAutoEnabled = document.getElementById(
  'row-free-phone-reuse-auto-enabled'
)
...
const btnToggleHeroSmsApiKey = document.getElementById(
  'btn-toggle-hero-sms-api-key'
)
const inputFiveSimApiKey = document.getElementById('input-five-sim-api-key')
const btnToggleFiveSimApiKey = document.getElementById(
  'btn-toggle-five-sim-api-key'
)
...
const btnToggleNexSmsApiKey = document.getElementById(
  'btn-toggle-nex-sms-api-key'
)
const inputNexSmsServiceCode = document.getElementById(
  'input-nex-sms-service-code'
)
const inputSmsbowerApiKey = document.getElementById('input-smsbower-api-key')
const btnToggleSmsbowerApiKey = document.getElementById(
  'btn-toggle-smsbower-api-key'
)
const inputSmsbowerBaseUrl = document.getElementById('input-smsbower-base-url')
const inputSmsbowerCountryOrder = document.getElementById(
  'input-smsbower-country-order'
)
const inputSmsbowerServiceCode = document.getElementById(
  'input-smsbower-service-code'
)
const inputSmsbowerMaxPrice = document.getElementById(
  'input-smsbower-max-price'
)
const inputHeroSmsMaxPrice = document.getElementById('input-hero-sms-max-price')
const inputHeroSmsPreferredPrice = document.getElementById(
  'input-hero-sms-preferred-price'
)
const inputPhoneReplacementLimit = document.getElementById(
  'input-phone-replacement-limit'
)
const inputPhoneCodeWaitSeconds = document.getElementById(
  'input-phone-code-wait-seconds'
)
const inputPhoneCodeTimeoutWindows = document.getElementById(
  'input-phone-code-timeout-windows'
)
const inputPhoneCodePollIntervalSeconds = document.getElementById(
  'input-phone-code-poll-interval-seconds'
)
const inputPhoneCodePollMaxRounds = document.getElementById(
  'input-phone-code-poll-max-rounds'
)
...
const selectHeroSmsAcquirePriority = document.getElementById(
  'select-hero-sms-acquire-priority'
)
const selectHeroSmsPreferredActivation = document.getElementById(
  'select-hero-sms-preferred-activation'
)
const selectFiveSimCountry = document.getElementById('select-five-sim-country')
const heroSmsCountryMenuShell = document.getElementById(
  'hero-sms-country-menu-shell'
)
const btnHeroSmsCountryMenu = document.getElementById(
  'btn-hero-sms-country-menu'
)
const heroSmsCountryMenu = document.getElementById('hero-sms-country-menu')
const btnHeroSmsCountryClear = document.getElementById(
  'btn-hero-sms-country-clear'
)
const fiveSimCountryMenuShell = document.getElementById(
  'five-sim-country-menu-shell'
)
const btnFiveSimCountryMenu = document.getElementById(
  'btn-five-sim-country-menu'
)
const fiveSimCountryMenu = document.getElementById('five-sim-country-menu')
const btnFiveSimCountryClear = document.getElementById(
  'btn-five-sim-country-clear'
)
const selectNexSmsCountry = document.getElementById('select-nex-sms-country')
const nexSmsCountryMenuShell = document.getElementById(
  'nex-sms-country-menu-shell'
)
...
const btnNexSmsCountryClear = document.getElementById(
  'btn-nex-sms-country-clear'
)
const selectPhoneSmsProviderOrder = document.getElementById(
  'select-phone-sms-provider-order'
)
const phoneSmsProviderOrderMenuShell = document.getElementById(
  'phone-sms-provider-order-menu-shell'
)
const btnPhoneSmsProviderOrderMenu = document.getElementById(
  'btn-phone-sms-provider-order-menu'
)
const phoneSmsProviderOrderMenu = document.getElementById(
  'phone-sms-provider-order-menu'
)
const btnPhoneSmsProviderOrderReset = document.getElementById(
  'btn-phone-sms-provider-order-reset'
)
const btnHeroSmsPricePreview = document.getElementById(
  'btn-hero-sms-price-preview'
)
const btnPhoneSmsBalance = document.getElementById('btn-phone-sms-balance')
const displayHeroSmsPlatform = document.getElementById(
  'display-hero-sms-platform'
)
const displayHeroSmsCurrentNumber = document.getElementById(
  'display-hero-sms-current-number'
)
const displayHeroSmsCurrentCountdown = document.getElementById(
  'display-hero-sms-current-countdown'
)
const displayHeroSmsPriceTiers = document.getElementById(
  'display-hero-sms-price-tiers'
)
const displayPhoneSmsBalance = document.getElementById(
  'display-phone-sms-balance'
)
const displayHeroSmsCurrentCode = document.getElementById(
  'display-hero-sms-current-code'
)
...
const displayFiveSimCountryFallbackOrder = document.getElementById(
  'display-five-sim-country-fallback-order'
)
const displayNexSmsCountryFallbackOrder = document.getElementById(
  'display-nex-sms-country-fallback-order'
)
...
const inputAccountRunHistoryHelperBaseUrl = document.getElementById(
...
const btnSharedFormModalClose = document.getElementById(
  'btn-shared-form-modal-close'
)
const sharedFormModalMessage = document.getElementById(
  'shared-form-modal-message'
)
const sharedFormModalAlert = document.getElementById('shared-form-modal-alert')
const sharedFormModalFields = document.getElementById(
  'shared-form-modal-fields'
)
const btnSharedFormModalCancel = document.getElementById(
  'btn-shared-form-modal-cancel'
)
const btnSharedFormModalConfirm = document.getElementById(
  'btn-shared-form-modal-confirm'
)
...
let STEP_IDS = stepDefinitions
  .map((step) => Number(step.id))
  .filter(Number.isFinite)
let STEP_DEFAULT_STATUSES = Object.fromEntries(
  STEP_IDS.map((stepId) => [stepId, 'pending'])
)
...
const HERO_SMS_SUPPORTED_COUNTRY_ID_SET = new Set(
  HERO_SMS_SUPPORTED_COUNTRY_ITEMS.map((item) => String(item.id))
)
...
const NEW_USER_GUIDE_PROMPT_DISMISSED_STORAGE_KEY =
  'multipage-new-user-guide-prompt-dismissed'
const AUTO_SKIP_FAILURES_PROMPT_DISMISSED_STORAGE_KEY =
  'multipage-auto-skip-failures-prompt-dismissed'
const AUTO_RUN_FALLBACK_RISK_PROMPT_DISMISSED_STORAGE_KEY =
  'multipage-auto-run-fallback-risk-prompt-dismissed'
const CPA_PHONE_SIGNUP_PROMPT_DISMISSED_STORAGE_KEY =
  'multipage-cpa-phone-signup-prompt-dismissed'
const CPA_PHONE_SIGNUP_WARNING_MESSAGE =
  'CPA 未适配手机号注册模式，认证成功后无法使用。请使用 SUB2API，或者认证成功后重新登录一遍进行解决。'
const PHONE_VERIFICATION_SECTION_EXPANDED_STORAGE_KEY =
  'multipage-phone-verification-section-expanded'
...
function getStepDefinitionsForMode(plusModeEnabled = false, options = {}) {
  const defaultFlowId =
    typeof DEFAULT_ACTIVE_FLOW_ID !== 'undefined'
  ...
  const activeFlowId =
    typeof options === 'string'
      ...
      : options.activeFlowId ||
        ...
        defaultFlowId
  return (
    window.MultiPageStepDefinitions?.getSteps?.({
      activeFlowId:
        String(activeFlowId || '')
          .trim()
          .toLowerCase() || defaultFlowId,
      plusModeEnabled,
...
function getStepIdByKeyForCurrentMode(stepKey = '') {
  ...
  const match = (stepDefinitions || []).find(
    (step) => String(step?.key || '') === normalizedKey
  )
...
function rebuildStepDefinitionState(plusModeEnabled = false, options = {}) {
  ...
  STEP_IDS = stepDefinitions
    .map((step) => Number(step.id))
    .filter(Number.isFinite)
  STEP_DEFAULT_STATUSES = Object.fromEntries(
    STEP_IDS.map((stepId) => [stepId, 'pending'])
  )
  SKIPPABLE_STEPS = new Set(STEP_IDS)
}
const CONTRIBUTION_CONTENT_PROMPT_DISMISSED_VERSION_STORAGE_KEY =
  'multipage-contribution-content-prompt-dismissed-version'
...
const FIVE_SIM_SUPPORTED_COUNTRY_ITEMS = Object.freeze([
  {
    ...
    chn: '印度尼西亚',
    eng: 'Indonesia',
    searchText: 'indonesia 印度尼西亚 印尼 Indonesia ID +62'
  },
  {
    id: 'thailand',
    chn: '泰国',
    eng: 'Thailand',
    searchText: 'thailand 泰国 Thailand TH +66'
  },
  {
    id: 'england',
    chn: '英国',
    eng: 'England',
    searchText: 'england 英国 England UK GB United Kingdom +44'
  },
  {
    id: 'usa',
    chn: '美国',
    eng: 'United States',
    searchText: 'usa 美国 United States US +1'
  },
  {
    id: 'japan',
    chn: '日本',
    eng: 'Japan',
    searchText: 'japan 日本 Japan JP +81'
  },
  {
    id: 'germany',
    chn: '德国',
    eng: 'Germany',
    searchText: 'germany 德国 Germany DE +49'
  },
  {
    id: 'vietnam',
    chn: '越南',
    eng: 'Vietnam',
    searchText: 'vietnam 越南 Vietnam VN +84'
  }
])
const FIVE_SIM_SUPPORTED_COUNTRY_ID_SET = new Set(
  FIVE_SIM_SUPPORTED_COUNTRY_ITEMS.map((item) => item.id)
)
...
const SUPPORTED_IP_PROXY_SERVICES = [
  '711proxy',
  'lumiproxy',
  'iproyal',
  'omegaproxy'
...
function isManagedAliasProvider(
  ...
  if (utils?.isManagedAliasProvider) {
    ...
    if (normalizedProvider === '2925') {
      return (
        utils.isManagedAliasProvider(provider) &&
...
function parseManagedAliasBaseEmail(
  rawValue,
  provider = selectMailProvider.value
) {
  const utils = getManagedAliasUtils()
...
function getPreferredMail2925PoolAccountId(state = latestState) {
  ...
  if (
    currentId &&
    getMail2925Accounts(state).some((account) => account.id === currentId)
  ) {
    return currentId
  }
  return ''
...
function syncMail2925PoolAccountOptions(state = latestState) {
  ...
  const options = ['<option value="">请选择号池邮箱</option>'].concat(
    accounts.map(
      (account) =>
        `<option value="${escapeHtml(account.id)}">${escapeHtml(account.email || '(未命名账号)')}</option>`
    )
  )
...
async function syncSelectedMail2925PoolAccount(options = {}) {
  ...
  if (
    ...
    !isMail2925AccountPoolEnabled(latestState)
  ) {
    return null
  }
  ...
  syncLatestState({
    ...
    ...(response.account?.email
      ? { mail2925BaseEmail: String(response.account.email).trim() }
      : {})
  })
  setManagedAliasBaseEmailInputForProvider('2925', latestState)
  if (!silent) {
    showToast(
      `已切换当前 2925 号池邮箱为 ${response.account?.email || accountId}`,
      'success',
      1800
    )
  }
...
function getManagedAliasBaseEmailForProvider(
  ...
  if (
    String(provider || '')
      .trim()
      .toLowerCase() === '2925' &&
    isMail2925AccountPoolEnabled(state)
  ) {
  ...
  return parseManagedAliasBaseEmail(legacyEmailPrefix, provider)
    ? legacyEmailPrefix
    : ''
}
...
function syncManagedAliasBaseEmailDraftFromInput(
  provider = selectMailProvider.value
) {
  const key = getManagedAliasBaseEmailKey(provider)
  if (!key) {
...
function isCurrentRegistrationEmailCompatible(
  email = inputEmail.value.trim(),
  provider = selectMailProvider.value,
  state = latestState
) {
  if (
    !usesGeneratedAliasMailProvider(provider, getSelectedMail2925Mode()) ||
    !email
  ) {
    return true
  }
...
function validateCurrentRegistrationEmail(
  email = inputEmail.value.trim(),
  options = {}
) {
...
async function getCurrentSidepanelWindowId() {
  if (chrome?.windows?.getCurrent) {
    try {
      ...
      console.warn(
        'Failed to get current sidepanel window:',
        error?.message || error
      )
    }
  }
...
const normalizeEditableListValues =
  editableListPickerModule.normalizeEditableListValues ||
  ((...sources) => {
    const values = []
    const seen = new Set()
    const append = (value) => {
...
const createEditableListPicker =
  editableListPickerModule.createEditableListPicker ||
  (() => ({
    close() {},
    render() {},
    setOpen() {},
...
const closeEditableListPickers =
  editableListPickerModule.closeEditableListPickers || (() => {})
const isClickInsideEditableListPicker =
  editableListPickerModule.isClickInsideEditableListPicker || (() => false)
...
function getSelectedSub2ApiGroupName() {
  return (
    String(inputSub2ApiGroup?.value || '').trim() ||
...
const cfDomainPicker = createEditableListPicker({
  ...
  onDeleteError: (error) =>
    showToast(error?.message || '删除 Cloudflare 域名失败。', 'error')
})
...
const tempEmailDomainPicker = createEditableListPicker({
  ...
  onDeleteError: (error) =>
    showToast(
      error?.message || '删除 Cloudflare Temp Email 域名失败。',
      'error'
    )
})
...
function renderSub2ApiGroupOptions(state = latestState, selectedValue = '') {
  ...
  if (
    selected &&
    !options.some((name) => name.toLowerCase() === selected.toLowerCase())
  ) {
  ...
  sub2ApiGroupPicker.render(
    options,
    selected || options[0] || DEFAULT_SUB2API_GROUP_OPTIONS[0]
  )
}
...
const normalizeHotmailServiceModeFromUtils =
  window.HotmailUtils?.normalizeHotmailServiceMode
const shouldClearHotmailCurrentSelection =
  window.HotmailUtils?.shouldClearHotmailCurrentSelection
const upsertHotmailAccountInList =
  window.HotmailUtils?.upsertHotmailAccountInList
const filterHotmailAccountsByUsage =
  window.HotmailUtils?.filterHotmailAccountsByUsage
...
const normalizeLuckmailTimestampValue =
  window.LuckMailUtils?.normalizeTimestamp ||
  ((value) => {
...
const DEFAULT_LUCKMAIL_PRESERVE_TAG_NAME =
  window.LuckMailUtils?.DEFAULT_LUCKMAIL_PRESERVE_TAG_NAME || '保留'
const normalizeIcloudHost =
  window.IcloudUtils?.normalizeIcloudHost ||
  ((value) => {
    const normalized = String(value || '')
      .trim()
      .toLowerCase()
    return normalized === 'icloud.com' || normalized === 'icloud.com.cn'
      ? normalized
      : ''
  })
...
const normalizeIcloudTargetMailboxType =
  window.MailProviderUtils?.normalizeIcloudTargetMailboxType ||
  ((value) =>
    String(value || '')
      .trim()
      .toLowerCase() === 'forward-mailbox'
      ? 'forward-mailbox'
      : 'icloud-inbox')
const getIcloudForwardMailProviderOptions =
  window.MailProviderUtils?.getIcloudForwardMailProviderOptions ||
  (() =>
...
const normalizeIcloudForwardMailProvider =
  window.MailProviderUtils?.normalizeIcloudForwardMailProvider ||
  ((value) => {
    const normalized = String(value || '')
      .trim()
      .toLowerCase()
...
const ICLOUD_FORWARD_MAIL_PROVIDER_LABELS = Object.fromEntries(
  getIcloudForwardMailProviderOptions().map((option) => [
    option.value,
    option.label
  ])
)
const getIcloudLoginUrlForHost =
  window.IcloudUtils?.getIcloudLoginUrlForHost ||
  ((host) =>
    host === 'icloud.com.cn'
...
const CLOUDFLARE_TEMP_EMAIL_REPOSITORY_URL =
...
function usesGeneratedAliasMailProvider(
  ...
  const customEmailPoolGenerator =
  ...
  const resolvedGenerator =
    generator !== undefined
      ? generator
      : typeof getSelectedEmailGenerator === 'function'
        ? getSelectedEmailGenerator()
        : ''
  return (
    resolvedGenerator !== customEmailPoolGenerator &&
...
function isManagedGmailAlias(value, baseEmail) {
  ...
  const match = String(value || '')
    .trim()
    .toLowerCase()
    .match(/^([^@\s+]+)(?:\+[^@\s]+)?@((?:gmail|googlemail)\.com)$/i)
...
function resolveModalChoice(choice) {
  ...
  const result =
    typeof modalResultBuilder === 'function'
...
function openAutoStartChoiceDialog(startStep, options = {}) {
  const runningStep = Number.isInteger(options.runningStep)
    ? options.runningStep
    : null
...
async function openPlusManualConfirmationDialog(options = {}) {
  ...
  return openActionModal({
    ...
    alert:
      method === 'gopay'
        ? {
            text: '确认后流程会直接继续到 Plus 模式第 10 步 OAuth 登录。',
            tone: 'info'
          }
        : null
  })
...
async function syncPlusManualConfirmationDialog() {
  const requestId = String(
    latestState?.plusManualConfirmationRequestId || ''
  ).trim()
  const pending = Boolean(latestState?.plusManualConfirmationPending)
  if (
    !pending ||
    !requestId ||
    plusManualConfirmationDialogInFlight ||
  ...
  const method = String(latestState?.plusManualConfirmationMethod || '')
    .trim()
    .toLowerCase()
  ...
  try {
    ...
    if (confirmed) {
      ...
      showToast(
        method === 'gopay' ? '已取消 GoPay 订阅等待。' : '已取消当前手动确认。',
        'warn',
        2200
      )
    }
    ...
    if (
      ...
      String(latestState?.plusManualConfirmationRequestId || '').trim() ===
        requestId
    ) {
      setTimeout(() => {
...
function getContributionPortalUrl() {
  return String(
    contributionContentService?.portalUrl || 'https://apikey.qzz.io'
  ).trim()
}
...
function openNewUserGuidePrompt() {
  return openActionModal({
    title: '新手引导',
    message:
      '如果你是第一次使用，可以先查看贡献页里的公告和使用教程。点击“查看引导”会自动打开贡献页面。',
    alert: {
      text: '本提示仅出现一次。'
    },
    actions: [
...
function getDismissedContributionContentPromptVersion() {
  return String(
    localStorage.getItem(
      CONTRIBUTION_CONTENT_PROMPT_DISMISSED_VERSION_STORAGE_KEY
    ) || ''
  ).trim()
}
...
function setAutoRunFallbackRiskPromptDismissed(dismissed) {
  setPromptDismissed(
    AUTO_RUN_FALLBACK_RISK_PROMPT_DISMISSED_STORAGE_KEY,
    dismissed
  )
}
...
function shouldWarnCpaPhoneSignup(signupMethod = null, panelMode = null) {
  ...
  const capabilityState =
    typeof resolveCurrentSidepanelCapabilities === 'function'
      ...
      : (() => {
          ...
          const registry =
            rootScope.MultiPageFlowCapabilities?.createFlowCapabilityRegistry?.(
              {
                defaultFlowId:
  ...
  if (
    capabilityState &&
    typeof capabilityState.shouldWarnCpaPhoneSignup === 'boolean'
  ) {
    return (
      capabilityState.shouldWarnCpaPhoneSignup &&
...
async function confirmCpaPhoneSignupIfNeeded(options = {}) {
  const signupMethod = Object.prototype.hasOwnProperty.call(
    options,
    'signupMethod'
  )
...
function getStepStatuses(state = latestState) {
  ...
  return Object.fromEntries(
    STEP_IDS.map((stepId) => [stepId, merged[stepId] || 'pending'])
  )
}
...
function scheduleAccountRunHistoryRefresh(delayMs = 150) {
  ...
  accountRunHistoryRefreshTimer = setTimeout(
    () => {
      ...
      chrome.runtime
        .sendMessage({ type: 'GET_STATE', source: 'sidepanel' })
        .then((state) => {
...
function applyOperationDelayState(state = latestState, options = {}) {
  const enabled = options.restoreFailed
    ? true
    : normalizeOperationDelayEnabled(state?.operationDelayEnabled)
  ...
  if (options.restoreFailed) {
    appendOperationDelayLog(
      true,
      'warn',
      '操作间延迟设置读取失败，已回退为默认开启。'
    )
  }
}

async function persistOperationDelayToggle() {
  const nextEnabled = normalizeOperationDelayEnabled(
    inputOperationDelayEnabled?.checked
  )
  try {
    const response = await chrome.runtime.sendMessage({
      type: 'SAVE_SETTING',
    ...
    const confirmed = normalizeOperationDelayEnabled(
      response?.state?.operationDelayEnabled ?? nextEnabled
    )
    lastConfirmedOperationDelayEnabled = confirmed
    if (inputOperationDelayEnabled)
      inputOperationDelayEnabled.checked = confirmed
    syncLatestState({ operationDelayEnabled: confirmed })
    appendOperationDelayLog(confirmed)
  } catch (error) {
    if (inputOperationDelayEnabled)
      inputOperationDelayEnabled.checked = lastConfirmedOperationDelayEnabled
    appendOperationDelayLog(
      lastConfirmedOperationDelayEnabled,
      'error',
      `操作间延迟设置保存失败，已恢复为上一次确认的状态：${error.message}`
    )
    throw error
  }
}
...
function normalizePlusPaymentMethod(value = '') {
  ...
  const gopayValue =
    typeof PLUS_PAYMENT_METHOD_GOPAY !== 'undefined'
...
function getSelectedPlusPaymentMethod(state = latestState) {
  const defaultMethod =
    typeof DEFAULT_PLUS_PAYMENT_METHOD !== 'undefined'
      ...
      : 'paypal'
  if (
    typeof selectPlusPaymentMethod !== 'undefined' &&
  ...
  return normalizePlusPaymentMethod(
    state?.plusPaymentMethod || currentPlusPaymentMethod || defaultMethod
  )
}
...
function normalizeGpcAutoModePermissionValue(value) {
  ...
  if (
    ['true', '1', 'yes', 'y', 'on', 'enabled', 'enable'].includes(normalized)
  ) {
    return true
  }
  if (
    ['false', '0', 'no', 'n', 'off', 'disabled', 'disable'].includes(normalized)
  ) {
    return false
  }
  return null
...
function shouldPreserveSelectedGpcAutoMode(state = latestState) {
  const payloadPermission = getGpcAutoModePermissionFromPayload(
    state?.gopayHelperBalancePayload
  )
  return (
    normalizeGpcHelperPhoneModeValue(state?.gopayHelperPhoneMode) ===
      GPC_HELPER_PHONE_MODE_AUTO &&
...
function getGpcBalanceRemainingUsesFromResponse(response = {}) {
  ...
  if (rootScope.GoPayUtils?.getGpcBalanceRemainingUses) {
    const remaining = rootScope.GoPayUtils.getGpcBalanceRemainingUses(
...
function registerPendingAutoRunStartRunCount(totalRuns) {
  ...
  pendingAutoRunStartExpiresAt =
    pendingAutoRunStartTotalRuns > 0 ? Date.now() + 30000 : 0
}
...
function getPendingAutoRunStartRunCount() {
  if (
    pendingAutoRunStartTotalRuns > 0 &&
    pendingAutoRunStartExpiresAt > 0 &&
    Date.now() > pendingAutoRunStartExpiresAt
  ) {
...
function syncAutoRunState(source = {}) {
  ...
  currentAutoRun = {
    autoRunning,
    phase,
    currentRun: readAutoRunStateValue(
      source,
      ['autoRunCurrentRun', 'currentRun'],
      currentAutoRun.currentRun
    ),
    totalRuns: readAutoRunStateValue(
      source,
      ['autoRunTotalRuns', 'totalRuns'],
      currentAutoRun.totalRuns
    ),
    attemptRun: readAutoRunStateValue(
      source,
      ['autoRunAttemptRun', 'attemptRun'],
      currentAutoRun.attemptRun
    ),
    scheduledAt: readAutoRunStateValue(
      source,
      ['scheduledAutoRunAt', 'scheduledAt'],
      currentAutoRun.scheduledAt
    ),
    countdownAt: readAutoRunStateValue(
      source,
      ['autoRunCountdownAt', 'countdownAt'],
      currentAutoRun.countdownAt
    ),
    countdownTitle: readAutoRunStateValue(
      source,
      ['autoRunCountdownTitle', 'countdownTitle'],
      currentAutoRun.countdownTitle
    ),
    countdownNote: readAutoRunStateValue(
      source,
      ['autoRunCountdownNote', 'countdownNote'],
      currentAutoRun.countdownNote
    )
  }
}
...
function normalizeAutoDelayMinutes(value) {
  ...
  return Math.min(
    ...
    Math.max(AUTO_DELAY_MIN_MINUTES, Math.floor(numeric))
  )
}
...
function normalizeAutoStepDelaySeconds(value) {
  ...
  return Math.min(
    ...
    Math.max(AUTO_STEP_DELAY_MIN_SECONDS, Math.floor(numeric))
  )
}
...
function normalizeCustomEmailPoolEntryObjects(value = []) {
  ...
  for (const rawEntry of source) {
    const asObject =
      rawEntry && typeof rawEntry === 'object' ? rawEntry : { email: rawEntry }
    ...
    entries.push({
      ...
      email,
      enabled:
        asObject.enabled !== undefined ? Boolean(asObject.enabled) : true,
      used: Boolean(asObject.used),
      note: String(asObject.note || '').trim(),
      lastUsedAt: Number.isFinite(Number(asObject.lastUsedAt))
        ? Number(asObject.lastUsedAt)
        : 0
    })
  }
...
function getNormalizedCustomEmailPoolEntriesState() {
  const entries =
    typeof customEmailPoolEntriesState !== 'undefined' &&
    Array.isArray(customEmailPoolEntriesState)
      ? customEmailPoolEntriesState
      : []
  return normalizeCustomEmailPoolEntryObjects(entries)
}

function getActiveCustomEmailPoolEmails(
  entries = getNormalizedCustomEmailPoolEntriesState()
) {
  return normalizeCustomEmailPoolEntryObjects(entries)
...
function setCustomEmailPoolEntriesState(entries = [], options = {}) {
  ...
  if (syncInput && inputCustomEmailPool) {
    inputCustomEmailPool.value = getActiveCustomEmailPoolEmails(
      customEmailPoolEntriesState
    ).join('\n')
  }
}
...
function restoreCustomEmailPoolEntriesFromState(state = {}) {
  ...
  return normalizeCustomEmailPoolEntries(state?.customEmailPool).map(
    (email) => ({
...
function getCustomEmailPoolSize() {
  if (
    ...
    const activeEntries = getActiveCustomEmailPoolEmails(
      customEmailPoolEntriesState
    )
...
function shouldLockRunCountToEmailPool(
  provider = typeof selectMailProvider !== 'undefined'
...
function getRunCountValue() {
  const lockedRunCount =
    typeof getLockedRunCountFromEmailPool === 'function'
...
function updateFallbackThreadIntervalInputState() {
  ...
  inputAutoSkipFailuresThreadIntervalMinutes.disabled = Boolean(
    inputAutoSkipFailures.disabled
  )
}
...
function getActiveAutoRunCountdown() {
  if (
    isAutoRunScheduledPhase() &&
    Number.isFinite(currentAutoRun.scheduledAt)
  ) {
    return {
...
function setDefaultAutoRunButton() {
  ...
  btnAutoRun.innerHTML =
    '<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><polygon points="5 3 19 12 5 21 5 3"/></svg> 自动'
}
...
function getCloudflareDomainsFromState() {
  const domains = normalizeCloudflareDomains(
    latestState?.cloudflareDomains || []
  )
  const activeDomain = normalizeCloudflareDomainValue(
    latestState?.cloudflareDomain || ''
  )
...
function getCloudflareTempEmailDomainsFromState() {
  const domains = normalizeCloudflareTempEmailDomains(
    latestState?.cloudflareTempEmailDomains || []
  )
  const activeDomain = normalizeCloudflareTempEmailDomainValue(
...
function renderCloudflareDomainOptions(preferredDomain = '') {
  ...
  cfDomainPicker.render(
    domains,
    domains.includes(selected) ? selected : domains[0] || ''
  )
}
...
function setCloudflareTempEmailDomainEditMode(editing, options = {}) {
  ...
  inputTempEmailDomain.style.display = cloudflareTempEmailDomainEditMode
    ? ''
    : 'none'
  btnTempEmailDomainMode.textContent = cloudflareTempEmailDomainEditMode
    ? '保存'
    : '添加'
...
function applyCloudflareTempEmailSettingsState(state = {}) {
  ...
  inputTempEmailReceiveMailbox.value =
    state?.cloudflareTempEmailReceiveMailbox || ''
  if (inputTempEmailUseRandomSubdomain) {
    inputTempEmailUseRandomSubdomain.checked = Boolean(
...
function collectSettingsPayload() {
  const defaultGpcHelperApiUrl =
    typeof DEFAULT_GPC_HELPER_API_URL !== 'undefined'
  ...
  const { domains: tempEmailDomains, activeDomain: tempEmailActiveDomain } =
    getCloudflareTempEmailDomainsFromState()
  const selectedCloudflareTempEmailDomain =
    normalizeCloudflareTempEmailDomainValue(
      !cloudflareTempEmailDomainEditMode
        ? selectTempEmailDomain.value
        : tempEmailActiveDomain
    ) || tempEmailActiveDomain
  const normalizeCloudMailBaseUrlInput =
    typeof normalizeCloudMailBaseUrlValue === 'function'
      ? normalizeCloudMailBaseUrlValue
      : normalizeCloudflareTempEmailBaseUrlValue
  const normalizeCloudMailReceiveMailboxInput =
    typeof normalizeCloudMailReceiveMailboxValue === 'function'
      ? normalizeCloudMailReceiveMailboxValue
      : normalizeCloudflareTempEmailReceiveMailboxValue
  const normalizeCloudMailDomainInput =
    typeof normalizeCloudMailDomainValue === 'function'
      ? normalizeCloudMailDomainValue
      : normalizeCloudflareTempEmailDomainValue
  const contributionModeEnabled = Boolean(latestState?.contributionMode)
  const icloudFetchModeRawValue =
    typeof selectIcloudFetchMode !== 'undefined'
      ? String(selectIcloudFetchMode?.value || '')
      : ''
  const icloudTargetMailboxTypeValue =
    typeof selectIcloudTargetMailboxType !== 'undefined'
      ? selectIcloudTargetMailboxType?.value
      : ''
  const icloudForwardMailProviderValue =
    typeof selectIcloudForwardMailProvider !== 'undefined'
      ? selectIcloudForwardMailProvider?.value
      : ''
  const normalizedIcloudTargetMailboxType = normalizeIcloudTargetMailboxType(
    icloudTargetMailboxTypeValue
  )
  const normalizedIcloudForwardMailProvider =
    normalizeIcloudForwardMailProvider(icloudForwardMailProviderValue)
  const normalizeIpProxyServiceSafe =
    typeof normalizeIpProxyService === 'function'
      ? normalizeIpProxyService
      : (value = '') => {
          const normalized = String(value || '')
            .trim()
            .toLowerCase()
          return ['711proxy'].includes(normalized) ? normalized : '711proxy'
        }
  const normalizeIpProxyModeSafe =
    typeof normalizeIpProxyMode === 'function'
      ? normalizeIpProxyMode
      : (value = '') => {
          const normalized = String(value || '')
            .trim()
            .toLowerCase()
          return ['api', 'account'].includes(normalized)
            ? normalized
            : 'account'
        }
  const normalizeIpProxyProtocolSafe =
    typeof normalizeIpProxyProtocol === 'function'
      ? normalizeIpProxyProtocol
      : (value = '') => {
          const normalized = String(value || '')
            .trim()
            .toLowerCase()
          return ['http', 'https', 'socks4', 'socks5'].includes(normalized)
            ? normalized
            : 'http'
        }
  const normalizeIpProxyPortSafe =
    typeof normalizeIpProxyPort === 'function'
  ...
  const normalizeIpProxyPoolTargetCountSafe =
  ...
  const normalizeIpProxyAutoSyncIntervalMinutesSafe = (
    value = '',
    fallback = 15
  ) => {
    const rawValue = String(value ?? '').trim()
  ...
  const normalizeIpProxyAccountLifeMinutesSafe =
  ...
  const normalizeIpProxyAccountSessionPrefixSafe =
    typeof normalizeIpProxyAccountSessionPrefix === 'function'
      ...
      : (value = '') =>
          String(value || '')
            ...
            .slice(0, 32)
  const normalizeIpProxyAccountListSafe =
    typeof normalizeIpProxyAccountList === 'function'
      ...
      : (value = '') =>
          String(value || '')
            ...
            .filter(Boolean)
            .join('\n')
  const normalizeGpcOtpChannelSafe =
    typeof normalizeGpcOtpChannelValue === 'function'
  ...
  const normalizeGpcLocalSmsHelperBaseUrlSafe =
    typeof normalizeGpcLocalSmsHelperBaseUrlValue === 'function'
  ...
  const getSelectedIpProxyEnabledSafe =
    typeof getSelectedIpProxyEnabled === 'function'
      ? getSelectedIpProxyEnabled
      : () => false
  const getSelectedIpProxyModeSafe =
    typeof getSelectedIpProxyMode === 'function'
      ? getSelectedIpProxyMode
      : () => 'account'
  const isIpProxyApiModeEnabledSafe =
    typeof isIpProxyApiModeAvailable === 'function'
      ? Boolean(isIpProxyApiModeAvailable())
      : typeof IP_PROXY_API_MODE_ENABLED !== 'undefined'
        ? Boolean(IP_PROXY_API_MODE_ENABLED)
        : false
  const normalizeIpProxyServiceProfilesSafe =
    typeof normalizeIpProxyServiceProfiles === 'function'
      ...
      : (rawValue = {}, fallbackState = {}) => {
          ...
          const fallbackProfile = {
            mode: normalizeIpProxyModeSafe(
              fallbackState?.ipProxyMode || 'account'
            ),
            apiUrl: String(fallbackState?.ipProxyApiUrl || '').trim(),
            accountList: normalizeIpProxyAccountListSafe(
              fallbackState?.ipProxyAccountList || ''
            ),
            accountSessionPrefix: normalizeIpProxyAccountSessionPrefixSafe(
              fallbackState?.ipProxyAccountSessionPrefix || ''
            ),
            accountLifeMinutes: normalizeIpProxyAccountLifeMinutesSafe(
              fallbackState?.ipProxyAccountLifeMinutes || ''
            ),
            poolTargetCount: normalizeIpProxyPoolTargetCountSafe(
              fallbackState?.ipProxyPoolTargetCount || '',
              20
            ),
            host: String(fallbackState?.ipProxyHost || '').trim(),
            port: String(
              normalizeIpProxyPortSafe(fallbackState?.ipProxyPort || '') || ''
            ),
            protocol: normalizeIpProxyProtocolSafe(
              fallbackState?.ipProxyProtocol || ''
            ),
          ...
          services.forEach((service) => {
            ...
            result[service] = {
              mode: normalizeIpProxyModeSafe(
                source.mode || fallbackProfile.mode
              ),
              apiUrl: String(
                source.apiUrl || fallbackProfile.apiUrl || ''
              ).trim(),
              accountList: normalizeIpProxyAccountListSafe(
                source.accountList || fallbackProfile.accountList
              ),
              accountSessionPrefix: normalizeIpProxyAccountSessionPrefixSafe(
                source.accountSessionPrefix ||
                  fallbackProfile.accountSessionPrefix
              ),
              accountLifeMinutes: normalizeIpProxyAccountLifeMinutesSafe(
                source.accountLifeMinutes || fallbackProfile.accountLifeMinutes
              ),
              poolTargetCount: normalizeIpProxyPoolTargetCountSafe(
                source.poolTargetCount || fallbackProfile.poolTargetCount,
                20
              ),
              host: String(source.host || fallbackProfile.host || '').trim(),
              port: String(
                normalizeIpProxyPortSafe(
                  source.port || fallbackProfile.port || ''
                ) || ''
              ),
              protocol: normalizeIpProxyProtocolSafe(
                source.protocol || fallbackProfile.protocol
              ),
              username: String(
                source.username || fallbackProfile.username || ''
              ).trim(),
              password: String(
                source.password || fallbackProfile.password || ''
              ),
              region: String(
                source.region || fallbackProfile.region || ''
              ).trim()
            }
          })
          return result
        }
  const ipProxyServiceRawValue =
    typeof selectIpProxyService !== 'undefined'
      ? selectIpProxyService?.value
      : ''
  const ipProxyApiUrlRawValue =
    typeof inputIpProxyApiUrl !== 'undefined' ? inputIpProxyApiUrl?.value : ''
  const ipProxyAccountListRawValue =
    typeof inputIpProxyAccountList !== 'undefined'
      ? inputIpProxyAccountList?.value
      : ''
  const ipProxyAccountSessionPrefixRawValue =
    typeof inputIpProxyAccountSessionPrefix !== 'undefined'
      ? inputIpProxyAccountSessionPrefix?.value
      : ''
  const ipProxyAccountLifeMinutesRawValue =
    typeof inputIpProxyAccountLifeMinutes !== 'undefined'
      ? inputIpProxyAccountLifeMinutes?.value
      : ''
  const ipProxyPoolTargetCountRawValue =
    typeof inputIpProxyPoolTargetCount !== 'undefined'
      ? inputIpProxyPoolTargetCount?.value
      : ''
  const ipProxyAutoSyncEnabledRawValue =
    typeof inputIpProxyAutoSyncEnabled !== 'undefined'
      ? Boolean(inputIpProxyAutoSyncEnabled?.checked)
      : Boolean(latestState?.ipProxyAutoSyncEnabled)
  const ipProxyAutoSyncIntervalMinutesRawValue =
    typeof inputIpProxyAutoSyncIntervalMinutes !== 'undefined'
      ? inputIpProxyAutoSyncIntervalMinutes?.value
      : ''
  const ipProxyHostRawValue =
    typeof inputIpProxyHost !== 'undefined' ? inputIpProxyHost?.value : ''
  const ipProxyPortRawValue =
    typeof inputIpProxyPort !== 'undefined' ? inputIpProxyPort?.value : ''
  const ipProxyProtocolRawValue =
    typeof selectIpProxyProtocol !== 'undefined'
      ? selectIpProxyProtocol?.value
      : ''
  const ipProxyUsernameRawValue =
    typeof inputIpProxyUsername !== 'undefined'
      ? inputIpProxyUsername?.value
      : ''
  const ipProxyPasswordRawValue =
    typeof inputIpProxyPassword !== 'undefined'
      ? inputIpProxyPassword?.value
      : ''
  const ipProxyRegionRawValue =
    typeof inputIpProxyRegion !== 'undefined' ? inputIpProxyRegion?.value : ''
  const selectedIpProxyService = normalizeIpProxyServiceSafe(
    ipProxyServiceRawValue || latestState?.ipProxyService || '711proxy'
  )
  const selectedIpProxyModeRaw = normalizeIpProxyModeSafe(
    getSelectedIpProxyModeSafe()
  )
  const selectedIpProxyMode =
  ...
  const currentIpProxyServiceProfile = {
    ...
    accountList: normalizeIpProxyAccountListSafe(
      ipProxyAccountListRawValue || ''
    ),
    accountSessionPrefix: normalizeIpProxyAccountSessionPrefixSafe(
      ipProxyAccountSessionPrefixRawValue || ''
    ),
    accountLifeMinutes: normalizeIpProxyAccountLifeMinutesSafe(
      ipProxyAccountLifeMinutesRawValue || ''
    ),
    poolTargetCount: normalizeIpProxyPoolTargetCountSafe(
      ipProxyPoolTargetCountRawValue || '',
      20
    ),
  ...
  const ipProxyServiceProfiles = normalizeIpProxyServiceProfilesSafe(
    ...
    },
    {
      ...
      ipProxyAccountSessionPrefix:
        currentIpProxyServiceProfile.accountSessionPrefix,
      ipProxyAccountLifeMinutes:
        currentIpProxyServiceProfile.accountLifeMinutes,
  ...
  const mail2925UseAccountPool =
    typeof inputMail2925UseAccountPool !== 'undefined'
      ? Boolean(inputMail2925UseAccountPool?.checked)
      : Boolean(latestState?.mail2925UseAccountPool)
  const phoneSmsProviderValue =
    typeof selectPhoneSmsProvider !== 'undefined' && selectPhoneSmsProvider
      ? normalizePhoneSmsProvider(selectPhoneSmsProvider.value)
      : normalizePhoneSmsProvider(latestState?.phoneSmsProvider)
  const phoneSmsProviderOrderValue =
  ...
  const defaultHeroSmsReuseEnabled =
    typeof DEFAULT_HERO_SMS_REUSE_ENABLED !== 'undefined'
      ? DEFAULT_HERO_SMS_REUSE_ENABLED
      : true
  const defaultPhoneCodeWaitSeconds =
    typeof DEFAULT_PHONE_CODE_WAIT_SECONDS !== 'undefined'
      ? DEFAULT_PHONE_CODE_WAIT_SECONDS
      : 60
  const defaultPhoneCodeTimeoutWindows =
    typeof DEFAULT_PHONE_CODE_TIMEOUT_WINDOWS !== 'undefined'
      ? DEFAULT_PHONE_CODE_TIMEOUT_WINDOWS
      : 2
  const defaultPhoneCodePollIntervalSeconds =
    typeof DEFAULT_PHONE_CODE_POLL_INTERVAL_SECONDS !== 'undefined'
      ? DEFAULT_PHONE_CODE_POLL_INTERVAL_SECONDS
      : 5
  const defaultPhoneCodePollMaxRounds =
    typeof DEFAULT_PHONE_CODE_POLL_MAX_ROUNDS !== 'undefined'
  ...
  const freePhoneReuseEnabledValue =
  ...
  const freePhoneReuseAutoEnabledValue =
    typeof inputFreePhoneReuseAutoEnabled !== 'undefined' &&
  ...
  const defaultHeroSmsAcquirePriority =
    typeof DEFAULT_HERO_SMS_ACQUIRE_PRIORITY !== 'undefined'
      ...
      : typeof HERO_SMS_ACQUIRE_PRIORITY_COUNTRY !== 'undefined'
        ? HERO_SMS_ACQUIRE_PRIORITY_COUNTRY
        : 'country'
  const heroSmsAcquirePriorityValue =
    typeof selectHeroSmsAcquirePriority !== 'undefined' &&
    selectHeroSmsAcquirePriority
  ...
  const currentPhoneSmsMaxPriceValue =
    typeof inputHeroSmsMaxPrice !== 'undefined' && inputHeroSmsMaxPrice
  ...
  const fiveSimMaxPriceValue =
    phoneSmsProviderValue === PHONE_SMS_PROVIDER_FIVE_SIM
      ? currentPhoneSmsMaxPriceValue
      : normalizeFiveSimMaxPriceValue(latestState?.fiveSimMaxPrice || '')
  const defaultFiveSimProduct =
    typeof DEFAULT_FIVE_SIM_PRODUCT !== 'undefined'
      ? DEFAULT_FIVE_SIM_PRODUCT
      : 'openai'
  const defaultNexSmsServiceCode =
    typeof DEFAULT_NEX_SMS_SERVICE_CODE !== 'undefined'
      ? DEFAULT_NEX_SMS_SERVICE_CODE
      : 'ot'
  const normalizeFiveSimProductForPayload =
    typeof normalizeFiveSimProductValue === 'function'
      ? normalizeFiveSimProductValue
      : (value = '') =>
          String(value || '')
            .trim()
            .toLowerCase()
            .replace(/[^a-z0-9_-]+/g, '') || defaultFiveSimProduct
  const normalizeNexSmsServiceCodeForPayload =
    typeof normalizeNexSmsServiceCodeValue === 'function'
      ? normalizeNexSmsServiceCodeValue
      : (value = '') =>
          String(value || '')
            .trim()
            .toLowerCase()
            .replace(/[^a-z0-9_-]+/g, '') || defaultNexSmsServiceCode
  const normalizeFiveSimCountryOrderForPayload =
    typeof normalizeFiveSimCountryOrderValue === 'function'
      ? normalizeFiveSimCountryOrderValue
      : (value = []) =>
          (Array.isArray(value) ? value : [])
            .map((entry) => normalizeFiveSimCountryId(entry, ''))
            .filter(Boolean)
  const normalizeNexSmsCountryIdForPayload =
    typeof normalizeNexSmsCountryIdValue === 'function'
  ...
  const normalizeNexSmsCountryOrderForPayload =
    typeof normalizeNexSmsCountryOrderValue === 'function'
  ...
  const phoneSmsProviderSmsbower =
    typeof PHONE_SMS_PROVIDER_SMSBOWER !== 'undefined'
      ? PHONE_SMS_PROVIDER_SMSBOWER
      : 'smsbower'
  const defaultNexSmsCountryOrder =
    typeof DEFAULT_NEX_SMS_COUNTRY_ORDER !== 'undefined'
      ? DEFAULT_NEX_SMS_COUNTRY_ORDER
      : [1]
  const defaultSmsbowerCountryOrder =
    typeof DEFAULT_SMSBOWER_COUNTRY_ORDER !== 'undefined'
      ? DEFAULT_SMSBOWER_COUNTRY_ORDER
      : [52]
  const defaultSmsbowerServiceCode =
    typeof DEFAULT_SMSBOWER_SERVICE_CODE !== 'undefined'
      ? DEFAULT_SMSBOWER_SERVICE_CODE
      : 'dr'
  const fiveSimOperatorValue =
    typeof inputFiveSimOperator !== 'undefined' && inputFiveSimOperator
  ...
  const fiveSimProductValue =
    typeof inputFiveSimProduct !== 'undefined' && inputFiveSimProduct
      ? normalizeFiveSimProductForPayload(
          inputFiveSimProduct.value || latestState?.fiveSimProduct
        )
      : normalizeFiveSimProductForPayload(
          latestState?.fiveSimProduct || defaultFiveSimProduct
        )
  const nexSmsServiceCodeValue =
    typeof inputNexSmsServiceCode !== 'undefined' && inputNexSmsServiceCode
  ...
  const phonePreferredActivationValue =
    typeof getSelectedPhonePreferredActivation === 'function'
      ? getSelectedPhonePreferredActivation()
      : null
  const phoneVerificationReplacementLimitValue =
    typeof inputPhoneReplacementLimit !== 'undefined' &&
    inputPhoneReplacementLimit
  ...
  const phoneCodeWaitSecondsValue =
    typeof inputPhoneCodeWaitSeconds !== 'undefined' &&
    inputPhoneCodeWaitSeconds
  ...
  const phoneCodeTimeoutWindowsValue =
    typeof inputPhoneCodeTimeoutWindows !== 'undefined' &&
    inputPhoneCodeTimeoutWindows
  ...
  const phoneCodePollIntervalSecondsValue =
    typeof inputPhoneCodePollIntervalSeconds !== 'undefined' &&
    inputPhoneCodePollIntervalSeconds
  ...
  const phoneCodePollMaxRoundsValue =
    typeof inputPhoneCodePollMaxRounds !== 'undefined' &&
    inputPhoneCodePollMaxRounds
  ...
  const selectedPhoneSmsCountry =
    phoneSmsProviderValue === PHONE_SMS_PROVIDER_FIVE_SIM
      ? (typeof getSelectedFiveSimCountries === 'function'
          ? getSelectedFiveSimCountries()[0]
          : null) || {
      ...
      : phoneSmsProviderValue === phoneSmsProviderNexsms
        ? (typeof getSelectedNexSmsCountries === 'function'
            ? getSelectedNexSmsCountries()[0]
            : null) || {
            id: defaultNexSmsCountryOrder[0],
            label: `Country #${defaultNexSmsCountryOrder[0]}`
          }
        : typeof getSelectedHeroSmsCountryOption === 'function'
          ? getSelectedHeroSmsCountryOption()
          : {
              id:
                typeof DEFAULT_HERO_SMS_COUNTRY_ID !== 'undefined'
                  ? DEFAULT_HERO_SMS_COUNTRY_ID
                  : 52,
              label:
                typeof DEFAULT_HERO_SMS_COUNTRY_LABEL !== 'undefined'
                  ? DEFAULT_HERO_SMS_COUNTRY_LABEL
                  : 'Thailand'
            }
  const heroSmsCountry =
    phoneSmsProviderValue === PHONE_SMS_PROVIDER_HERO_SMS
  ...
  const normalizedCustomEmailPool =
    typeof getActiveCustomEmailPoolEmails === 'function'
      ...
      : typeof normalizeCustomEmailPoolEntries === 'function'
        ...
        : []
  const normalizedCustomEmailPoolEntries =
    typeof getNormalizedCustomEmailPoolEntriesState === 'function'
      ? getNormalizedCustomEmailPoolEntriesState()
      : []
  const selectedPhoneSmsCountryFallback =
    typeof syncHeroSmsFallbackSelectionOrderFromSelect === 'function'
      ? syncHeroSmsFallbackSelectionOrderFromSelect().filter(
          (country) => String(country.id) !== String(selectedPhoneSmsCountry.id)
        )
      : []
  const fiveSimCountryOrderValue =
    typeof getSelectedFiveSimCountries === 'function'
      ? getSelectedFiveSimCountries()
          .map((country) =>
            normalizeFiveSimCountryCode(country.code || country.id, '')
          )
          .filter(Boolean)
      : normalizeFiveSimCountryOrderForPayload(
  ...
  const payPalAccounts =
    typeof getPayPalAccounts === 'function'
      ? getPayPalAccounts(latestState)
      : Array.isArray(latestState?.paypalAccounts)
        ? latestState.paypalAccounts
        : []
  const currentPayPalAccount =
    typeof getCurrentPayPalAccount === 'function'
      ? getCurrentPayPalAccount(latestState)
      : payPalAccounts.find(
          (account) =>
            account?.id ===
            String(latestState?.currentPayPalAccountId || '').trim()
        ) || null
  const selectedSignupMethod =
    typeof getSelectedSignupMethod === 'function'
      ? getSelectedSignupMethod()
      : typeof normalizeSignupMethod === 'function'
        ? normalizeSignupMethod(latestState?.signupMethod)
        : String(latestState?.signupMethod || '')
              .trim()
              .toLowerCase() === 'phone'
          ? 'phone'
          : 'email'
  const normalizePanelModeSafe =
    typeof normalizePanelMode === 'function'
      ? normalizePanelMode
      : (value = '') => {
          const normalized = String(value || '')
            .trim()
            .toLowerCase()
          return normalized === 'sub2api' || normalized === 'codex2api'
            ? normalized
            : 'cpa'
        }
  const rawPanelMode = normalizePanelModeSafe(
    selectPanelMode?.value || latestState?.panelMode || 'cpa'
  )
  const rawPlusModeEnabled =
    typeof inputPlusModeEnabled !== 'undefined' && inputPlusModeEnabled
      ? Boolean(inputPlusModeEnabled.checked)
      : Boolean(latestState?.plusModeEnabled)
  const rawPhoneVerificationEnabled = Boolean(
  ...
  const effectiveSignupMethod =
    capabilityState?.effectiveSignupMethod || selectedSignupMethod
  const plusPaymentMethod = getSelectedPlusPaymentMethod()
  const normalizeGpcHelperPhoneModeSafe =
    typeof normalizeGpcHelperPhoneModeValue === 'function'
  ...
  const selectedGpcOtpChannel = normalizeGpcOtpChannelSafe(
    typeof selectGpcHelperOtpChannel !== 'undefined' &&
      selectGpcHelperOtpChannel
      ? selectGpcHelperOtpChannel.value
      : latestState?.gopayHelperOtpChannel || 'whatsapp'
  )
  const selectedGpcLocalSmsHelperEnabled =
    effectiveGpcPhoneMode === 'auto'
      ? false
      : Boolean(
          typeof inputGpcHelperLocalSmsEnabled !== 'undefined' &&
  ...
  return {
    ...
    plusPaymentMethod,
    paypalEmail: String(
      currentPayPalAccount?.email || latestState?.paypalEmail || ''
    ).trim(),
    paypalPassword: String(
      currentPayPalAccount?.password || latestState?.paypalPassword || ''
    ),
    currentPayPalAccountId: String(
      latestState?.currentPayPalAccountId || ''
    ).trim(),
    paypalAccounts: payPalAccounts,
    gopayCountryCode: window.GoPayUtils?.normalizeGoPayCountryCode
      ? window.GoPayUtils.normalizeGoPayCountryCode(
          typeof selectGoPayCountryCode !== 'undefined' &&
            selectGoPayCountryCode
            ? selectGoPayCountryCode.value
            : latestState?.gopayCountryCode
        )
    ...
    gopayHelperApiKey:
      typeof inputGpcHelperCardKey !== 'undefined' && inputGpcHelperCardKey
        ? String(inputGpcHelperCardKey.value || '').trim()
        : String(
            latestState?.gopayHelperApiKey ||
    ...
    gopayHelperCountryCode: window.GoPayUtils?.normalizeGoPayCountryCode
      ? window.GoPayUtils.normalizeGoPayCountryCode(
          typeof selectGpcHelperCountryCode !== 'undefined' &&
            selectGpcHelperCountryCode
            ? selectGpcHelperCountryCode.value
            : latestState?.gopayHelperCountryCode
        )
      : typeof selectGpcHelperCountryCode !== 'undefined' &&
          selectGpcHelperCountryCode
    ...
    gopayHelperLocalSmsHelperUrl: normalizeGpcLocalSmsHelperBaseUrlSafe(
      typeof inputGpcHelperLocalSmsUrl !== 'undefined' &&
    ...
    currentMail2925AccountId: String(
      latestState?.currentMail2925AccountId || ''
    ).trim(),
    ...
    icloudFetchMode:
      icloudFetchModeRawValue.trim().toLowerCase() === 'always_new'
        ? 'always_new'
        : 'reuse_existing',
    ...(contributionModeEnabled
      ? {}
      : {
          ...
          accountRunHistoryHelperBaseUrl:
            normalizeAccountRunHistoryHelperBaseUrlValue(
              inputAccountRunHistoryHelperBaseUrl?.value
            )
        }),
    ...
    luckmailEmailType: normalizeLuckmailEmailType(
      selectLuckmailEmailType.value
    ),
    luckmailDomain: inputLuckmailDomain.value.trim(),
    cloudflareDomain: selectedCloudflareDomain,
    cloudflareDomains: domains,
    cloudflareTempEmailBaseUrl: normalizeCloudflareTempEmailBaseUrlValue(
      inputTempEmailBaseUrl.value
    ),
    ...
    cloudflareTempEmailUseRandomSubdomain: Boolean(
      inputTempEmailUseRandomSubdomain?.checked
    ),
    cloudflareTempEmailDomain: selectedCloudflareTempEmailDomain,
    cloudflareTempEmailDomains: tempEmailDomains,
    cloudMailBaseUrl: normalizeCloudMailBaseUrlInput(
      typeof inputCloudMailBaseUrl !== 'undefined' && inputCloudMailBaseUrl
        ? inputCloudMailBaseUrl.value
        : ''
    ),
    cloudMailAdminEmail: (typeof inputCloudMailAdminEmail !== 'undefined' &&
    inputCloudMailAdminEmail
      ? inputCloudMailAdminEmail.value
      : ''
    ).trim(),
    cloudMailAdminPassword:
      typeof inputCloudMailAdminPassword !== 'undefined' &&
      inputCloudMailAdminPassword
        ? inputCloudMailAdminPassword.value
        : '',
    cloudMailReceiveMailbox: normalizeCloudMailReceiveMailboxInput(
      typeof inputCloudMailReceiveMailbox !== 'undefined' &&
        inputCloudMailReceiveMailbox
        ? inputCloudMailReceiveMailbox.value
        : ''
    ),
    cloudMailDomain: normalizeCloudMailDomainInput(
      typeof inputCloudMailDomain !== 'undefined' && inputCloudMailDomain
        ? inputCloudMailDomain.value
        : ''
    ),
    autoRunSkipFailures: inputAutoSkipFailures.checked,
    autoRunFallbackThreadIntervalMinutes: normalizeAutoRunThreadIntervalMinutes(
    ...
    autoStepDelaySeconds: normalizeAutoStepDelaySeconds(
      inputAutoStepDelaySeconds.value
    ),
    oauthFlowTimeoutEnabled:
      typeof inputOAuthFlowTimeoutEnabled !== 'undefined' &&
    ...
    smsbowerBaseUrl: smsbowerBaseUrlValue,
...
function normalizeMail2925Mode(value = '') {
  return String(value || '')
    .trim()
    .toLowerCase() === MAIL_2925_MODE_RECEIVE
...
function normalizeHotmailServiceMode(value = '') {
  ...
  return String(value || '')
    .trim()
    .toLowerCase() === HOTMAIL_SERVICE_MODE_REMOTE
...
function normalizeAccountRunHistoryHelperBaseUrlValue(value = '') {
  ...
  try {
    ...
    if (
      parsed.pathname === '/append-account-log' ||
      parsed.pathname === '/sync-account-run-records'
    ) {
      parsed.pathname = ''
      parsed.search = ''
      parsed.hash = ''
...
function normalizePhoneSmsProvider(value = '') {
  if (
    ...
    window.PhoneSmsProviderRegistry?.normalizeProviderId
  ) {
...
function getPhoneSmsProviderLabel(provider = getSelectedPhoneSmsProvider()) {
  if (
    typeof window !== 'undefined' &&
    window.PhoneSmsProviderRegistry?.getProviderLabel
  ) {
  ...
  if (normalized === PHONE_SMS_PROVIDER_SMSBOWER) return 'smsbower.app'
  return 'HeroSMS'
}
...
function normalizePhoneSmsCountryId(
  value,
  ...
  if (normalizedProvider === PHONE_SMS_PROVIDER_NEXSMS) {
    return normalizeNexSmsCountryIdValue(value)
  }
...
function normalizePhoneSmsCountryLabel(
  value = '',
  provider = getSelectedPhoneSmsProvider()
) {
  const normalizedProvider = normalizePhoneSmsProvider(provider)
  ...
  if (normalizedProvider === PHONE_SMS_PROVIDER_SMSBOWER) {
    return normalizeSmsbowerCountryLabelValue(value)
  }
  return normalizeHeroSmsCountryLabel(value)
}

function normalizePhoneSmsMaxPriceValue(
  value = '',
  provider = getSelectedPhoneSmsProvider()
) {
  const normalizedProvider = normalizePhoneSmsProvider(provider)
...
function normalizeFiveSimCountryId(
  value,
  fallback = DEFAULT_FIVE_SIM_COUNTRY_ID
) {
  const fallbackSource =
    fallback === undefined || fallback === null
      ? DEFAULT_FIVE_SIM_COUNTRY_ID
      : fallback
  const normalizedFallback = String(fallbackSource)
    .trim()
    .toLowerCase()
    .replace(/[^a-z0-9_-]+/g, '')
  const rawNormalized =
    typeof window !== 'undefined' &&
    window.PhoneSmsFiveSimProvider?.normalizeFiveSimCountryId
      ? window.PhoneSmsFiveSimProvider.normalizeFiveSimCountryId(value, '')
      : String(value || '')
          .trim()
          .toLowerCase()
          .replace(/[^a-z0-9_-]+/g, '')
  const normalized = String(rawNormalized || '')
    .trim()
    .toLowerCase()
  if (normalized) {
    return normalized
...
function normalizeFiveSimCountryLabel(
  value = '',
  fallback = DEFAULT_FIVE_SIM_COUNTRY_LABEL
) {
  if (
    typeof window !== 'undefined' &&
    window.PhoneSmsFiveSimProvider?.normalizeFiveSimCountryLabel
  ) {
...
function formatFiveSimCountryDisplayLabel(
  id = '',
  englishValue = '',
  fallback = DEFAULT_FIVE_SIM_COUNTRY_LABEL
) {
  if (
    typeof window !== 'undefined' &&
    window.PhoneSmsFiveSimProvider?.formatFiveSimCountryLabel
  ) {
  ...
  const english = normalizeFiveSimCountryLabel(
    englishValue || countryId || fallback,
    fallback
  )
...
function normalizeFiveSimOperator(
  value = '',
  fallback = DEFAULT_FIVE_SIM_OPERATOR
) {
  if (
    typeof window !== 'undefined' &&
    window.PhoneSmsFiveSimProvider?.normalizeFiveSimOperator
  ) {
    return window.PhoneSmsFiveSimProvider.normalizeFiveSimOperator(
      value || fallback
    )
  }
  return (
...
function normalizeFiveSimMaxPriceValue(value = '') {
  if (
    typeof window !== 'undefined' &&
    window.PhoneSmsFiveSimProvider?.normalizeFiveSimMaxPrice
  ) {
...
function normalizeFiveSimCountryFallbackList(value = []) {
  if (
    typeof window !== 'undefined' &&
    window.PhoneSmsFiveSimProvider?.normalizeFiveSimCountryFallback
  ) {
  ...
  source.forEach((entry) => {
    ...
    if (entry && typeof entry === 'object' && !Array.isArray(entry)) {
      id = normalizeFiveSimCountryId(
        entry.id ?? entry.countryId ?? entry.slug,
        ''
      )
      label = normalizeFiveSimCountryLabel(
        entry.label ??
          entry.countryLabel ??
          formatFiveSimCountryDisplayLabel(id, entry.text_en ?? entry.name, id),
        id
      )
    } else {
      ...
      label =
        String(structured?.[2] || '').trim() ||
        formatFiveSimCountryDisplayLabel(id, id, id)
    }
    if (!id || seen.has(id)) {
      return
    }
    ...
    normalized.push({
      id,
      label: label || formatFiveSimCountryDisplayLabel(id, id, id)
    })
  })
...
function normalizeHeroSmsCountryId(
  value,
  fallback = DEFAULT_HERO_SMS_COUNTRY_ID
) {
...
function formatPhoneSmsProviderOrderSummary(order = []) {
  ...
  return normalized
    .map(
      (provider, index) => `${index + 1}. ${getPhoneSmsProviderLabel(provider)}`
    )
    .join(' → ')
}
...
function updatePhoneSmsProviderOrderSummary(order = []) {
  ...
  if (displayPhoneSmsProviderOrder) {
    displayPhoneSmsProviderOrder.textContent =
      formatPhoneSmsProviderOrderSummary(normalized)
  }
...
function renderPhoneSmsProviderOrderMenu() {
  ...
  const selectedOrder = normalizePhoneSmsProviderOrderValue(
  ...
  Array.from(selectPhoneSmsProviderOrder.options || []).forEach((option) => {
    ...
    const orderIndex = active
      ? selectedOrder.findIndex((entry) => entry === provider) + 1
      : 0
...
function syncPhoneSmsProviderOrderFromSelect(options = {}) {
  const selectionLimit = Math.max(
    1,
    Math.floor(
      Number(options.maxSelection) || DEFAULT_PHONE_SMS_PROVIDER_ORDER.length
    )
  )
  ...
  let nextOrder = phoneSmsProviderOrderSelection.filter((provider) =>
  ...
  if (enforceMax && nextOrder.length > selectionLimit) {
    ...
    if (showLimitToast && droppedCount > 0 && typeof showToast === 'function') {
      showToast(
        `服务商顺序最多 ${selectionLimit} 个，已保留前 ${selectionLimit} 个。`,
        'warn',
        2200
      )
    }
...
function getSelectedPhoneSmsProvider() {
  ...
  const normalized = normalizePhoneSmsProviderValue(
    selectPhoneSmsProvider.value
  )
...
function normalizeSmsbowerCountryIdValue(
  value,
  fallback = DEFAULT_SMSBOWER_COUNTRY_ORDER[0]
) {
  const parsed = Math.floor(Number(value))
  if (Number.isFinite(parsed) && parsed >= 0) {
    return parsed
...
function normalizeSmsbowerCountryLabelValue(value = '', fallback = '') {
  return String(value || '').trim() || fallback
}
...
function normalizeSmsbowerServiceCodeValue(value = '') {
  const normalized = String(value || '')
    ...
    .toLowerCase()
    .replace(/[^a-z0-9_-]/g, '')
  return normalized || DEFAULT_SMSBOWER_SERVICE_CODE
}
...
function normalizeSmsbowerBaseUrlValue(value = '') {
  const rawValue = String(value || DEFAULT_SMSBOWER_BASE_URL).trim()
  try {
    return new URL(rawValue).toString()
  } catch {
...
function getSelectedSmsbowerCountry() {
  const countryOrder = normalizeSmsbowerCountryOrderValue(
    inputSmsbowerCountryOrder?.value ||
      latestState?.smsbowerCountryOrder ||
      DEFAULT_SMSBOWER_COUNTRY_ORDER
  )
  const countryId = countryOrder[0] ?? DEFAULT_SMSBOWER_COUNTRY_ORDER[0]
  return {
    id: countryId,
...
function normalizeFiveSimCountryFallbackList(value = []) {
  ...
  source.forEach((entry) => {
    ...
    let label = ''
    if (entry && typeof entry === 'object' && !Array.isArray(entry)) {
      code = normalizeFiveSimCountryCode(
...
function normalizeNexSmsCountryFallbackList(value = []) {
  ...
  source.forEach((entry) => {
    ...
    let label = ''
    if (entry && typeof entry === 'object' && !Array.isArray(entry)) {
      countryId = normalizeNexSmsCountryIdValue(
        entry.id || entry.countryId || entry.country || '',
        -1
      )
      label = normalizeNexSmsCountryLabel(
        entry.label || entry.countryLabel || ''
      )
    } else {
...
function getFiveSimCountryDisplayNameByIso(isoCode = '') {
  const normalizedIso = String(isoCode || '')
    .trim()
    .toUpperCase()
  if (
    !normalizedIso ||
...
function buildFiveSimCountryDisplayLabel(country = {}) {
  const code = normalizeFiveSimCountryCode(
    country.code || country.id || country.country || '',
    'thailand'
  )
  const english = String(
    country.text_en || country.eng || country.english || code
  ).trim()
  const iso = String(
    country.isoCode || country.iso || country.countryCode || ''
  )
    .trim()
    .toUpperCase()
  const chinese = getFiveSimCountryDisplayNameByIso(iso)
  const base =
    chinese && english ? `${chinese} (${english})` : chinese || english || code
...
function parseFiveSimCountriesPayload(payload = {}) {
  ...
  const entries = Object.entries(payload)
    .map(([countryCode, details]) => {
      const isoObject =
        details?.iso && typeof details.iso === 'object' ? details.iso : {}
...
function normalizePhoneVerificationReplacementLimit(
  value,
  fallback = DEFAULT_PHONE_VERIFICATION_REPLACEMENT_LIMIT
) {
  const rawValue = String(value ?? '').trim()
  ...
  if (!Number.isFinite(parsed)) {
    return Math.max(
      ...
      Math.min(
        ...
        Number(fallback) || DEFAULT_PHONE_VERIFICATION_REPLACEMENT_LIMIT
      )
    )
  }
  return Math.max(
    PHONE_REPLACEMENT_LIMIT_MIN,
    Math.min(PHONE_REPLACEMENT_LIMIT_MAX, parsed)
  )
}

function normalizePhoneCodeWaitSecondsValue(
  value,
  fallback = DEFAULT_PHONE_CODE_WAIT_SECONDS
) {
  const rawValue = String(value ?? '').trim()
  const parsed = Number.parseInt(rawValue, 10)
  if (!Number.isFinite(parsed)) {
    return Math.max(
      ...
      Math.min(
        ...
        Number(fallback) || DEFAULT_PHONE_CODE_WAIT_SECONDS
      )
    )
  }
  return Math.max(
    PHONE_CODE_WAIT_SECONDS_MIN,
    Math.min(PHONE_CODE_WAIT_SECONDS_MAX, parsed)
  )
}

function normalizePhoneCodeTimeoutWindowsValue(
  value,
  fallback = DEFAULT_PHONE_CODE_TIMEOUT_WINDOWS
) {
  const rawValue = String(value ?? '').trim()
  const parsed = Number.parseInt(rawValue, 10)
  if (!Number.isFinite(parsed)) {
    return Math.max(
      ...
      Math.min(
        ...
        Number(fallback) || DEFAULT_PHONE_CODE_TIMEOUT_WINDOWS
      )
    )
  }
  return Math.max(
    PHONE_CODE_TIMEOUT_WINDOWS_MIN,
    Math.min(PHONE_CODE_TIMEOUT_WINDOWS_MAX, parsed)
  )
}

function normalizePhoneCodePollIntervalSecondsValue(
  value,
  fallback = DEFAULT_PHONE_CODE_POLL_INTERVAL_SECONDS
) {
  const rawValue = String(value ?? '').trim()
  const parsed = Number.parseInt(rawValue, 10)
  if (!Number.isFinite(parsed)) {
    return Math.max(
      ...
      Math.min(
        ...
        Number(fallback) || DEFAULT_PHONE_CODE_POLL_INTERVAL_SECONDS
      )
    )
  }
  return Math.max(
    PHONE_CODE_POLL_INTERVAL_SECONDS_MIN,
    Math.min(PHONE_CODE_POLL_INTERVAL_SECONDS_MAX, parsed)
  )
}

function normalizePhoneCodePollMaxRoundsValue(
  value,
  fallback = DEFAULT_PHONE_CODE_POLL_MAX_ROUNDS
) {
  const rawValue = String(value ?? '').trim()
  const parsed = Number.parseInt(rawValue, 10)
  if (!Number.isFinite(parsed)) {
    return Math.max(
      ...
      Math.min(
        PHONE_CODE_POLL_MAX_ROUNDS_MAX,
        Number(fallback) || DEFAULT_PHONE_CODE_POLL_MAX_ROUNDS
      )
    )
  }
  return Math.max(
    PHONE_CODE_POLL_MAX_ROUNDS_MIN,
    Math.min(PHONE_CODE_POLL_MAX_ROUNDS_MAX, parsed)
  )
}
...
function collectHeroSmsCountrySearchTokens(value, tokens, depth = 0) {
  ...
  if (Array.isArray(value)) {
    value.forEach((entry) =>
      collectHeroSmsCountrySearchTokens(entry, tokens, depth + 1)
    )
    return
  }
...
function buildHeroSmsCountrySearchText(country = {}, label = '', id = '') {
  ...
  collectHeroSmsCountryCodeAliases(country, label).forEach((alias) =>
    tokens.add(alias)
  )
  return Array.from(tokens).join(' ')
}
...
function collectHeroSmsPriceEntriesForPreview(payload, entries = []) {
  ...
  const cost = normalizeHeroSmsPriceForPreview(
    payload.cost ?? payload.price ?? payload.Price
  )
  if (cost !== null) {
    ...
    const stockCount = hasPhysicalCount ? physicalCount : hasCount ? count : 0
  ...
  Object.entries(payload).forEach(([key, value]) => {
    ...
    if (value && typeof value === 'object') {
      ...
      const looksLikeDecimalPriceKey =
        /^-?\d+[.,]\d+$/.test(trimmedKey) ||
...
function collectHeroSmsPriceEntriesFromTopCountriesPayload(
  payload,
  countryId,
  entries = []
) {
...
function collectHeroSmsPriceEntriesFromVerificationPayload(
  payload,
  countryId,
  serviceCode = 'dr',
  entries = []
  ...
  if (
    !serviceNode ||
    typeof serviceNode !== 'object' ||
    Array.isArray(serviceNode)
  ) {
    return entries
  }
  ...
  if (
    !countryNode ||
    typeof countryNode !== 'object' ||
    Array.isArray(countryNode)
  ) {
    return entries
  }
...
function formatPhoneSmsPriceEntriesSummary(payload) {
  const entries = collectHeroSmsPriceEntriesForPreview(payload, []).filter(
    (entry) => Number.isFinite(Number(entry.cost)) && Number(entry.cost) > 0
  )
  const inStockPrices = Array.from(
    new Set(
      entries
        .filter((entry) => entry.inStock)
...
function describeHeroSmsPreviewPayload(payload) {
  ...
  if (typeof payload === 'object') {
    ...
    if (directMessage) {
      const extra = String(
        payload?.info?.text || payload?.info?.description || ''
      ).trim()
...
function summarizeHeroSmsPreviewError(payload, responseStatus = 0) {
  ...
  if (
    /UNPROCESSABLE_ENTITY/i.test(text) &&
    /api_key/i.test(text) &&
...
function formatPriceTiersForPreview(entries = [], options = {}) {
  ...
  const suffix =
    normalized.length > limit ? ` ... +${normalized.length - limit} 档` : ''
  return (
    displayed
      .map((entry) => {
        const priceText =
          formatHeroSmsPriceForPreview(entry.price) || String(entry.price)
...
function getFiveSimCountryOptionLabel(code = '') {
  ...
  const matched = Array.from(selectFiveSimCountry?.options || []).find(
    (option) => normalizeFiveSimCountryCode(option.value, '') === normalizedCode
  )
  if (matched) {
    return normalizeFiveSimCountryLabel(matched.textContent, normalizedCode)
  }
  const fallback = FIVE_SIM_SUPPORTED_COUNTRY_ITEMS.find(
    (item) => item.id === normalizedCode
  )
  return fallback
    ? formatFiveSimCountryDisplayLabel(fallback.id, fallback.eng, fallback.id)
    : normalizedCode
}
...
function getNexSmsCountryLabelById(id) {
  ...
  const matched = Array.from(selectNexSmsCountry?.options || []).find(
    (option) => normalizeNexSmsCountryIdValue(option.value, -1) === countryId
  )
  return normalizeNexSmsCountryLabel(
    matched?.textContent || '',
    `Country #${countryId}`
  )
}
...
function updateHeroSmsPlatformDisplay() {
  ...
  if (inputHeroSmsApiKey) {
    inputHeroSmsApiKey.placeholder =
      provider === PHONE_SMS_PROVIDER_FIVE_SIM
        ? '请输入 5sim API Key'
        : provider === PHONE_SMS_PROVIDER_NEXSMS
          ? '请输入 NexSMS API Key'
...
function getHeroSmsCountryLabelById(id) {
  ...
  const matched = Array.from(countrySelect.options).find(
    (option) => option.value === targetId
  )
  return (
    String(matched?.textContent || '').trim() ||
...
function setHeroSmsCountryMenuOpen(open) {
  ...
  if (heroSmsCountryMenu) {
    ...
    if (nextOpen) {
      const searchInput = heroSmsCountryMenu.querySelector(
...
function applyHeroSmsCountryMenuFilter(keyword = '') {
  ...
  const items = Array.from(
    heroSmsCountryMenu.querySelectorAll('.hero-sms-country-menu-item')
  )
  let visibleCount = 0
  items.forEach((item) => {
...
function updateHeroSmsCountryMenuSummary(selectedCountries = []) {
  ...
  const normalized = isFiveSimProviderSelected()
    ? normalizeFiveSimCountryFallbackList(selectedCountries)
    : normalizeHeroSmsCountryFallbackList(selectedCountries)
  if (!normalized.length) {
...
function renderHeroSmsCountryChoiceButtons() {
  ...
  options.forEach((option) => {
    ...
    const orderIndex = active
      ...
      : 0
    const label =
      String(option.textContent || '').trim() || `Country #${countryId}`
    item.classList.toggle('is-active', active)
    const labelText = document.createElement('span')
    labelText.className = 'hero-sms-country-menu-item-label'
...
function syncHeroSmsFallbackSelectionOrderFromSelect(options = {}) {
  ...
  const selectionLimit = Math.max(
    1,
    Math.floor(Number(options.maxSelection) || HERO_SMS_COUNTRY_SELECTION_MAX)
  )
  const enforceMax = options.enforceMax !== false
  const ensureDefault = options.ensureDefault !== false
  const showLimitToast = Boolean(options.showLimitToast)
  ...
  const selectedIds = Array.from(countrySelect.options)
    .filter((option) => option.selected)
    .map((option) =>
      normalizePhoneSmsCountryId(option.value, getSelectedPhoneSmsProvider())
    )
    .filter(Boolean)
  if (!selectedIds.length && !countrySelect.multiple) {
    const fallbackId = normalizePhoneSmsCountryId(
      countrySelect.value,
  ...
  let nextOrder = heroSmsCountrySelectionOrder.filter((id) =>
    selectedSet.has(id)
  )
  ...
  if (enforceMax && nextOrder.length > selectionLimit) {
    ...
    if (showLimitToast && droppedCount > 0 && typeof showToast === 'function') {
      showToast(
        `接码国家最多选择 ${selectionLimit} 个，已保留前 ${selectionLimit} 个。`,
        'warn',
        2200
      )
    }
...
function applyHeroSmsFallbackSelection(countries = [], options = {}) {
  ...
  const selectedIds = normalized
    .map((entry) =>
      normalizePhoneSmsCountryId(entry.id, getSelectedPhoneSmsProvider())
    )
    .filter(Boolean)
...
function removeHeroSmsCountryFromOrder(id) {
  ...
  heroSmsCountrySelectionOrder = heroSmsCountrySelectionOrder.filter(
  ...
  ;[selectHeroSmsCountry, selectHeroSmsCountryFallback].forEach((selectEl) => {
    ...
    Array.from(selectEl.options || []).forEach((option) => {
      if (
        String(normalizePhoneSmsCountryId(option.value, provider)) ===
        String(normalizedId)
      ) {
        option.selected = false
      }
...
function normalizePhoneActivationState(record = {}) {
  ...
  const provider = normalizePhoneSmsProviderValue(
    record.provider || latestState?.phoneSmsProvider || PHONE_SMS_PROVIDER_HERO
  )
...
function syncPhoneRuntimeCountdown(state = {}) {
  phoneRuntimeCountdownEndsAt = Math.max(
    0,
    Number(state?.currentPhoneVerificationCountdownEndsAt) || 0
  )
  phoneRuntimeCountdownWindowIndex = Math.max(
    0,
    Math.floor(Number(state?.currentPhoneVerificationCountdownWindowIndex) || 0)
  )
  phoneRuntimeCountdownWindowTotal = Math.max(
    0,
    Math.floor(Number(state?.currentPhoneVerificationCountdownWindowTotal) || 0)
  )
...
function renderPhonePreferredActivationOptions(state = {}) {
  ...
  const selectedPreferred = normalizePhoneActivationState(
    state?.phonePreferredActivation || latestState?.phonePreferredActivation
  )
  const reusablePool = Array.isArray(state?.phoneReusableActivationPool)
    ? state.phoneReusableActivationPool
    : Array.isArray(latestState?.phoneReusableActivationPool)
      ? latestState.phoneReusableActivationPool
      : []
  const optionEntries = []
  const seen = new Set()
...
function updateHeroSmsRuntimeDisplay(state = {}) {
  if (displayHeroSmsCurrentNumber) {
    const activation = normalizePhoneActivationState(
      state?.currentPhoneActivation || latestState?.currentPhoneActivation
    )
  ...
  if (displayHeroSmsCurrentCode) {
    const code = String(
      state?.currentPhoneVerificationCode ??
  ...
  if (
    displayFreeReusablePhone ||
    displayFreeReusablePhoneCountry ||
    inputFreeReusablePhone
  ) {
    const activation =
      state?.freeReusablePhoneActivation ??
      latestState?.freeReusablePhoneActivation ??
      null
    const phoneNumber = String(activation?.phoneNumber || '').trim()
    const activationId = String(activation?.activationId || '').trim()
    ...
    const countryLabel = normalizePhoneSmsCountryLabel(
      activation?.countryLabel ||
        ...
        getHeroSmsCountryLabelById(
          state?.heroSmsCountryId || latestState?.heroSmsCountryId || ''
        ),
      activation?.provider || getSelectedPhoneSmsProvider()
    )
    const usesText =
      successfulUses !== null || maxUses !== null
...
function applyFreeReusablePhoneMutationResult(
  refreshedState = {},
  mutationResult = {},
  options = {}
) {
...
async function refreshFreeReusablePhoneStateFallback(
  mutationResult = {},
  options = {}
) {
  if (
  ...
  try {
    const refreshedState = await chrome.runtime.sendMessage({
      type: 'GET_STATE',
      source: 'sidepanel'
    })
    applyFreeReusablePhoneMutationResult(
      refreshedState || latestState,
      mutationResult,
      options
    )
  } catch (error) {
...
async function loadHeroSmsCountries() {
    ...
    try {
      ...
      const optionItems = Object.entries(countriesPayload)
        .map(([slug, entry]) => {
          ...
          const label = formatFiveSimCountryDisplayLabel(
            id,
            entry?.text_en || slug,
            slug
          )
      ...
      if (typeof showToast === 'function') {
        showToast(
          `5sim 国家列表加载失败：${normalizeHeroSmsFetchErrorMessage(error)}（已切换为内置国家列表）`,
          'warn',
          2800
        )
      }
    ...
    try {
      ...
      const optionItems = countries
        .filter(
          (item) =>
            Number(item?.id) > 0 &&
            (String(item?.eng || '').trim() || String(item?.chn || '').trim())
        )
        .sort((left, right) =>
          String(left.eng || '').localeCompare(String(right.eng || ''))
        )
        .map((item) => {
      ...
      const fallbackItems = HERO_SMS_FALLBACK_COUNTRY_ITEMS.map((item) => {
        const id = normalizeHeroSmsCountryId(item.id)
        const label = buildHeroSmsCountryDisplayLabel(item)
        return {
          id,
      ...
      if (
        !fallbackItems.some((item) => item.id === DEFAULT_HERO_SMS_COUNTRY_ID)
      ) {
      ...
      if (typeof showToast === 'function') {
        showToast(
          `国家列表加载失败：${normalizeHeroSmsFetchErrorMessage(error)}（已切换为内置国家列表）`,
          'warn',
          2800
        )
      }
  ...
  const availableIds = new Set(
    Array.from(countrySelect.options).map((option) => String(option.value))
  )
...
function getFiveSimCountryLabelByCode(code = '') {
  ...
  const matched = Array.from(selectFiveSimCountry.options || []).find(
    (option) => String(option.value || '').trim() === normalizedCode
  )
  return normalizeFiveSimCountryLabel(
    matched?.textContent || '',
    normalizedCode
  )
}
...
function setFiveSimCountryMenuOpen(open) {
  ...
  if (fiveSimCountryMenu) {
    ...
    if (nextOpen) {
      const searchInput = fiveSimCountryMenu.querySelector(
        '.hero-sms-country-menu-search-input'
      )
      if (searchInput) {
...
function applyFiveSimCountryMenuFilter(keyword = '') {
  ...
  const normalizedKeyword = String(keyword || '')
    ...
    .toLowerCase()
  const items = Array.from(
    fiveSimCountryMenu.querySelectorAll('.hero-sms-country-menu-item')
  )
  let visibleCount = 0
  items.forEach((item) => {
    const haystack = String(item.dataset.searchText || '').toLowerCase()
...
function renderFiveSimCountryChoiceButtons() {
  ...
  options.forEach((option) => {
    ...
    item.dataset.searchText =
      fiveSimCountrySearchTextByCode.get(countryId) ||
...
function syncFiveSimCountrySelectionOrderFromSelect(options = {}) {
  ...
  let nextOrder = fiveSimCountrySelectionOrder.filter((code) =>
  ...
  if (ensureDefault && !nextOrder.length) {
    nextOrder = [
      normalizeFiveSimCountryCode(
        countrySelect.value || DEFAULT_FIVE_SIM_COUNTRY_ID
      )
    ]
  }
  if (enforceMax && nextOrder.length > selectionLimit) {
    ...
    if (showLimitToast && droppedCount > 0 && typeof showToast === 'function') {
      showToast(
        `5sim 国家最多选择 ${selectionLimit} 个，已保留前 ${selectionLimit} 个。`,
        'warn',
        2200
      )
    }
  ...
  const nextOrderSet = new Set(nextOrder)
  Array.from(countrySelect.options || []).forEach((option) => {
    option.selected = nextOrderSet.has(
      normalizeFiveSimCountryCode(option.value, '')
    )
  })
...
function applyFiveSimCountrySelection(countries = [], options = {}) {
  const normalized = normalizeFiveSimCountryFallbackList(countries).slice(
    0,
  ...
  if (selectFiveSimCountry) {
    ...
    Array.from(selectFiveSimCountry.options || []).forEach((option) => {
      option.selected = selectedSet.has(
        normalizeFiveSimCountryCode(option.value, '')
      )
    })
  }
...
function toggleFiveSimCountryInOrder(code = '') {
  ...
  const option = Array.from(selectFiveSimCountry.options || []).find(
    (entry) => normalizeFiveSimCountryCode(entry.value, '') === normalizedCode
  )
  if (option) {
    option.selected = !option.selected
  }
...
function removeFiveSimCountryFromOrder(code = '') {
  const normalizedCode = normalizeFiveSimCountryCode(code, '')
  fiveSimCountrySelectionOrder = fiveSimCountrySelectionOrder.filter(
...
async function loadFiveSimCountries() {
  ...
  const applyOptions = (items = []) => {
    ...
    items.forEach((entry) => {
      ...
      option.value = code
      option.textContent =
        entry.label || getFiveSimCountryOptionLabel(code) || code
      selectFiveSimCountry.appendChild(option)
      fiveSimCountrySearchTextByCode.set(
        code,
        entry.searchText || `${option.textContent} ${code}`
      )
    })
  }
  const fallbackItems = FIVE_SIM_SUPPORTED_COUNTRY_ITEMS.map((item) => ({
...
function setNexSmsCountryMenuOpen(open) {
  ...
  if (nexSmsCountryMenu) {
    ...
    if (nextOpen) {
      const searchInput = nexSmsCountryMenu.querySelector(
        '.hero-sms-country-menu-search-input'
      )
      if (searchInput) {
...
function applyNexSmsCountryMenuFilter(keyword = '') {
  ...
  const normalizedKeyword = String(keyword || '')
    ...
    .toLowerCase()
  const items = Array.from(
    nexSmsCountryMenu.querySelectorAll('.hero-sms-country-menu-item')
  )
  let visibleCount = 0
  items.forEach((item) => {
    const haystack = String(item.dataset.searchText || '').toLowerCase()
...
function renderNexSmsCountryChoiceButtons() {
  ...
  options.forEach((option) => {
    ...
    item.dataset.searchText =
      nexSmsCountrySearchTextById.get(countryId) ||
      `${countryId} ${option.textContent || ''}`
    const selected = selectedSet.has(countryId)
    item.setAttribute('aria-pressed', selected ? 'true' : 'false')
...
function syncNexSmsCountrySelectionOrderFromSelect(options = {}) {
  ...
  const selectedIds = Array.from(countrySelect.options || [])
    ...
    .filter((id) => id >= 0)
  const selectedSet = new Set(selectedIds)
  let nextOrder = nexSmsCountrySelectionOrder.filter((id) =>
    selectedSet.has(id)
  )
  selectedIds.forEach((id) => {
    if (!nextOrder.includes(id)) {
  ...
  if (ensureDefault && !nextOrder.length) {
    nextOrder = [
      normalizeNexSmsCountryIdValue(DEFAULT_NEX_SMS_COUNTRY_ORDER[0], 1)
    ]
  }
  if (enforceMax && nextOrder.length > selectionLimit) {
    const droppedCount = nextOrder.length - selectionLimit
    ...
    if (showLimitToast && droppedCount > 0 && typeof showToast === 'function') {
      showToast(
        `NexSMS 国家最多选择 ${selectionLimit} 个，已保留前 ${selectionLimit} 个。`,
        'warn',
        2200
      )
    }
  ...
  Array.from(countrySelect.options || []).forEach((option) => {
    option.selected = nextOrderSet.has(
      normalizeNexSmsCountryIdValue(option.value, -1)
    )
  })
...
function applyNexSmsCountrySelection(countries = [], options = {}) {
  const normalized = normalizeNexSmsCountryFallbackList(countries).slice(
    0,
    HERO_SMS_COUNTRY_SELECTION_MAX
  )
  const selectedIds = normalized
...
function toggleNexSmsCountryInOrder(id = -1) {
  ...
  const option = Array.from(selectNexSmsCountry.options || []).find(
    (entry) => normalizeNexSmsCountryIdValue(entry.value, -1) === countryId
  )
  if (option) {
    option.selected = !option.selected
  }
...
function removeNexSmsCountryFromOrder(id = -1) {
  const countryId = normalizeNexSmsCountryIdValue(id, -1)
  nexSmsCountrySelectionOrder = nexSmsCountrySelectionOrder.filter(
    (entry) => entry !== countryId
  )
  if (selectNexSmsCountry) {
    Array.from(selectNexSmsCountry.options || []).forEach((option) => {
...
async function loadNexSmsCountries() {
  ...
  NEX_SMS_FALLBACK_COUNTRY_ITEMS.forEach((entry) => {
    ...
    nexSmsCountrySearchTextById.set(
      id,
      entry.searchText || `${option.textContent} ${id}`
    )
  })
...
async function buildNexSmsPricePreviewLines(options = {}) {
  ...
  const serviceCode = normalizeNexSmsServiceCodeValue(
    inputNexSmsServiceCode?.value ||
      latestState?.nexSmsServiceCode ||
      DEFAULT_NEX_SMS_SERVICE_CODE
  )
  const maxPriceText = normalizeHeroSmsMaxPriceValue(
    inputHeroSmsMaxPrice?.value || ''
  )
  ...
  for (const countryId of countryIds) {
    const countryLabel =
      getNexSmsCountryLabelById(countryId) || `Country #${countryId}`
    try {
      ...
      if (!response.ok || Number(payload?.code) !== 0) {
        previews.push(
          `${countryLabel}: ${describeNexSmsPreviewPayload(payload) || `HTTP ${response.status}`}`
        )
        continue
      }
      const data = payload?.data || {}
      const tierEntries =
        data?.priceMap && typeof data.priceMap === 'object'
      ...
      const uniqueSorted = Array.from(new Set(availablePrices)).sort(
      ...
      if (Number.isFinite(maxPrice) && maxPrice > 0 && lowest > maxPrice) {
        previews.push(
          `${countryLabel}: 最低 ${lowest}（高于上限 ${maxPrice}）${tierText ? `；档位：${tierText}` : ''}`
        )
      } else {
        previews.push(
          `${countryLabel}: 最低 ${lowest}${tierText ? `；档位：${tierText}` : ''}`
        )
      }
    } catch (error) {
      previews.push(
        `${countryLabel}: 查询失败（${normalizeHeroSmsFetchErrorMessage(error)}）`
      )
    }
  }
...
async function previewFiveSimPriceTiers() {
  ...
  const product = normalizeFiveSimProductValue(
    inputFiveSimProduct?.value ||
      latestState?.fiveSimProduct ||
      DEFAULT_FIVE_SIM_PRODUCT
  )
  const maxPriceText = normalizeHeroSmsMaxPriceValue(
    inputHeroSmsMaxPrice?.value || ''
  ...
  for (const countryCode of countryCodes) {
    const countryLabel =
      getFiveSimCountryLabelByCode(countryCode) || countryCode
    try {
      ...
      const prices = tierEntries
        .filter((entry) => entry.count === null || entry.count > 0)
        .map((entry) => entry.price)
      const uniqueSorted = Array.from(new Set(prices)).sort(
        (left, right) => left - right
      )
...
async function buildSmsbowerPricePreviewLines(options = {}) {
  const countryIds = normalizeSmsbowerCountryOrderValue(
    inputSmsbowerCountryOrder?.value ||
      latestState?.smsbowerCountryOrder ||
      DEFAULT_SMSBOWER_COUNTRY_ORDER
  )
  ...
  const maxPriceText = normalizeSmsbowerMaxPriceValue(
    inputSmsbowerMaxPrice?.value || latestState?.smsbowerMaxPrice || ''
  )
  const maxPrice = maxPriceText ? Number(maxPriceText) : null
  const apiKey = String(inputSmsbowerApiKey?.value || '').trim()
  const baseUrl = normalizeSmsbowerBaseUrlValue(
    inputSmsbowerBaseUrl?.value || latestState?.smsbowerBaseUrl || DEFAULT_SMSBOWER_BASE_URL
  )
  const providerLabel = String(options?.providerLabel || 'smsbower.app').trim()

  if (!apiKey) {
    return [`${providerLabel}: 请先填写 smsbower API Key`]
  }
  if (!countryIds.length) {
    return [`${providerLabel}: 请先填写至少 1 个国家 ID`]
  }
  ...
  const collectPriceEntries = (payload, entries = []) => {
    ...
    const directCost = Number(payload.cost ?? payload.price ?? payload.Price)
    const directCount = Number(
      payload.count ?? payload.qty ?? payload.Qty ?? payload.available
    )
    if (Number.isFinite(directCost) && directCost > 0) {
      entries.push({
        price: Math.round(directCost * 10000) / 10000,
    ...
    Object.entries(payload).forEach(([key, value]) => {
      ...
      if (value && typeof value === 'object') {
        const keyedCount = Number(value.count ?? value.qty ?? value.Qty ?? value.available)
        entries.push({
          price: Math.round(keyedPrice * 10000) / 10000,
          count: Number.isFinite(keyedCount) ? Math.max(0, Math.floor(keyedCount)) : null
        })
        return
      }
      const numericCount = Number(value)
  ...
  const previews = []
  for (const countryId of countryIds) {
    const countryLabel = `Country #${countryId}`
    try {
...
async function previewHeroSmsPriceTiers() {
  const normalizeProvider =
    typeof normalizePhoneSmsProviderValue === 'function'
  ...
  const fiveSimProviderValue =
    typeof PHONE_SMS_PROVIDER_FIVE_SIM !== 'undefined'
      ? PHONE_SMS_PROVIDER_FIVE_SIM
      : '5sim'
  const nexSmsProviderValue =
    typeof PHONE_SMS_PROVIDER_NEXSMS !== 'undefined'
      ? PHONE_SMS_PROVIDER_NEXSMS
      : 'nexsms'
  const smsbowerProviderValue =
    typeof PHONE_SMS_PROVIDER_SMSBOWER !== 'undefined'
      ? PHONE_SMS_PROVIDER_SMSBOWER
      : 'smsbower'
  const heroProviderValue =
    typeof PHONE_SMS_PROVIDER_HERO !== 'undefined'
      ? PHONE_SMS_PROVIDER_HERO
      : 'hero-sms'
  const defaultProviderValue =
    typeof DEFAULT_PHONE_SMS_PROVIDER !== 'undefined'
      ? DEFAULT_PHONE_SMS_PROVIDER
      : 'hero-sms'
  ...
  for (const provider of providerOrder) {
    if (provider === fiveSimProviderValue) {
      const lines = await buildFiveSimPricePreviewLines({
        providerLabel: '5sim'
      })
      previews.push(...lines, '')
      continue
    ...
    if (provider === nexSmsProviderValue) {
      const lines = await buildNexSmsPricePreviewLines({
    ...
    if (provider === smsbowerProviderValue) {
      const lines = await buildSmsbowerPricePreviewLines({
        providerLabel: 'smsbower.app'
      })
      previews.push(...lines, '')
      continue
    }
    ...
    for (const country of candidates) {
      ...
      try {
        ...
        const fetchPriceAction = async (action) => {
          ...
          if (!response.ok) {
            const reason = summarizeHeroSmsPreviewError(
              payload,
              response.status
            )
        ...
        const priceEntries = parsedPayloads
          ...
          .concat(
            collectHeroSmsPriceEntriesFromTopCountriesPayload(
              topCountriesPayload,
              countryId,
              []
            ),
            collectHeroSmsPriceEntriesFromVerificationPayload(
              verificationPayload,
              countryId,
              'dr',
              []
        ...
        for (const entry of priceEntries) {
          ...
          const stockCount = Number.isFinite(Number(entry.stockCount))
            ? Math.max(0, Number(entry.stockCount))
            : 0
          const previous = tierStockByPrice.get(cost)
          tierStockByPrice.set(
            cost,
            Number.isFinite(previous)
              ? Math.max(previous, stockCount)
              : stockCount
          )
        }
        const allPrices = Array.from(tierStockByPrice.keys()).sort(
          (left, right) => left - right
        )
        const inStockPrices = allPrices.filter(
          (price) => Number(tierStockByPrice.get(price)) > 0
        )
        const tierEntries = allPrices.map((price) => ({
          price,
          count: Math.max(0, Number(tierStockByPrice.get(price)) || 0)
        }))
        const withinLimitInStockPrices =
          Number.isFinite(maxPrice) && maxPrice > 0
            ? inStockPrices.filter((price) => price <= maxPrice)
            : inStockPrices
        const tierPreviewText = formatPriceTiersWithZeroStockForPreview(
          tierEntries,
          { maxPrice }
        )
        if (!inStockPrices.length) {
          if (allPrices.length) {
            const lowestKnown =
              formatHeroSmsPriceForPreview(allPrices[0]) || String(allPrices[0])
            heroLines.push(
              `${countryLabel}: 全档位均无库存（最低标价 ${lowestKnown}）${tierPreviewText ? `；档位：${tierPreviewText}` : ''}`
            )
            continue
          }
        ...
        if (
          ...
          maxPrice > 0 &&
          !withinLimitInStockPrices.length
        ) {
          const lowestInStockText =
            formatHeroSmsPriceForPreview(inStockPrices[0]) ||
            String(inStockPrices[0])
          heroLines.push(
            `${countryLabel}: 上限内无可用号源（上限 ${formatHeroSmsPriceForPreview(maxPrice) || maxPrice}，最低可用 ${lowestInStockText}）${tierPreviewText ? `；档位：${tierPreviewText}` : ''}`
          )
        } else {
          const lowestWithinLimit = withinLimitInStockPrices[0]
          const lowestText =
            formatHeroSmsPriceForPreview(lowestWithinLimit) ||
            String(lowestWithinLimit)
          heroLines.push(
            `${countryLabel}: 上限内最低 ${lowestText}${tierPreviewText ? `；档位：${tierPreviewText}` : ''}`
          )
        }
      } catch (error) {
        heroLines.push(
...
async function previewPhoneSmsBalance() {
  ...
  try {
    const url = provider === PHONE_SMS_PROVIDER_FIVE_SIM
      ...
      : provider === PHONE_SMS_PROVIDER_SMSBOWER
        ? new URL(normalizeSmsbowerBaseUrlValue(inputSmsbowerBaseUrl?.value || latestState?.smsbowerBaseUrl || DEFAULT_SMSBOWER_BASE_URL))
    ...
    if (provider === PHONE_SMS_PROVIDER_FIVE_SIM) {
      ...
      const text = describeHeroSmsPreviewPayload(payload)
        .replace(/^ACCESS_BALANCE:/i, '')
        .trim()
      displayPhoneSmsBalance.textContent = `smsbower.app 余额 ${text || '未知'}`
    } else {
      const text = describeHeroSmsPreviewPayload(payload)
        .replace(/^ACCESS_BALANCE:/i, '')
        .trim()
...
function getSelectedLocalCpaStep9Mode() {
  const activeButton = localCpaStep9ModeButtons.find((button) =>
...
function getSelectedMail2925Mode() {
  const activeButton = mail2925ModeButtons.find((button) =>
    button.classList.contains('is-active')
  )
...
function getSelectedHotmailServiceMode() {
  const activeButton = hotmailServiceModeButtons.find((button) =>
    button.classList.contains('is-active')
  )
...
function resolveStepDefinitionCapabilityState(
  state = latestState,
  options = {}
) {
  const nextState = {
  ...
  return {
    ...
    signupMethod:
      ...
      normalizeSignupMethod(
        (options?.signupMethod ?? nextState?.signupMethod) ||
          DEFAULT_SIGNUP_METHOD
      )
  }
}
...
function getSelectedSignupMethod() {
  const activeButton = signupMethodButtons.find((button) =>
    button.classList.contains('is-active')
  )
  return normalizeSignupMethod(
    activeButton?.dataset.signupMethod ||
...
function setSignupMethod(method) {
  ...
  signupMethodButtons.forEach((button) => {
    const active =
      normalizeSignupMethod(button.dataset.signupMethod) === resolvedMethod
    button.classList.toggle('is-active', active)
    button.setAttribute('aria-pressed', String(active))
  })
...
function canSelectPhoneSignupMethod() {
  ...
  if (
    capabilityState &&
    typeof capabilityState.canSelectPhoneSignup === 'boolean'
  ) {
...
function updateSignupMethodUI(options = {}) {
  ...
  signupMethodButtons.forEach((button) => {
    ...
    const disabled =
      locked || (method === SIGNUP_METHOD_PHONE && !phoneSelectable)
    ...
    if (method === SIGNUP_METHOD_PHONE) {
      if (!Boolean(inputPhoneVerificationEnabled?.checked)) {
        ...
        typeof inputPlusModeEnabled !== 'undefined' &&
        inputPlusModeEnabled?.checked
      ) {
  ...
  const stepDefinitionState =
    typeof resolveStepDefinitionCapabilityState === 'function'
...
function updatePhoneVerificationSettingsUI() {
  ...
  const smsbowerProviderValue =
    typeof PHONE_SMS_PROVIDER_SMSBOWER !== 'undefined'
      ? PHONE_SMS_PROVIDER_SMSBOWER
      : 'smsbower'
  const providerOrderForDisplay = resolveNormalizedProviderOrderForRuntime(
    latestState || {}
  )
  const provider =
  ...
  if (rowPhoneVerificationEnabled) {
    rowPhoneVerificationEnabled.style.display = canShowPhoneSettings
      ? ''
      : 'none'
  }
  ...
  if (btnTogglePhoneVerificationSection) {
    ...
    btnTogglePhoneVerificationSection.textContent = showSettings
      ? '收起设置'
      : '展开设置'
    btnTogglePhoneVerificationSection.title = enabled
      ? showSettings
        ...
        : '展开接码设置'
      : '开启接码后可展开设置'
    btnTogglePhoneVerificationSection.setAttribute(
      'aria-expanded',
      String(showSettings)
    )
  }
  ...
  const phoneVerificationRows = [
    ...
    typeof rowPhoneSmsProviderOrder !== 'undefined'
      ? rowPhoneSmsProviderOrder
      : null,
    typeof rowPhoneSmsProviderOrderActions !== 'undefined'
      ? rowPhoneSmsProviderOrderActions
      : null,
    typeof rowHeroSmsCountry !== 'undefined' ? rowHeroSmsCountry : null,
    typeof rowHeroSmsCountryFallback !== 'undefined'
      ? rowHeroSmsCountryFallback
      : null,
    typeof rowHeroSmsAcquirePriority !== 'undefined'
    ...
    typeof rowFiveSimCountryFallback !== 'undefined'
    ...
    typeof rowNexSmsCountryFallback !== 'undefined'
    ...
    typeof rowSmsbowerBaseUrl !== 'undefined' ? rowSmsbowerBaseUrl : null,
    typeof rowSmsbowerCountryOrder !== 'undefined'
      ? rowSmsbowerCountryOrder
      : null,
    typeof rowSmsbowerServiceCode !== 'undefined'
      ? rowSmsbowerServiceCode
      : null,
    typeof rowSmsbowerMaxPrice !== 'undefined' ? rowSmsbowerMaxPrice : null,
    typeof rowHeroSmsMaxPrice !== 'undefined' ? rowHeroSmsMaxPrice : null,
    typeof rowFiveSimOperator !== 'undefined' ? rowFiveSimOperator : null,
    typeof rowPhoneCodeSettingsGroup !== 'undefined'
      ? rowPhoneCodeSettingsGroup
      : null,
    typeof rowPhoneVerificationResendCount !== 'undefined'
      ? rowPhoneVerificationResendCount
      : null,
    typeof rowPhoneReplacementLimit !== 'undefined'
      ? rowPhoneReplacementLimit
      : null,
    typeof rowPhoneCodeWaitSeconds !== 'undefined'
      ? rowPhoneCodeWaitSeconds
      : null,
    typeof rowPhoneCodeTimeoutWindows !== 'undefined'
      ? rowPhoneCodeTimeoutWindows
      : null,
    typeof rowPhoneCodePollIntervalSeconds !== 'undefined'
      ? rowPhoneCodePollIntervalSeconds
      : null,
    typeof rowPhoneCodePollMaxRounds !== 'undefined'
      ? rowPhoneCodePollMaxRounds
      : null,
    typeof rowFreePhoneReuseEnabled !== 'undefined'
      ? rowFreePhoneReuseEnabled
      : null,
    typeof rowFreePhoneReuseAutoEnabled !== 'undefined'
  ...
  if (rowHeroSmsCountry)
    rowHeroSmsCountry.style.display = showSettings && heroProvider ? '' : 'none'
  if (rowHeroSmsCountryFallback)
    rowHeroSmsCountryFallback.style.display =
      showSettings && heroProvider ? '' : 'none'
  if (rowHeroSmsAcquirePriority)
    rowHeroSmsAcquirePriority.style.display =
      showSettings && heroProvider ? '' : 'none'
  if (rowHeroSmsApiKey)
    rowHeroSmsApiKey.style.display = showSettings && heroProvider ? '' : 'none'
  if (rowFiveSimApiKey)
    rowFiveSimApiKey.style.display =
      showSettings && fiveSimProvider ? '' : 'none'
  if (rowFiveSimCountry)
    rowFiveSimCountry.style.display =
      showSettings && fiveSimProvider ? '' : 'none'
  if (rowFiveSimCountryFallback)
    rowFiveSimCountryFallback.style.display =
      showSettings && fiveSimProvider ? '' : 'none'
  if (rowFiveSimOperator)
    rowFiveSimOperator.style.display =
      showSettings && fiveSimProvider ? '' : 'none'
  if (rowFiveSimProduct)
    rowFiveSimProduct.style.display =
      showSettings && fiveSimProvider ? '' : 'none'
  if (rowNexSmsApiKey)
    rowNexSmsApiKey.style.display = showSettings && nexSmsProvider ? '' : 'none'
  if (rowNexSmsCountry)
    rowNexSmsCountry.style.display =
      showSettings && nexSmsProvider ? '' : 'none'
  if (rowNexSmsCountryFallback)
    rowNexSmsCountryFallback.style.display =
      showSettings && nexSmsProvider ? '' : 'none'
  if (rowNexSmsServiceCode)
    rowNexSmsServiceCode.style.display =
      showSettings && nexSmsProvider ? '' : 'none'
  if (rowSmsbowerApiKey)
    rowSmsbowerApiKey.style.display =
      showSettings && smsbowerProvider ? '' : 'none'
  if (rowSmsbowerBaseUrl)
    rowSmsbowerBaseUrl.style.display =
      showSettings && smsbowerProvider ? '' : 'none'
  if (rowSmsbowerCountryOrder)
    rowSmsbowerCountryOrder.style.display =
      showSettings && smsbowerProvider ? '' : 'none'
  if (rowSmsbowerServiceCode)
    rowSmsbowerServiceCode.style.display =
      showSettings && smsbowerProvider ? '' : 'none'
  if (rowSmsbowerMaxPrice)
    rowSmsbowerMaxPrice.style.display =
      showSettings && smsbowerProvider ? '' : 'none'
  if (rowFiveSimOperator) {
    rowFiveSimOperator.style.display =
      showSettings && fiveSimProvider ? '' : 'none'
  ...
  setFreePhoneReuseControlsLocked(
    isAutoRunLockedPhase() || isAutoRunScheduledPhase()
  )
  if (
    typeof rowFreePhoneReuseAutoEnabled !== 'undefined' &&
    rowFreePhoneReuseAutoEnabled
  ) {
    rowFreePhoneReuseAutoEnabled.classList.toggle(
      'is-disabled',
  ...
  ;[
    ...
    typeof rowHeroSmsCurrentNumber !== 'undefined'
      ? rowHeroSmsCurrentNumber
      : null,
    typeof rowHeroSmsCurrentCountdown !== 'undefined'
    ...
    typeof rowHeroSmsPreferredActivation !== 'undefined'
  ...
  if (
    !showSettings &&
    typeof rowHeroSmsPriceTiers !== 'undefined' &&
...
function updatePlusModeUI() {
  ...
  ;[typeof rowPayPalAccount !== 'undefined' ? rowPayPalAccount : null].forEach(
    (row) => {
      if (!row) {
        return
      }
      row.style.display =
        enabled && selectedMethod === paypalValue ? '' : 'none'
    }
  )
  ;[
  ...
  if (
    typeof rowGpcHelperLocalSmsEnabled !== 'undefined' &&
    rowGpcHelperLocalSmsEnabled
  ) {
    rowGpcHelperLocalSmsEnabled.style.display = localSmsControlsVisible
      ? ''
      : 'none'
  }
  if (
    typeof rowGpcHelperLocalSmsUrl !== 'undefined' &&
    rowGpcHelperLocalSmsUrl
  ) {
    rowGpcHelperLocalSmsUrl.style.display =
      localSmsControlsVisible && effectiveLocalSmsEnabled ? '' : 'none'
  }
...
function getRuntimeSignupPhoneValue(state = latestState) {
  const identifierType = String(state?.accountIdentifierType || '')
    .trim()
    .toLowerCase()
  return String(
...
function shouldPreserveSignupPhoneInputValue(stateSignupPhone = '') {
  if (
    typeof inputSignupPhone === 'undefined' ||
    !inputSignupPhone ||
    !signupPhoneInputDirty
  ) {
    return false
  }
  ...
  return (
    signupPhoneInputFocused ||
    (typeof document !== 'undefined' &&
      document.activeElement === inputSignupPhone)
  )
}
...
function syncSignupPhoneInputFromState(state = latestState) {
  ...
  if (typeof rowSignupPhone !== 'undefined' && rowSignupPhone) {
      ...
      typeof resolveCurrentSidepanelCapabilities === 'function'
        ...
        : (() => {
            ...
            return registry?.resolveSidepanelCapabilities
              ? registry.resolveSidepanelCapabilities({
                  activeFlowId:
                    state?.activeFlowId || latestState?.activeFlowId,
                  panelMode: state?.panelMode || latestState?.panelMode,
                  signupMethod: selectedMethod,
                  state: {
                    ...(latestState || {}),
    ...
    const canShowPhoneSettings = capabilityState
      ? Boolean(capabilityState.canShowPhoneSettings)
      : true
    rowSignupPhone.style.display =
      canShowPhoneSettings &&
      phoneVerificationEnabled &&
      (selectedMethod === 'phone' ||
        Boolean(signupPhone) ||
        Boolean(getSignupPhoneInputValue()) ||
        signupPhoneInputDirty)
        ? ''
        : 'none'
  }
  ...
  signupPhoneInputPersistPromise = (async () => {
    ...
    syncLatestState({
      ...
      ...(normalizedPhone
        ...
        : String(latestState?.accountIdentifierType || '')
              .trim()
              .toLowerCase() === 'phone'
          ? {
    ...
    if (!silent) {
      showToast(
        normalizedPhone ? '注册手机号已保存。' : '注册手机号已清空。',
        'success',
        1600
      )
    }
...
async function refreshGpcBalanceForStart() {
  const response = await chrome.runtime.sendMessage({
    ...
    payload: {
      ...
      gopayHelperApiKey:
        inputGpcHelperCardKey?.value || latestState?.gopayHelperApiKey || '',
      reason: 'before_start'
    }
  })
  if (response?.error) {
  ...
  const nextState = {
    gopayHelperBalance:
      response?.balance || latestState?.gopayHelperBalance || '',
    gopayHelperBalancePayload:
      response?.data ||
      response?.payload?.data ||
      response?.payload ||
      latestState?.gopayHelperBalancePayload ||
      null,
    gopayHelperBalanceUpdatedAt: response?.updatedAt || Date.now(),
    gopayHelperBalanceError: '',
    gopayHelperRemainingUses:
      getGpcBalanceRemainingUsesFromResponse(response) ?? 0,
...
async function ensureGpcApiKeyReadyForStart(options = {}) {
  ...
  try {
    ...
    await showGpcStartBlockedDialog(
      `API Key 余额校验失败：${error?.message || '未知错误'}。请先确认 API Key 是否正确。`
    )
    return false
  }

  const remainingUses = normalizeGpcRemainingUsesValue(
    balanceState.gopayHelperRemainingUses
  )
  const apiKeyStatus = String(balanceState.gopayHelperApiKeyStatus || '')
    .trim()
    .toLowerCase()
  if (apiKeyStatus && apiKeyStatus !== 'active') {
    await showGpcStartBlockedDialog(
      `当前 GPC API Key 状态为 ${balanceState.gopayHelperApiKeyStatus}，不能开启任务。`
    )
    return false
  }
  if (remainingUses !== null && remainingUses <= 0) {
    await showGpcStartBlockedDialog(
      '当前 GPC API Key 剩余次数不足，不能开启任务。'
    )
    return false
  }

  if (
    selectedMode === GPC_HELPER_PHONE_MODE_AUTO &&
    isGpcAutoModePermissionDenied(balanceState)
  ) {
    await showGpcStartBlockedDialog(
      '当前 GPC API Key 未开通自动模式，已保留你的当前选择。如需继续，请由你手动切换到手动模式后再开启任务。'
    )
    return false
  }
...
async function openPlusManualConfirmationDialog(options = {}) {
  ...
  const title =
    String(options.title || '').trim() ||
    (method === gopayValue ? 'GoPay 订阅确认' : '手动确认')
  const message =
    String(options.message || '').trim() ||
    (method === gopayValue
      ? '请在当前订阅页中手动完成 GoPay 订阅，完成后点击“我已完成订阅”继续。'
...
function applyAutoRunStatus(payload = currentAutoRun) {
  ...
  btnFetchEmail.disabled =
    locked || isCustomMailProvider() || usesCustomEmailPoolGenerator()
  ...
  const lockedRunCount =
    typeof getLockedRunCountFromEmailPool === 'function'
      ...
      : 0
  const isSyncPhase =
    typeof isAutoRunSourceSyncPhase === 'function'
  ...
  const shouldSyncRunCount =
    typeof shouldSyncRunCountFromAutoRunSource === 'function'
  ...
  switch (currentAutoRun.phase) {
    ...
    default:
      ...
      if (!locked) {
        btnFetchEmail.disabled =
          isCustomMailProvider() || usesCustomEmailPoolGenerator()
      }
      break
  }
...
function renderStepsList() {
  ...
  stepsList.innerHTML = stepDefinitions
    .map(
      (step) => `
...
function syncStepDefinitionsForMode(
  ...
  const options =
    typeof plusPaymentMethodOrOptions === 'string'
      ? maybeOptions
      : plusPaymentMethodOrOptions || {}
  const rawPaymentMethod =
    typeof plusPaymentMethodOrOptions === 'string'
  ...
  const nextActiveFlowId =
    String(
      ...
      .toLowerCase() || defaultFlowId
  const rootScope = typeof window !== 'undefined' ? window : globalThis
  const currentPaymentStep = stepDefinitions.find(
    (step) => step.key === 'paypal-approve'
  )
  const nextPaymentTitle =
    rootScope.MultiPageStepDefinitions?.getPlusPaymentStepTitle?.({
...
function applySettingsState(state) {
    ...
    const stepDefinitionState =
      typeof resolveStepDefinitionCapabilityState === 'function'
        ...
        : {
            ...
            signupMethod: normalizeSignupMethod(
  ...
  const resolveIpProxyService = (value) =>
    typeof normalizeIpProxyService === 'function'
      ? normalizeIpProxyService(value)
      : String(value || fallbackIpProxyService)
          .trim()
          .toLowerCase() || fallbackIpProxyService
  const resolveIpProxyMode = (value) => {
    ...
    const normalized = String(value || fallbackIpProxyMode)
      .trim()
      .toLowerCase()
    return normalized || fallbackIpProxyMode
  }
  const resolveIpProxyProtocol = (value) =>
    typeof normalizeIpProxyProtocol === 'function'
      ? normalizeIpProxyProtocol(value)
      : String(value || fallbackIpProxyProtocol)
          .trim()
          .toLowerCase() || fallbackIpProxyProtocol
  ...
  const resolveIpProxyAccountList = (value) =>
    typeof normalizeIpProxyAccountList === 'function'
      ? normalizeIpProxyAccountList(value || '')
      : String(value || '')
          .replace(/\r/g, '')
          .trim()
  const resolveIpProxySessionPrefix = (value) =>
    typeof normalizeIpProxyAccountSessionPrefix === 'function'
      ? normalizeIpProxyAccountSessionPrefix(value || '')
      : String(value || '').trim()
  const resolveIpProxyAccountLifeMinutes = (value) =>
    typeof normalizeIpProxyAccountLifeMinutes === 'function'
      ? normalizeIpProxyAccountLifeMinutes(value || '')
      : String(value || '').trim()
  const resolveIpProxyPoolTargetCount = (value) =>
    typeof normalizeIpProxyPoolTargetCount === 'function'
  ...
  if (
    ...
    selectPlusPaymentMethod.value = normalizePlusPaymentMethod(
  ...
  if (typeof inputGpcHelperCardKey !== 'undefined' && inputGpcHelperCardKey) {
    inputGpcHelperCardKey.value =
      state?.gopayHelperApiKey || state?.gopayHelperCardKey || ''
  }
  if (
    typeof selectGpcHelperPhoneMode !== 'undefined' &&
    selectGpcHelperPhoneMode
  ) {
    selectGpcHelperPhoneMode.value = normalizeGpcHelperPhoneModeValue(
      state?.gopayHelperPhoneMode || 'manual'
    )
  }
  if (
    typeof selectGpcHelperCountryCode !== 'undefined' &&
    ...
    const normalizedCountryCode = window.GoPayUtils?.normalizeGoPayCountryCode
      ? window.GoPayUtils.normalizeGoPayCountryCode(
          state?.gopayHelperCountryCode
        )
      : String(state?.gopayHelperCountryCode || '+86').trim()
    const hasOption = Array.from(selectGpcHelperCountryCode.options || []).some(
      (option) => option.value === normalizedCountryCode
    )
  ...
  if (
    ...
    selectGpcHelperOtpChannel.value = normalizeGpcOtpChannelValue(
      state?.gopayHelperOtpChannel || 'whatsapp'
    )
  }
  if (
    typeof inputGpcHelperLocalSmsEnabled !== 'undefined' &&
    ...
    inputGpcHelperLocalSmsEnabled.checked = Boolean(
      state?.gopayHelperLocalSmsHelperEnabled
    )
  }
  if (
    typeof inputGpcHelperLocalSmsUrl !== 'undefined' &&
    ...
    inputGpcHelperLocalSmsUrl.value = normalizeGpcLocalSmsHelperBaseUrlValue(
  ...
  if (
    typeof displayGpcHelperBalance !== 'undefined' &&
    displayGpcHelperBalance
  ) {
  ...
  if (typeof selectGoPayCountryCode !== 'undefined' && selectGoPayCountryCode) {
    const normalizedGoPayCountryCode = window.GoPayUtils
    ...
    const hasOption = Array.from(selectGoPayCountryCode.options || []).some(
      (option) => option.value === normalizedGoPayCountryCode
    )
  ...
  const normalizedIpProxyServiceProfiles =
    typeof normalizeIpProxyServiceProfiles === 'function'
      ? normalizeIpProxyServiceProfiles(
      ...
      : state?.ipProxyServiceProfiles || {}
  const activeIpProxyProfile =
    typeof getIpProxyServiceProfile === 'function'
      ...
      : {
          ...
          accountList: resolveIpProxyAccountList(
            state?.ipProxyAccountList || ''
          ),
          accountSessionPrefix: resolveIpProxySessionPrefix(
            state?.ipProxyAccountSessionPrefix || ''
          ),
          accountLifeMinutes: resolveIpProxyAccountLifeMinutes(
            state?.ipProxyAccountLifeMinutes || ''
          ),
          poolTargetCount: resolveIpProxyPoolTargetCount(
            state?.ipProxyPoolTargetCount || ''
          ),
  ...
  if (
    typeof inputIpProxyAccountSessionPrefix !== 'undefined' &&
    inputIpProxyAccountSessionPrefix
  ) {
    inputIpProxyAccountSessionPrefix.value =
      activeIpProxyProfile.accountSessionPrefix
  }
  if (
    typeof inputIpProxyAccountLifeMinutes !== 'undefined' &&
    inputIpProxyAccountLifeMinutes
  ) {
    inputIpProxyAccountLifeMinutes.value =
      activeIpProxyProfile.accountLifeMinutes
  }
  if (
    typeof inputIpProxyPoolTargetCount !== 'undefined' &&
    inputIpProxyPoolTargetCount
  ) {
    inputIpProxyPoolTargetCount.value = activeIpProxyProfile.poolTargetCount
  }
  if (
    typeof inputIpProxyAutoSyncEnabled !== 'undefined' &&
    inputIpProxyAutoSyncEnabled
  ) {
    inputIpProxyAutoSyncEnabled.checked = resolveIpProxyAutoSyncEnabled(
      state?.ipProxyAutoSyncEnabled
    )
  }
  if (
    typeof inputIpProxyAutoSyncIntervalMinutes !== 'undefined' &&
    inputIpProxyAutoSyncIntervalMinutes
  ) {
    inputIpProxyAutoSyncIntervalMinutes.value = String(
      resolveIpProxyAutoSyncIntervalMinutes(
  ...
  if (typeof selectIpProxyProtocol !== 'undefined' && selectIpProxyProtocol) {
    selectIpProxyProtocol.value = resolveIpProxyProtocol(
      activeIpProxyProfile.protocol
    )
  }
  ...
  syncLatestState({
    ...
    ...(typeof buildIpProxyStatePatchFromServiceProfile === 'function'
      ? buildIpProxyStatePatchFromServiceProfile(
          normalizedIpProxyService,
          activeIpProxyProfile
        )
      : {})
  })
  ...
  const restoredMailProvider =
    isCustomMailProvider(state?.mailProvider) ||
    [
      ICLOUD_PROVIDER,
      'hotmail-api',
      GMAIL_PROVIDER,
      ...
      'cloudflare-temp-email',
      'cloudmail'
    ].includes(String(state?.mailProvider || '').trim())
      ? String(state?.mailProvider || '163').trim()
      : String(state?.emailGenerator || '')
            .trim()
            .toLowerCase() === 'custom' ||
          String(state?.emailGenerator || '')
            .trim()
  ...
  {
    const restoredEmailGenerator = String(state?.emailGenerator || '')
      .trim()
      .toLowerCase()
    if (restoredMailProvider === GMAIL_PROVIDER) {
      selectEmailGenerator.value =
        restoredEmailGenerator === CUSTOM_EMAIL_POOL_GENERATOR
          ? CUSTOM_EMAIL_POOL_GENERATOR
  ...
  if (selectIcloudHostPreference) {
    selectIcloudHostPreference.value =
      String(state?.icloudHostPreference || '')
        .trim()
        .toLowerCase() === 'icloud.com'
        ? 'icloud.com'
        : String(state?.icloudHostPreference || '')
              .trim()
              .toLowerCase() === 'icloud.com.cn'
          ? 'icloud.com.cn'
          : 'auto'
  }
  if (selectIcloudFetchMode) {
    selectIcloudFetchMode.value = normalizeIcloudFetchMode(
      state?.icloudFetchMode
    )
  }
  if (selectIcloudTargetMailboxType) {
    selectIcloudTargetMailboxType.value = normalizeIcloudTargetMailboxType(
      state?.icloudTargetMailboxType
    )
  }
  if (selectIcloudForwardMailProvider) {
    selectIcloudForwardMailProvider.value = normalizeIcloudForwardMailProvider(
      state?.icloudForwardMailProvider
    )
  }
  ...
  if (inputCustomMailProviderPool) {
    inputCustomMailProviderPool.value = normalizeCustomEmailPoolEntries(
      state?.customMailProviderPool
    ).join('\n')
  }
  const restoredCustomEmailPoolEntries =
    typeof restoreCustomEmailPoolEntriesFromState === 'function'
  ...
  selectLuckmailEmailType.value = normalizeLuckmailEmailType(
    state?.luckmailEmailType
  )
  ...
  inputAutoSkipFailuresThreadIntervalMinutes.value = String(
    normalizeAutoRunThreadIntervalMinutes(
      state?.autoRunFallbackThreadIntervalMinutes
    )
  )
  if (
    typeof inputStep6CookieCleanupEnabled !== 'undefined' &&
    ...
    inputStep6CookieCleanupEnabled.checked = Boolean(
      state?.step6CookieCleanupEnabled
    )
  }
  inputAutoDelayEnabled.checked = Boolean(state?.autoRunDelayEnabled)
  inputAutoDelayMinutes.value = String(
    normalizeAutoDelayMinutes(state?.autoRunDelayMinutes)
  )
  inputAutoStepDelaySeconds.value = formatAutoStepDelayInputValue(
    state?.autoStepDelaySeconds
  )
  if (
    typeof inputOAuthFlowTimeoutEnabled !== 'undefined' &&
    inputOAuthFlowTimeoutEnabled
  ) {
    inputOAuthFlowTimeoutEnabled.checked =
      state?.oauthFlowTimeoutEnabled !== undefined
        ? Boolean(state.oauthFlowTimeoutEnabled)
        : true
  }
  if (inputVerificationResendCount) {
    const restoredVerificationResendCount =
      state?.verificationResendCount !== undefined
        ? state.verificationResendCount
        : (state?.signupVerificationResendCount ??
          state?.loginVerificationResendCount)
    inputVerificationResendCount.value = String(
      normalizeVerificationResendCount(
        restoredVerificationResendCount,
        DEFAULT_VERIFICATION_RESEND_COUNT
      )
    )
  }
  if (inputPhoneVerificationEnabled) {
    inputPhoneVerificationEnabled.checked =
      state?.phoneVerificationEnabled !== undefined
  ...
  const restoredPhoneSmsProvider = normalizePhoneSmsProvider(
    state?.phoneSmsProvider
  )
  const previousPhoneSmsProvider = selectPhoneSmsProvider
    ? normalizePhoneSmsProvider(selectPhoneSmsProvider.value)
    : restoredPhoneSmsProvider
  const defaultFiveSimProduct =
    typeof DEFAULT_FIVE_SIM_PRODUCT !== 'undefined'
      ? DEFAULT_FIVE_SIM_PRODUCT
      : 'openai'
  ...
  const restoredPhoneSmsProviderOrder =
    typeof applyPhoneSmsProviderOrderSelection === 'function'
  ...
  if (previousPhoneSmsProvider !== restoredPhoneSmsProvider) {
    ...
    loadHeroSmsCountries().catch((error) => {
      console.warn(
        'Failed to reload SMS countries after provider restore:',
        error
      )
    })
  }
  ...
  if (typeof inputFiveSimOperator !== 'undefined' && inputFiveSimOperator) {
    inputFiveSimOperator.value =
      typeof normalizeFiveSimOperatorValue === 'function'
        ? normalizeFiveSimOperatorValue(
            state?.fiveSimOperator || DEFAULT_FIVE_SIM_OPERATOR
          )
        : normalizeFiveSimOperator(
            state?.fiveSimOperator || DEFAULT_FIVE_SIM_OPERATOR
          )
  ...
  if (typeof inputFiveSimProduct !== 'undefined' && inputFiveSimProduct) {
    inputFiveSimProduct.value =
      typeof normalizeFiveSimProductValue === 'function'
        ? normalizeFiveSimProductValue(
            state?.fiveSimProduct || defaultFiveSimProduct
          )
        : String(state?.fiveSimProduct || defaultFiveSimProduct)
            .trim()
            .toLowerCase()
            .replace(/[^a-z0-9_-]+/g, '') || defaultFiveSimProduct
  }
  ...
  if (typeof inputNexSmsServiceCode !== 'undefined' && inputNexSmsServiceCode) {
    inputNexSmsServiceCode.value =
      typeof normalizeNexSmsServiceCodeValue === 'function'
        ? normalizeNexSmsServiceCodeValue(
            state?.nexSmsServiceCode || defaultNexSmsServiceCode
          )
        : String(state?.nexSmsServiceCode || defaultNexSmsServiceCode)
            .trim()
            .toLowerCase()
            .replace(/[^a-z0-9_-]+/g, '') || defaultNexSmsServiceCode
  }
  ...
  if (typeof inputSmsbowerBaseUrl !== 'undefined' && inputSmsbowerBaseUrl) {
    inputSmsbowerBaseUrl.value = normalizeSmsbowerBaseUrlValue(
      state?.smsbowerBaseUrl || DEFAULT_SMSBOWER_BASE_URL
    )
  }
  if (
    typeof inputSmsbowerCountryOrder !== 'undefined' &&
    ...
    inputSmsbowerCountryOrder.value = formatSmsbowerCountryOrderValue(
      state?.smsbowerCountryOrder || DEFAULT_SMSBOWER_COUNTRY_ORDER
    )
  }
  if (
    ...
    inputSmsbowerServiceCode.value = normalizeSmsbowerServiceCodeValue(
      state?.smsbowerServiceCode || DEFAULT_SMSBOWER_SERVICE_CODE
    )
  }
  if (typeof inputSmsbowerMaxPrice !== 'undefined' && inputSmsbowerMaxPrice) {
    inputSmsbowerMaxPrice.value = normalizeSmsbowerMaxPriceValue(
      state?.smsbowerMaxPrice || ''
    )
  }
  if (
    typeof inputHeroSmsReuseEnabled !== 'undefined' &&
  ...
  if (
    ...
    inputFreePhoneReuseAutoEnabled.checked = Boolean(
      state?.freePhoneReuseAutoEnabled
    )
  }
  if (
    typeof selectHeroSmsAcquirePriority !== 'undefined' &&
    ...
    selectHeroSmsAcquirePriority.value = normalizeHeroSmsAcquirePriority(
      state?.heroSmsAcquirePriority
    )
  }
  ...
  if (
    ...
    inputHeroSmsPreferredPrice.value = normalizeHeroSmsMaxPriceValue(
      state?.heroSmsPreferredPrice || ''
    )
  }
  if (
    typeof inputPhoneReplacementLimit !== 'undefined' &&
  ...
  if (typeof applyHeroSmsFallbackSelection === 'function') {
    ...
    if (
      Array.from(selectHeroSmsCountry.options).some(
        (option) => option.value === restoredCountryId
      )
    ) {
  ...
  const shouldSyncInitialRunCount =
    typeof shouldSyncRunCountFromAutoRunSource === 'function'
      ? shouldSyncRunCountFromAutoRunSource(state)
      : Boolean(state?.autoRunning) ||
        isSyncPhase(state?.autoRunPhase ?? state?.phase)
...
async function restoreState() {
  try {
    ...
    if (
      getSelectedEmailGenerator() === 'icloud' &&
      icloudSection?.style.display !== 'none'
    ) {
...
function getRepositoryHomeUrl() {
  const serviceRepositoryUrl = String(
    sidepanelUpdateService?.repositoryUrl || ''
  ).trim()
  if (serviceRepositoryUrl) {
    return serviceRepositoryUrl
  }

  const releasesPageUrl = String(
    sidepanelUpdateService?.releasesPageUrl || ''
  ).trim()
  if (releasesPageUrl) {
...
function getReleaseListUrl() {
  const snapshotReleaseListUrl = String(
    currentReleaseSnapshot?.releasesPageUrl || ''
  ).trim()
  if (snapshotReleaseListUrl) {
    return snapshotReleaseListUrl
  }

  const serviceReleaseListUrl = String(
    sidepanelUpdateService?.releasesPageUrl || ''
  ).trim()
...
function ignoreCurrentReleaseUpdate() {
  ...
  const ignoredVersion = sidepanelUpdateService.ignoreReleaseSnapshot(
  ...
  showToast(
    `已忽略 ${ignoredVersion} 更新，有新版本时会再次提醒。`,
    'info',
    2200
  )
}
...
function renderUpdateReleaseList(releases = []) {
  ...
  releases.forEach((release) => {
    ...
    const publishedAt =
      sidepanelUpdateService?.formatReleaseDate?.(release.publishedAt) || ''
    if (publishedAt) {
...
function renderReleaseSnapshot(snapshot) {
  ...
  extensionUpdateStatus.classList.remove(
    'is-update-available',
    'is-check-failed',
    'is-version-label'
  )
  ...
  switch (snapshot?.status) {
    case 'update-available': {
      ...
      if (updateCardSummary) {
        const updateCount = Array.isArray(snapshot.newerReleases)
          ? snapshot.newerReleases.length
          : 0
        updateCardSummary.textContent =
          updateCount > 1
    ...
    default: {
      ...
      extensionVersionMeta.textContent =
        snapshot?.errorMessage || 'GitHub Releases 检查失败'
...
async function initializeReleaseInfo() {
  const fallbackReleaseUrl =
    sidepanelUpdateService?.releasesPageUrl ||
    'https://github.com/QLHazyCoder/codex-oauth-automation-extension/releases'

  if (btnReleaseLog) {
    btnReleaseLog.onclick = () =>
      openExternalUrl(currentReleaseSnapshot?.logUrl || fallbackReleaseUrl)
  }
  ...
  const localVersion =
    sidepanelUpdateService?.getLocalVersionLabel?.(
      chrome.runtime.getManifest()
    ) ||
    chrome.runtime.getManifest()?.version_name ||
    (chrome.runtime.getManifest()?.version
      ? `Ultra${chrome.runtime.getManifest().version}`
      : '')
...
function getContributionUpdateHintMessage(
...
function getContributionUpdatePromptLines(
  snapshot = currentContributionContentSnapshot
) {
  ...
  const autoRunNoticeItem = items.find(
    (item) =>
      item &&
      String(item.slug || '')
        .trim()
        .toLowerCase() === 'auto_run_notice'
  )
  ...
  const hasAnnouncementOrTutorial = items.some(
    (item) =>
      item &&
      item.isVisible &&
      ['announcement', 'tutorial'].includes(
        String(item.slug || '')
          .trim()
          .toLowerCase()
      )
  )
  const hasQuestionnaire = items.some(
    (item) =>
      item &&
      item.isVisible &&
      String(item.slug || '')
...
function positionContributionUpdateHint() {
  ...
  const maxLeft = Math.max(
    viewportPadding,
    viewportWidth - hintWidth - viewportPadding
  )
  const left = Math.min(
  ...
  const shouldPlaceAbove =
    buttonRect.bottom + gap + hintHeight > viewportHeight - viewportPadding &&
  ...
  const arrowOffset = Math.min(
    Math.max(16, buttonCenter - left),
    Math.max(16, hintWidth - 16)
  )

  contributionUpdateHint.style.left = `${left}px`
  contributionUpdateHint.style.top = `${top}px`
  contributionUpdateHint.style.setProperty(
    '--contribution-update-arrow-left',
    `${arrowOffset}px`
  )
}

function shouldShowContributionUpdateHint(
  snapshot = currentContributionContentSnapshot
) {
...
function renderContributionUpdateHint(
  snapshot = currentContributionContentSnapshot
) {
  ...
  contributionUpdateHintText.textContent =
    getContributionUpdateHintMessage(snapshot)
...
function dismissContributionUpdateHint() {
  const promptVersion = String(
    currentContributionContentSnapshot?.promptVersion || ''
  ).trim()
  if (promptVersion) {
...
async function refreshContributionContentHint() {
  ...
  contributionContentSnapshotRequestInFlight = contributionContentService
...
function syncPasswordField(state) {
  inputPassword.value = state?.contributionMode
    ? ''
    : state.customPassword || state.password || ''
}
...
function normalizeLuckmailEmailType(value = '') {
  const normalized = String(value || '')
    .trim()
    .toLowerCase()
  return ['self_built', 'ms_imap', 'ms_graph', 'google_variant'].includes(
    normalized
  )
    ? normalized
...
function getSelectedEmailGenerator() {
  const generator = String(selectEmailGenerator.value || '')
    .trim()
    .toLowerCase()
...
async function openGoPayOtpInputDialog(payload = {}) {
  ...
  const initialCode = normalizeGoPayOtpInputValue(
    payload.code || inputGoPayOtp?.value || latestState?.gopayOtp || ''
  )
  const result = await sharedFormDialog.open({
    title: '输入 GoPay 验证码',
    message:
      '请把当前 GoPay 页面收到的验证码填到这里，确认后插件会继续填写验证码并进入 PIN 步骤。',
    confirmLabel: '提交验证码',
    confirmVariant: 'btn-primary',
    fields: [
      {
  ...
  if (step === 8 || step === 11) {
    return openActionModal({
      ...
      actions: [
        ...
        {
          id: 'add_phone',
          label: promptCopy.phoneActionLabel || '出现手机号验证',
          variant: 'btn-outline'
        },
...
function getCurrentHotmailAccount(state = latestState) {
  ...
  return (
    getHotmailAccounts(state).find((account) => account.id === currentId) ||
    null
  )
}
...
function getCurrentMail2925Account(state = latestState) {
  ...
  return (
    getMail2925Accounts(state).find((account) => account.id === currentId) ||
    null
  )
}
...
function getCurrentPayPalAccount(state = latestState) {
  ...
  return (
    getPayPalAccounts(state).find((account) => account.id === currentId) || null
  )
}

function syncMail2925BaseEmailFromCurrentAccount(
  state = latestState,
  options = {}
) {
  ...
  if (
    !currentEmail ||
    currentEmail === String(state?.mail2925BaseEmail || '').trim()
  ) {
    return false
  }
...
function getLuckmailPreserveTagName(state = latestState) {
  return (
    String(state?.luckmailPreserveTagName || '').trim() ||
...
function getIpProxyServiceLoginConfig(
  service = selectIpProxyService?.value ||
...
function getIpProxyServiceLoginUrl(
  service = selectIpProxyService?.value ||
    latestState?.ipProxyService ||
    DEFAULT_IP_PROXY_SERVICE
) {
...
function isCurrentEmailManagedByGeneratedAlias(
  ...
  const inputEmailValue = String(inputEmail.value || '')
    .trim()
    .toLowerCase()
  const stateEmailValue = String(state?.email || '')
    .trim()
    .toLowerCase()
  const baseEmail = getManagedAliasBaseEmailForProvider(
    normalizedProvider,
  ...
  return (
    isManagedAliasEmail(inputEmailValue, baseEmail, normalizedProvider) ||
...
async function maybeClearGeneratedAliasAfterEmailPrefixChange() {
  ...
  const previousPrefix = getManagedAliasBaseEmailForProvider(
    provider,
    latestState
  )
  ...
  if (
    !isCurrentEmailManagedByGeneratedAlias(
      provider,
      latestState,
      latestState?.mail2925Mode
    )
  ) {
    return
  }
...
function updateMailProviderUI() {
  const normalizeIcloudHostValue =
    typeof normalizeIcloudHost === 'function'
      ? normalizeIcloudHost
      : (value) => {
          const normalized = String(value || '')
            .trim()
  ...
  const icloudHostPreferenceValue =
    typeof selectIcloudHostPreference !== 'undefined'
      ? selectIcloudHostPreference?.value
      : latestState?.icloudHostPreference
  const capabilityState =
    typeof resolveCurrentSidepanelCapabilities === 'function'
  ...
  if (
    !canShowLuckmail &&
    String(selectMailProvider?.value || '')
      .trim()
      .toLowerCase() === 'luckmail-api'
  ) {
    const fallbackOption = mailProviderOptions.find(
  ...
  const useMail2925AccountPool =
    useMail2925 && Boolean(inputMail2925UseAccountPool?.checked)
  const mail2925Mode = getSelectedMail2925Mode()
  const gmailAliasGenerator =
    typeof GMAIL_ALIAS_GENERATOR === 'string'
      ? GMAIL_ALIAS_GENERATOR
      : 'gmail-alias'
  const customEmailPoolGenerator =
    typeof CUSTOM_EMAIL_POOL_GENERATOR === 'string'
      ? CUSTOM_EMAIL_POOL_GENERATOR
      : 'custom-pool'
  const gmailOnlyGenerators = new Set([
    gmailAliasGenerator,
  ...
  Array.from(selectEmailGenerator?.options || []).forEach((option) => {
    if (!option) return
    if (useGmail) {
      option.hidden = !gmailOnlyGenerators.has(
        String(option.value || '')
          .trim()
          .toLowerCase()
      )
    ...
    option.hidden =
      String(option.value || '')
        .trim()
        .toLowerCase() === gmailAliasGenerator
  })
  if (
    useGmail &&
    !gmailOnlyGenerators.has(
      String(selectEmailGenerator.value || '')
        .trim()
        .toLowerCase()
    )
  ) {
  ...
  const useGeneratedAlias = usesGeneratedAliasMailProvider(
    selectMailProvider.value,
    mail2925Mode,
    selectedGenerator
  )
  ...
  const useCustomMailProviderPool =
    useCustomEmail && usesCustomMailProviderPool(selectMailProvider.value)
  ...
  const useCloudflareTempEmailProvider =
    selectMailProvider.value === 'cloudflare-temp-email'
  ...
  if (
    typeof rowCustomMailProviderPool !== 'undefined' &&
    rowCustomMailProviderPool
  ) {
    rowCustomMailProviderPool.style.display = useCustomEmail ? '' : 'none'
  }
  rowEmailPrefix.style.display =
    useGeneratedAlias && !useMail2925AccountPool ? '' : 'none'
  const hotmailServiceMode = getSelectedHotmailServiceMode()
  rowInbucketHost.style.display = useInbucket ? '' : 'none'
  rowInbucketMailbox.style.display = useInbucket ? '' : 'none'
  const useCustomEmailPool =
    useEmailGenerator && selectedGenerator === customEmailPoolGenerator
  const useCloudflare = selectedGenerator === 'cloudflare'
  const useIcloud = selectedGenerator === 'icloud'
  const useCloudflareTempEmailGenerator =
    selectedGenerator === 'cloudflare-temp-email'
  const useCloudMailGenerator = selectedGenerator === 'cloudmail'
  const showCloudflareDomain = useEmailGenerator && useCloudflare
  const showCloudflareTempEmailSettings =
    useCloudflareTempEmailProvider ||
    (useEmailGenerator && useCloudflareTempEmailGenerator)
  const showCloudflareTempEmailReceiveMailbox =
    useCloudflareTempEmailProvider && !useCloudflareTempEmailGenerator
  const showCloudMailSettings =
    useCloudMailProvider || (useEmailGenerator && useCloudMailGenerator)
  const showCloudMailReceiveMailbox =
    useCloudMailProvider && !useCloudMailGenerator
  const showCloudMailDomain = useEmailGenerator && useCloudMailGenerator
  const selectedIcloudHost =
    typeof getSelectedIcloudHostPreference === 'function'
      ? getSelectedIcloudHostPreference()
      : normalizeIcloudHostValue(
          icloudHostPreferenceValue || latestState?.icloudHostPreference || ''
        ) ||
        normalizeIcloudHostValue(latestState?.preferredIcloudHost) ||
        'icloud.com'
  const icloudTargetMailboxType = normalizeIcloudTargetMailboxType(
    icloudTargetMailboxTypeValue
  )
  ...
  const showIcloudForwardMailProvider =
    useIcloudProvider && icloudTargetMailboxType === 'forward-mailbox'
  const showCloudflareTempEmailRandomSubdomainToggle =
    useEmailGenerator && useCloudflareTempEmailGenerator
  const showCloudflareTempEmailDomain =
    useEmailGenerator && useCloudflareTempEmailGenerator
  ...
  if (cloudflareTempEmailSection) {
    cloudflareTempEmailSection.style.display = showCloudflareTempEmailSettings
      ? ''
      : 'none'
  }
  ...
  if (typeof rowCloudMailBaseUrl !== 'undefined' && rowCloudMailBaseUrl)
    rowCloudMailBaseUrl.style.display = showCloudMailSettings ? '' : 'none'
  if (typeof rowCloudMailAdminEmail !== 'undefined' && rowCloudMailAdminEmail)
    rowCloudMailAdminEmail.style.display = showCloudMailSettings ? '' : 'none'
  if (
    typeof rowCloudMailAdminPassword !== 'undefined' &&
    rowCloudMailAdminPassword
  )
    rowCloudMailAdminPassword.style.display = showCloudMailSettings
      ? ''
      : 'none'
  if (
    typeof rowCloudMailReceiveMailbox !== 'undefined' &&
    rowCloudMailReceiveMailbox
  )
    rowCloudMailReceiveMailbox.style.display = showCloudMailReceiveMailbox
      ? ''
      : 'none'
  if (typeof rowCloudMailDomain !== 'undefined' && rowCloudMailDomain)
    rowCloudMailDomain.style.display = showCloudMailDomain ? '' : 'none'
  if (icloudSection) {
    const showIcloudSection =
      (useEmailGenerator && useIcloud) || useIcloudProvider
  ...
  if (
    typeof rowIcloudTargetMailboxType !== 'undefined' &&
    rowIcloudTargetMailboxType
  ) {
    rowIcloudTargetMailboxType.style.display = showIcloudTargetMailboxType
      ? ''
      : 'none'
  }
  if (
    typeof rowIcloudForwardMailProvider !== 'undefined' &&
    rowIcloudForwardMailProvider
  ) {
    rowIcloudForwardMailProvider.style.display = showIcloudForwardMailProvider
      ? ''
      : 'none'
  }
  ...
  if (showCloudflareDomain) {
    setCloudflareDomainEditMode(
      cloudflareDomainEditMode || domains.length === 0,
      { clearInput: false }
    )
  } else {
    setCloudflareDomainEditMode(false, { clearInput: false })
  }
  rowTempEmailBaseUrl.style.display = showCloudflareTempEmailSettings
    ? ''
    : 'none'
  rowTempEmailAdminAuth.style.display = showCloudflareTempEmailSettings
    ? ''
    : 'none'
  rowTempEmailCustomAuth.style.display = showCloudflareTempEmailSettings
    ? ''
    : 'none'
  rowTempEmailReceiveMailbox.style.display =
    showCloudflareTempEmailReceiveMailbox ? '' : 'none'
  if (rowTempEmailRandomSubdomainToggle) {
    rowTempEmailRandomSubdomainToggle.style.display =
      showCloudflareTempEmailRandomSubdomainToggle ? '' : 'none'
  }
  ...
  if (showCloudflareTempEmailDomain) {
    setCloudflareTempEmailDomainEditMode(
      cloudflareTempEmailDomainEditMode || tempEmailDomains.length === 0,
      { clearInput: false }
    )
  } else {
  ...
  if (selectMail2925PoolAccount) {
    selectMail2925PoolAccount.style.display = useMail2925AccountPool
      ? ''
      : 'none'
    selectMail2925PoolAccount.disabled =
      !useMail2925AccountPool || getMail2925Accounts().length === 0
  }
  inputEmailPrefix.style.display = ''
  inputEmailPrefix.readOnly = false
  selectEmailGenerator.disabled =
    useHotmail ||
    useLuckmail ||
    useCustomEmail ||
    (useGeneratedAlias && !useGmail)
  ...
  labelEmailPrefix.textContent =
    aliasUiCopy?.baseLabel || labelEmailPrefix.textContent
  inputEmailPrefix.placeholder =
    aliasUiCopy?.basePlaceholder || inputEmailPrefix.placeholder
  if (rowHotmailServiceMode) {
    rowHotmailServiceMode.style.display = useHotmail ? '' : 'none'
  }
  if (rowHotmailRemoteBaseUrl) {
    rowHotmailRemoteBaseUrl.style.display =
      useHotmail && hotmailServiceMode === HOTMAIL_SERVICE_MODE_REMOTE
        ? ''
        : 'none'
  }
  if (rowHotmailLocalBaseUrl) {
    rowHotmailLocalBaseUrl.style.display =
      useHotmail && hotmailServiceMode === HOTMAIL_SERVICE_MODE_LOCAL
        ? ''
        : 'none'
  }
  btnFetchEmail.hidden =
    useHotmail || useLuckmail || useCustomEmail || useCustomEmailPool
  inputEmail.readOnly = useHotmail || useLuckmail
  inputEmail.placeholder = useHotmail
    ? '由 Hotmail 账号池自动分配'
    : useLuckmail
      ? '步骤 3 自动购买 luckyous / LuckMail 邮箱并回填'
      : useGeneratedAlias
  ...
  if (autoHintText) {
    autoHintText.textContent = useHotmail
      ...
      : useLuckmail
        ? '步骤 3 会自动购买 luckyous / LuckMail 邮箱并用于收码'
        : useGeneratedAlias
          ? '步骤 3 会自动生成邮箱，无需手动获取'
          : useCustomEmail
            ? '请先填写自定义注册邮箱，成功一轮后会自动清空'
            : `先自动获取${uiCopy.label}，或手动粘贴邮箱后再继续`
  }
  if (autoHintText && useCustomEmailPool) {
    autoHintText.textContent =
      getCustomEmailPoolSize() > 0
  ...
  if (autoHintText && useGmail && useGeneratedAlias) {
    autoHintText.textContent =
      '请先填写 Gmail 原邮箱，步骤 3 会自动生成 Gmail +tag 地址'
  }
  ...
  if (
    autoHintText &&
    showCloudflareTempEmailReceiveMailbox &&
    !useCustomEmailPool
  ) {
    autoHintText.textContent =
      '若注册邮箱会转发到 Cloudflare Temp Email，请在“邮件接收”中填写实际接收转发邮件的邮箱。'
  }
  if (
    autoHintText &&
    ...
    autoHintText.textContent =
      '已启用随机子域名：扩展会按当前选中的 Temp 域名提交，并额外携带 enableRandomSubdomain；是否生效取决于后端 RANDOM_SUBDOMAIN_DOMAINS 配置。'
  }
  if (autoHintText && useIcloudProvider && showIcloudForwardMailProvider) {
    const forwardProvider = normalizeIcloudForwardMailProvider(
      icloudForwardMailProviderValue
    )
    const forwardProviderLabel =
      ICLOUD_FORWARD_MAIL_PROVIDER_LABELS[forwardProvider] ||
  ...
  if (typeof inputRunCount !== 'undefined' && inputRunCount) {
    inputRunCount.disabled =
      currentAutoRun.autoRunning || shouldLockRunCountToEmailPool()
  }
...
async function saveCloudflareDomainSettings(
  domains,
  activeDomain,
  options = {}
) {
  ...
  const normalizedActiveDomain =
    normalizeCloudflareDomainValue(activeDomain) || normalizedDomains[0] || ''
  const payload = {
...
async function saveCloudflareTempEmailDomainSettings(
  domains,
  activeDomain,
  options = {}
) {
  ...
  const normalizedActiveDomain =
    normalizeCloudflareTempEmailDomainValue(activeDomain) ||
    normalizedDomains[0] ||
    ''
  const payload = {
...
async function handleDeleteCloudflareDomain(domain) {
  ...
  const currentDomain = normalizeCloudflareDomainValue(
    selectCfDomain.value || activeDomain
  )
  const nextActiveDomain =
    currentDomain === targetDomain
      ? nextDomains[0] || ''
      : nextDomains.includes(currentDomain)
        ? currentDomain
        : nextDomains[0] || ''
  await saveCloudflareDomainSettings(nextDomains, nextActiveDomain, {
    silent: true
  })
...
async function handleDeleteCloudflareTempEmailDomain(domain) {
  ...
  const currentDomain = normalizeCloudflareTempEmailDomainValue(
    selectTempEmailDomain.value || activeDomain
  )
  const nextActiveDomain =
    currentDomain === targetDomain
      ? nextDomains[0] || ''
      : nextDomains.includes(currentDomain)
        ? currentDomain
        : nextDomains[0] || ''
  await saveCloudflareTempEmailDomainSettings(nextDomains, nextActiveDomain, {
    silent: true
  })
  showToast(
    `已删除 Cloudflare Temp Email 域名：${targetDomain}`,
    'success',
    1600
  )
}
...
async function handleDeleteSub2ApiGroup(groupName) {
  ...
  const nextGroups = currentGroups.filter(
    (name) => name.toLowerCase() !== targetKey
  )
  ...
  const nextSelectedGroup =
    currentGroup.toLowerCase() === targetKey
      ? nextGroups[0]
      : nextGroups.find(
          (name) => name.toLowerCase() === currentGroup.toLowerCase()
        ) || nextGroups[0]
...
function updatePanelModeUI() {
  const rawPanelMode = normalizePanelMode(
    selectPanelMode?.value || latestState?.panelMode || 'cpa'
  )
  const capabilityState =
    typeof resolveCurrentSidepanelCapabilities === 'function'
      ...
      : null
  const supportedPanelModes = Array.isArray(
  ...
  const step9Btn = document.querySelector(
    '.step-btn[data-step-key="platform-verify"]'
  )
  if (step9Btn) {
...
function updateButtonStates() {
  ...
  btnReset.disabled =
    anyRunning || autoScheduled || isAutoRunPausedPhase() || autoLocked
  ...
  if (btnIcloudDeleteUsed)
    btnIcloudDeleteUsed.disabled =
      disableIcloudControls || !hasDeletableUsedIcloudAliases()
  if (selectIcloudHostPreference)
    selectIcloudHostPreference.disabled = disableIcloudControls
  if (
    typeof selectIcloudTargetMailboxType !== 'undefined' &&
  ...
  if (
    ...
    const allowIcloudForwardMailProvider =
      isIcloudMailProvider() &&
      normalizedIcloudTargetMailboxType === 'forward-mailbox'
    selectIcloudForwardMailProvider.disabled =
      disableIcloudControls || !allowIcloudForwardMailProvider
  }
  if (selectIcloudFetchMode) {
    const allowIcloudFetchMode =
      getSelectedEmailGenerator() === ICLOUD_PROVIDER &&
      !isCustomMailProvider() &&
      !isManagedAliasProvider()
    selectIcloudFetchMode.disabled =
      disableIcloudControls || !allowIcloudFetchMode
  }
  if (checkboxAutoDeleteIcloud)
    checkboxAutoDeleteIcloud.disabled = disableIcloudControls
  if (btnContributionMode)
    btnContributionMode.disabled = isContributionButtonLocked()
  updateStopButtonState(
    anyRunning || autoScheduled || isAutoRunPausedPhase() || autoLocked
  )
  renderContributionMode()
...
function updateStatusDisplay(state) {
  ...
  if (countdown) {
    ...
    statusBar.classList.add(
      countdown.tone === 'scheduled' ? 'scheduled' : 'running'
    )
    return
  }
  ...
  const running = Object.entries(state.stepStatuses).find(
    ([, s]) => s === 'running'
  )
  if (running) {
  ...
  const failed = Object.entries(state.stepStatuses).find(
    ([, s]) => s === 'failed'
  )
  if (failed) {
  ...
  const stopped = Object.entries(state.stepStatuses).find(
    ([, s]) => s === 'stopped'
  )
  if (stopped) {
  ...
  if (lastCompleted === STEP_IDS[STEP_IDS.length - 1]) {
    displayStatus.textContent =
      state.stepStatuses[lastCompleted] === 'manual_completed' ||
      state.stepStatuses[lastCompleted] === 'skipped'
        ? '全部步骤已跳过/完成'
        : '全部步骤已完成'
...
async function fetchGeneratedEmail(options = {}) {
  ...
  try {
    ...
    showToast(
      `已${uiCopy.successVerb} ${uiCopy.label}：${response.email}`,
      'success',
      2500
    )
    ...
    if (showFailureToast) {
      showToast(
        `${uiCopy.label}${uiCopy.successVerb}失败：${err.message}`,
        'error'
      )
    }
    throw err
...
function syncPasswordVisibilityToggles(root = document) {
  root
    ...
    .forEach(syncPasswordVisibilityToggle)
}
...
const initHotmailListExpandedState =
  hotmailManager?.initHotmailListExpandedState || (() => {})
const renderHotmailAccounts =
  hotmailManager?.renderHotmailAccounts || (() => {})
...
const initMail2925ListExpandedState =
  mail2925Manager?.initMail2925ListExpandedState || (() => {})
const renderMail2925Accounts =
  mail2925Manager?.renderMail2925Accounts || (() => {})
...
const hasDeletableUsedIcloudAliases =
  icloudManager?.hasDeletableUsedAliases || (() => false)
const queueIcloudAliasRefresh =
  icloudManager?.queueIcloudAliasRefresh || (() => {})
const refreshIcloudAliases =
  icloudManager?.refreshIcloudAliases || (async () => {})
...
const queueLuckmailPurchaseRefresh =
  luckmailManager?.queueLuckmailPurchaseRefresh || (() => {})
const refreshLuckmailPurchases =
  luckmailManager?.refreshLuckmailPurchases || (async () => {})
const renderLuckmailPurchases =
  luckmailManager?.renderLuckmailPurchases || (() => {})
const resetLuckmailManager = luckmailManager?.reset || (() => {})
const bindLuckmailEvents = luckmailManager?.bindLuckmailEvents || (() => {})
bindLuckmailEvents()

const customEmailPoolManager =
  window.SidepanelCustomEmailPoolManager?.createCustomEmailPoolManager({
    dom: {
    ...
    state: {
      ...
      getCurrentEmail: () =>
        String(inputEmail?.value || latestState?.email || '')
          .trim()
          .toLowerCase(),
      isVisible: () =>
        Boolean(rowCustomEmailPool) &&
        rowCustomEmailPool.style.display !== 'none'
    },
    actions: {
...
const queueCustomEmailPoolRefresh =
  customEmailPoolManager?.queueCustomEmailPoolRefresh || (() => {})
const refreshCustomEmailPoolEntries =
  customEmailPoolManager?.refreshCustomEmailPoolEntries || (async () => {})
const renderCustomEmailPoolEntries =
  customEmailPoolManager?.renderCustomEmailPoolEntries || (() => {})
const resetCustomEmailPoolManager = customEmailPoolManager?.reset || (() => {})
const bindCustomEmailPoolEvents =
  customEmailPoolManager?.bindEvents || (() => {})
bindCustomEmailPoolEvents()

const accountRecordsManager =
  window.SidepanelAccountRecordsManager?.createAccountRecordsManager({
    state: {
      getLatestState: () => latestState,
      syncLatestState
    },
...
const contributionModeManager =
  window.SidepanelContributionMode?.createContributionModeManager({
    state: {
      getLatestState: () => latestState
    },
    dom: {
...
const bindContributionModeEvents =
  contributionModeManager?.bindEvents || (() => {})
  ...
  try {
    ...
    if (step === 3) {
      ...
      if (shouldExecuteStep3WithSignupPhoneIdentity(latestState)) {
        ...
        if (!emailPrefix) {
          showToast(
            selectMailProvider.value === GMAIL_PROVIDER
              ? '请先填写 Gmail 原邮箱。'
              : '请先填写 2925 邮箱前缀。',
            'warn'
          )
        ...
        if (!email) {
          if (isCustomMailProvider()) {
            showToast(
              '当前邮箱服务为自定义邮箱，请先填写注册邮箱后再执行第 3 步。',
              'warn'
            )
            return
          }
        ...
        if (
          !validateCurrentRegistrationEmail(email, { showToastOnFailure: true })
        ) {
          return
        }
        const response = await sendSidepanelMessage({
...
btnToggleVpsPassword.addEventListener('click', () => {
  inputVpsPassword.type =
    inputVpsPassword.type === 'password' ? 'text' : 'password'
  syncVpsPasswordToggleLabel()
})

btnToggleIpProxyApiUrl?.addEventListener('click', () => {
  inputIpProxyApiUrl.type =
    inputIpProxyApiUrl.type === 'password' ? 'text' : 'password'
  syncIpProxyApiUrlToggleLabel()
})

btnToggleIpProxyUsername?.addEventListener('click', () => {
  inputIpProxyUsername.type =
    inputIpProxyUsername.type === 'password' ? 'text' : 'password'
  syncIpProxyUsernameToggleLabel()
})

btnToggleIpProxyPassword?.addEventListener('click', () => {
  inputIpProxyPassword.type =
    inputIpProxyPassword.type === 'password' ? 'text' : 'password'
...
localCpaStep9ModeButtons.forEach((button) => {
  button.addEventListener('click', () => {
    ...
    if (
      getSelectedLocalCpaStep9Mode() === normalizeLocalCpaStep9Mode(nextMode)
    ) {
      return
    }
...
hotmailServiceModeButtons.forEach((button) => {
  button.addEventListener('click', () => {
    ...
    if (
      getSelectedHotmailServiceMode() === normalizeHotmailServiceMode(nextMode)
    ) {
      return
    }
...
btnStop.addEventListener('click', async () => {
  ...
  showToast(
    isAutoRunScheduledPhase() ? '正在取消倒计时计划...' : '正在停止当前流程...',
    'warn',
    2000
  )
})
...
async function startAutoRunFromCurrentSettings() {
  const initialLockedRunCount =
    typeof getLockedRunCountFromEmailPool === 'function'
      ? getLockedRunCountFromEmailPool()
      : 0
  const requestedTotalRuns =
    initialLockedRunCount > 0 ? initialLockedRunCount : getRunCountValue()
  ...
  try {
    ...
    console.warn(
      'Failed to refresh contribution content hint before auto run:',
      error
    )
  }
  ...
  if (autoRunStartValidation?.ok === false) {
    clearPendingAutoRunStartRunCount()
    throw new Error(
      autoRunStartValidation.errors?.[0]?.message ||
        '当前设置不支持启动自动流程。'
    )
  }
  ...
  const customEmailPoolEnabled =
    typeof usesCustomEmailPoolGenerator === 'function' &&
  ...
  const contributionNickname = String(
    inputContributionNickname?.value || ''
  ).trim()
...
btnReset.addEventListener('click', async () => {
  ...
  document
    ...
    .forEach((row) => (row.className = 'step-row'))
  document
    .querySelectorAll('.step-status')
...
;[inputLuckmailApiKey, inputLuckmailBaseUrl, inputLuckmailDomain].forEach(
  (input) => {
    input?.addEventListener('input', () => {
      markSettingsDirty(true)
      scheduleSettingsAutoSave()
...
btnGpcHelperBalance?.addEventListener('click', async () => {
  try {
    const response = await chrome.runtime.sendMessage({
      ...
      payload: {
        gopayHelperApiUrl:
          inputGpcHelperApi?.value || DEFAULT_GPC_HELPER_API_URL,
    ...
    const nextAutoModePermission = getGpcAutoModePermissionFromPayload(
      nextState.gopayHelperBalancePayload
    )
    const nextAutoModeDenied = nextAutoModePermission === false
    const nextAutoModeConfirmed =
      nextAutoModePermission === true || nextState.gopayHelperAutoModeEnabled
    const selectedModeBeforeBalanceState = getSelectedGpcHelperPhoneMode()
    syncLatestState(nextState)
    if (
      nextAutoModeDenied &&
      selectedModeBeforeBalanceState === GPC_HELPER_PHONE_MODE_AUTO
    ) {
      showToast(
        '当前 API Key 未开通自动模式，已保留当前选择；如需继续请手动切换到手动模式。',
        'warn'
      )
      ...
      showToast(
        'GPC 余额已更新，当前接口未返回自动模式权限，已保留所选模式。',
        'success'
      )
    }
    updatePlusModeUI()
...
selectMailProvider.addEventListener('change', async () => {
  ...
  if (
    ...
    if (!selectMail2925PoolAccount.value && getMail2925Accounts().length > 0) {
      selectMail2925PoolAccount.value = String(
        getMail2925Accounts()[0]?.id || ''
      )
    }
...
function syncCurrentIpProxyServiceProfileToLatestState() {
  ...
  const normalizedProfiles =
    typeof buildIpProxyServiceProfilesPatch === 'function'
  ...
  const currentProfile =
    typeof getIpProxyServiceProfile === 'function'
      ...
      : {
          ...
          accountList: normalizeIpProxyAccountList(
            inputIpProxyAccountList?.value || ''
          ),
          accountSessionPrefix: normalizeIpProxyAccountSessionPrefix(
            inputIpProxyAccountSessionPrefix?.value || ''
          ),
          accountLifeMinutes: normalizeIpProxyAccountLifeMinutes(
            inputIpProxyAccountLifeMinutes?.value || ''
          ),
          poolTargetCount: normalizeIpProxyPoolTargetCount(
            inputIpProxyPoolTargetCount?.value || '',
            20
          ),
          host: String(inputIpProxyHost?.value || '').trim(),
          port: String(
            normalizeIpProxyPort(inputIpProxyPort?.value || '') || ''
          ),
          protocol: normalizeIpProxyProtocol(
            selectIpProxyProtocol?.value || ''
          ),
...
selectIpProxyService?.addEventListener('change', () => {
  const previousService = normalizeIpProxyService(
    latestState?.ipProxyService || DEFAULT_IP_PROXY_SERVICE
  )
  ...
  if (typeof buildCurrentIpProxyServiceProfileFromInputs === 'function') {
    normalizedProfiles[previousService] =
  ...
  const nextProfile =
    typeof getIpProxyServiceProfile === 'function'
      ...
      : {
          mode:
            typeof normalizeIpProxyModeForCurrentRelease === 'function'
          ...
          accountList: normalizeIpProxyAccountList(
            latestState?.ipProxyAccountList || ''
          ),
          accountSessionPrefix: normalizeIpProxyAccountSessionPrefix(
            latestState?.ipProxyAccountSessionPrefix || ''
          ),
          accountLifeMinutes: normalizeIpProxyAccountLifeMinutes(
            latestState?.ipProxyAccountLifeMinutes || ''
          ),
          poolTargetCount: normalizeIpProxyPoolTargetCount(
            latestState?.ipProxyPoolTargetCount || '',
            20
          ),
          host: String(latestState?.ipProxyHost || '').trim(),
          port: String(
            normalizeIpProxyPort(latestState?.ipProxyPort || '') || ''
          ),
...
ipProxyModeButtons.forEach((button) => {
  button.addEventListener('click', () => {
    const nextMode = normalizeIpProxyMode(
      button.dataset.ipProxyMode || DEFAULT_IP_PROXY_MODE
    )
...
btnIpProxyRefresh?.addEventListener('click', async () => {
  try {
    const result =
      typeof runIpProxyActionWithLock === 'function'
...
btnIpProxyCheckIp?.addEventListener('click', async () => {
  try {
    ...
    showToast(
      `打开 IP 检测页失败：${err?.message || String(err || '未知错误')}`,
      'error'
    )
  }
})
...
btnTempEmailDomainMode.addEventListener('click', async () => {
  try {
    ...
    const newDomain = normalizeCloudflareTempEmailDomainValue(
      inputTempEmailDomain.value
    )
    if (!newDomain) {
    ...
    await saveCloudflareTempEmailDomainSettings(
      [...domains, newDomain],
      newDomain
    )
  } catch (err) {
...
inputSub2ApiAccountPriority.addEventListener('blur', () => {
  inputSub2ApiAccountPriority.value = String(
    normalizeSub2ApiAccountPriorityValue(inputSub2ApiAccountPriority.value)
  )
  saveSettings({ silent: true }).catch(() => {})
})
...
inputIpProxyAccountSessionPrefix?.addEventListener('input', () => {
  const syncResult =
    typeof sync711UsernameFromSessionFieldsForPanel === 'function'
...
inputIpProxyAccountSessionPrefix?.addEventListener('blur', () => {
  inputIpProxyAccountSessionPrefix.value = normalizeIpProxyAccountSessionPrefix(
    inputIpProxyAccountSessionPrefix.value || ''
  )
  const syncResult =
    typeof sync711UsernameFromSessionFieldsForPanel === 'function'
...
inputIpProxyAccountLifeMinutes?.addEventListener('blur', () => {
  inputIpProxyAccountLifeMinutes.value = normalizeIpProxyAccountLifeMinutes(
    inputIpProxyAccountLifeMinutes.value || ''
  )
  const syncResult =
    typeof sync711UsernameFromSessionFieldsForPanel === 'function'
...
inputIpProxyRegion?.addEventListener('input', () => {
  const normalizedRegion =
    typeof normalize711RegionCodeForPanel === 'function'
      ? normalize711RegionCodeForPanel(inputIpProxyRegion.value || '')
      : String(inputIpProxyRegion.value || '')
          .trim()
          .toUpperCase()
  if (normalizedRegion) {
  ...
  const syncResult =
    typeof sync711UsernameFromRegionForPanel === 'function'
...
inputIpProxyPoolTargetCount?.addEventListener('blur', () => {
  inputIpProxyPoolTargetCount.value = normalizeIpProxyPoolTargetCount(
    inputIpProxyPoolTargetCount.value || '',
    20
  )
  saveSettings({ silent: true }).catch(() => {})
...
inputIpProxyAutoSyncIntervalMinutes?.addEventListener('blur', () => {
  const numeric = Number.parseInt(
    String(inputIpProxyAutoSyncIntervalMinutes.value || '').trim(),
    10
  )
...
inputCustomEmailPool?.addEventListener('blur', () => {
  inputCustomEmailPool.value = normalizeCustomEmailPoolEntries(
    inputCustomEmailPool.value
  ).join('\n')
  syncRunCountFromConfiguredEmailPool()
  updateMailProviderUI()
  saveSettings({ silent: true }).catch(() => {})
...
inputCustomMailProviderPool?.addEventListener('blur', () => {
  inputCustomMailProviderPool.value = normalizeCustomEmailPoolEntries(
    inputCustomMailProviderPool.value
  ).join('\n')
  syncRunCountFromConfiguredEmailPool()
  updateMailProviderUI()
  saveSettings({ silent: true }).catch(() => {})
...
inputTempEmailBaseUrl.addEventListener('blur', () => {
  inputTempEmailBaseUrl.value = normalizeCloudflareTempEmailBaseUrlValue(
    inputTempEmailBaseUrl.value
  )
  saveSettings({ silent: true }).catch(() => {})
})
...
function getPhoneSmsCountrySelectionForProvider(
  ...
  const defaultCountry =
    normalizedProvider === PHONE_SMS_PROVIDER_FIVE_SIM
      ? {
          id: DEFAULT_FIVE_SIM_COUNTRY_ID,
          label: DEFAULT_FIVE_SIM_COUNTRY_LABEL
        }
  ...
  const optionByValue = new Map(
    Array.from(countrySelect.options || []).map((option) => [
      String(option.value),
      option
    ])
  )
  const selectedIds = Array.from(countrySelect.options || [])
    .filter((option) => option.selected)
    .map((option) =>
      normalizePhoneSmsCountryId(option.value, normalizedProvider)
    )
    .filter(Boolean)
  ...
  return orderedIds.slice(0, selectionLimit).map((id) => {
    ...
    return {
      ...
      label:
        optionLabel ||
        normalizePhoneSmsCountryLabel(
          defaultCountry.id === id ? defaultCountry.label : '',
          normalizedProvider
        )
    }
  })
...
async function switchPhoneSmsProvider(nextProvider) {
  ...
  const currentSelection =
    typeof getPhoneSmsCountrySelectionForProvider === 'function'
      ? getPhoneSmsCountrySelectionForProvider(previousProvider, {
          ensureDefault: true
        })
      : []
  const currentPrimary =
    currentSelection[0] || getSelectedHeroSmsCountryOption()
  ...
  const restoredPrimary =
    normalizedNextProvider === PHONE_SMS_PROVIDER_FIVE_SIM
      ? {
          id: normalizeFiveSimCountryId(latestState?.fiveSimCountryId),
          label: normalizeFiveSimCountryLabel(latestState?.fiveSimCountryLabel)
        }
  ...
  applyHeroSmsFallbackSelection([restoredPrimary, ...restoredFallback], {
    includePrimary: true
  })
  updatePhoneVerificationSettingsUI()
  markSettingsDirty(true)
...
selectPhoneSmsProvider?.addEventListener('change', async () => {
  ...
  if (selectPhoneSmsProvider?.value === PHONE_SMS_PROVIDER_FIVE_SIM) {
    ...
    const nextPrimaryCountries =
      nextPrimaryCountryId > 0
        ? [
            {
    ...
    applyHeroSmsFallbackSelection(
      [
        ...
        ...normalizeHeroSmsCountryFallbackList(
          Array.isArray(latestState?.heroSmsCountryFallback)
            ? latestState.heroSmsCountryFallback
            : []
        )
      ],
...
inputFiveSimOperator?.addEventListener('blur', () => {
  inputFiveSimOperator.value = normalizeFiveSimOperatorValue(
    inputFiveSimOperator.value
  )
  saveSettings({ silent: true }).catch(() => {})
})
...
inputFiveSimProduct?.addEventListener('blur', () => {
  inputFiveSimProduct.value = normalizeFiveSimProductValue(
    inputFiveSimProduct.value
  )
  updateHeroSmsPlatformDisplay()
  saveSettings({ silent: true }).catch(() => {})
...
inputSmsbowerBaseUrl?.addEventListener('input', () => {
  markSettingsDirty(true)
  scheduleSettingsAutoSave()
})
inputSmsbowerBaseUrl?.addEventListener('blur', () => {
  inputSmsbowerBaseUrl.value = normalizeSmsbowerBaseUrlValue(
    inputSmsbowerBaseUrl.value
  )
  saveSettings({ silent: true }).catch(() => {})
...
inputSmsbowerMaxPrice?.addEventListener('input', () => {
  markSettingsDirty(true)
})
inputSmsbowerMaxPrice?.addEventListener('blur', () => {
  inputSmsbowerMaxPrice.value = normalizeSmsbowerMaxPriceValue(
    inputSmsbowerMaxPrice.value
  )
  saveSettings({ silent: true }).catch(() => {})
})
...
btnSaveFreeReusablePhone?.addEventListener('click', async () => {
  ...
  try {
    ...
    showToast?.(
      `记录白嫖复用手机号失败：${error?.message || error}`,
      'error',
      4000
    )
  }
...
btnClearFreeReusablePhone?.addEventListener('click', async () => {
  try {
    ...
    showToast?.(
      `清除白嫖复用手机号失败：${error?.message || error}`,
      'error',
      4000
    )
  }
...
selectHeroSmsAcquirePriority?.addEventListener('change', () => {
  selectHeroSmsAcquirePriority.value = normalizeHeroSmsAcquirePriority(
    selectHeroSmsAcquirePriority.value
  )
  markSettingsDirty(true)
  saveSettings({ silent: true }).catch(() => {})
})
...
btnHeroSmsCountryMenu?.addEventListener('click', (event) => {
  event.preventDefault()
  const nextOpen =
    btnHeroSmsCountryMenu.getAttribute('aria-expanded') !== 'true'
...
btnFiveSimCountryMenu?.addEventListener('click', (event) => {
  event.preventDefault()
  const nextOpen =
    btnFiveSimCountryMenu.getAttribute('aria-expanded') !== 'true'
...
btnPhoneSmsProviderOrderMenu?.addEventListener('click', (event) => {
  event.preventDefault()
  const nextOpen =
    btnPhoneSmsProviderOrderMenu.getAttribute('aria-expanded') !== 'true'
  ...
  switch (message.type) {
    ...
    case 'SECURITY_BLOCKED_ALERT': {
      openConfirmModal({
        ...
        message:
          message.payload?.message || '检测到安全风控，当前流程已完全停止。',
        alert: message.payload?.alert || {
          text: '检测到 Cloudflare 风控，请暂停当前操作。',
          tone: 'danger'
        },
        confirmLabel: '我知道了',
        confirmVariant: 'btn-danger'
    ...
    case 'DATA_UPDATED': {
      ...
      if (
        message.payload.operationDelayEnabled !== undefined &&
        typeof applyOperationDelayState === 'function'
      ) {
      ...
      if (
        ...
        if (typeof buildIpProxyServiceProfileFromFlatState === 'function') {
          normalizedProxyProfiles[selectedProxyService] =
            buildIpProxyServiceProfileFromFlatState(mergedProxyState)
        }
        ...
        if (
          ...
          inputIpProxyAutoSyncEnabled.checked = Boolean(
            message.payload.ipProxyAutoSyncEnabled
          )
        }
        if (
          message.payload.ipProxyAutoSyncIntervalMinutes !== undefined &&
          ...
          const numeric = Number.parseInt(
            String(message.payload.ipProxyAutoSyncIntervalMinutes ?? '').trim(),
            10
          )
          inputIpProxyAutoSyncIntervalMinutes.value = String(
        ...
        if (message.payload.ipProxyApiUrl !== undefined && inputIpProxyApiUrl) {
          inputIpProxyApiUrl.value = String(
            message.payload.ipProxyApiUrl || ''
          ).trim()
        }
        if (hasIpProxyConfigPayload) {
          const activeProxyProfile =
            typeof getIpProxyServiceProfile === 'function'
              ...
              : {
                  mode:
                    typeof normalizeIpProxyModeForCurrentRelease === 'function'
                      ? normalizeIpProxyModeForCurrentRelease(
                          mergedProxyState?.ipProxyMode
                        )
                      : normalizeIpProxyMode(mergedProxyState?.ipProxyMode),
                  apiUrl: String(mergedProxyState?.ipProxyApiUrl || '').trim(),
                  accountList: normalizeIpProxyAccountList(
                    mergedProxyState?.ipProxyAccountList || ''
                  ),
                  accountSessionPrefix: normalizeIpProxyAccountSessionPrefix(
                    mergedProxyState?.ipProxyAccountSessionPrefix || ''
                  ),
                  accountLifeMinutes: normalizeIpProxyAccountLifeMinutes(
                    mergedProxyState?.ipProxyAccountLifeMinutes || ''
                  ),
                  poolTargetCount: normalizeIpProxyPoolTargetCount(
                    mergedProxyState?.ipProxyPoolTargetCount || '',
                    20
                  ),
                  host: String(mergedProxyState?.ipProxyHost || '').trim(),
                  port: String(
                    normalizeIpProxyPort(mergedProxyState?.ipProxyPort || '') ||
                      ''
                  ),
                  protocol: normalizeIpProxyProtocol(
                    mergedProxyState?.ipProxyProtocol
                  ),
                  username: String(
                    mergedProxyState?.ipProxyUsername || ''
                  ).trim(),
          ...
          if (typeof applyIpProxyServiceProfileToInputs === 'function') {
            ...
            if (inputIpProxyApiUrl)
              inputIpProxyApiUrl.value = String(
                activeProxyProfile.apiUrl || ''
              ).trim()
            if (inputIpProxyAccountList)
              inputIpProxyAccountList.value = activeProxyProfile.accountList
            if (inputIpProxyAccountSessionPrefix)
              inputIpProxyAccountSessionPrefix.value =
                activeProxyProfile.accountSessionPrefix
            if (inputIpProxyAccountLifeMinutes)
              inputIpProxyAccountLifeMinutes.value =
                activeProxyProfile.accountLifeMinutes
            if (inputIpProxyPoolTargetCount)
              inputIpProxyPoolTargetCount.value =
                activeProxyProfile.poolTargetCount
            if (inputIpProxyHost)
              inputIpProxyHost.value = activeProxyProfile.host
            if (inputIpProxyPort)
              inputIpProxyPort.value = activeProxyProfile.port
            if (selectIpProxyProtocol)
              selectIpProxyProtocol.value = normalizeIpProxyProtocol(
                activeProxyProfile.protocol
              )
            if (inputIpProxyUsername)
              inputIpProxyUsername.value = activeProxyProfile.username
            if (inputIpProxyPassword)
              inputIpProxyPassword.value = activeProxyProfile.password
            if (inputIpProxyRegion)
              inputIpProxyRegion.value = activeProxyProfile.region
          }
          syncLatestState({
            ipProxyService: selectedProxyService,
            ipProxyServiceProfiles: normalizedProxyProfiles,
      ...
      if (message.payload.oauthUrl !== undefined) {
        ...
        displayOauthUrl.classList.toggle(
          'has-value',
          Boolean(message.payload.oauthUrl)
        )
      }
      if (message.payload.localhostUrl !== undefined) {
        displayLocalhostUrl.textContent =
          message.payload.localhostUrl || '等待中...'
        displayLocalhostUrl.classList.toggle(
          'has-value',
          Boolean(message.payload.localhostUrl)
        )
      }
      if (message.payload.cloudflareTempEmailBaseUrl !== undefined) {
        inputTempEmailBaseUrl.value =
          message.payload.cloudflareTempEmailBaseUrl || ''
      }
      if (message.payload.cloudflareTempEmailAdminAuth !== undefined) {
        inputTempEmailAdminAuth.value =
          message.payload.cloudflareTempEmailAdminAuth || ''
      }
      if (message.payload.cloudflareTempEmailCustomAuth !== undefined) {
        inputTempEmailCustomAuth.value =
          message.payload.cloudflareTempEmailCustomAuth || ''
      }
      if (message.payload.cloudflareTempEmailReceiveMailbox !== undefined) {
        inputTempEmailReceiveMailbox.value =
          message.payload.cloudflareTempEmailReceiveMailbox || ''
      }
      if (
      ...
      if (
        ...
        renderCloudflareTempEmailDomainOptions(
          message.payload.cloudflareTempEmailDomain ||
            latestState?.cloudflareTempEmailDomain ||
            ''
        )
      }
      ...
      if (
        message.payload.cloudMailBaseUrl !== undefined &&
        inputCloudMailBaseUrl
      ) {
        inputCloudMailBaseUrl.value = message.payload.cloudMailBaseUrl || ''
      }
      if (
        message.payload.cloudMailAdminEmail !== undefined &&
        inputCloudMailAdminEmail
      ) {
        inputCloudMailAdminEmail.value =
          message.payload.cloudMailAdminEmail || ''
      }
      if (
        message.payload.cloudMailAdminPassword !== undefined &&
        inputCloudMailAdminPassword
      ) {
        inputCloudMailAdminPassword.value =
          message.payload.cloudMailAdminPassword || ''
      }
      if (
        message.payload.cloudMailReceiveMailbox !== undefined &&
        inputCloudMailReceiveMailbox
      ) {
        inputCloudMailReceiveMailbox.value =
          message.payload.cloudMailReceiveMailbox || ''
      }
      if (
        message.payload.cloudMailDomain !== undefined &&
      ...
      if (
        ...
        selectPlusPaymentMethod.value = normalizePlusPaymentMethod(
          message.payload.plusPaymentMethod
        )
      }
      if (
        ...
        selectGpcHelperPhoneMode.value = normalizeGpcHelperPhoneModeValue(
          message.payload.gopayHelperPhoneMode
        )
      }
      if (
        ...
        selectGpcHelperOtpChannel.value = normalizeGpcOtpChannelValue(
          message.payload.gopayHelperOtpChannel
        )
      }
      if (
        ...
        inputGpcHelperLocalSmsEnabled.checked = Boolean(
          message.payload.gopayHelperLocalSmsHelperEnabled
        )
      }
      if (
        message.payload.gopayHelperLocalSmsHelperUrl !== undefined &&
        inputGpcHelperLocalSmsUrl
      ) {
        inputGpcHelperLocalSmsUrl.value =
          normalizeGpcLocalSmsHelperBaseUrlValue(
            message.payload.gopayHelperLocalSmsHelperUrl
          )
      }
      if (
        message.payload.gopayHelperBalance !== undefined ||
        message.payload.gopayHelperBalanceError !== undefined
      ) {
        if (
          typeof displayGpcHelperBalance !== 'undefined' &&
          displayGpcHelperBalance
          ...
          const balanceText = String(
            message.payload.gopayHelperBalance ??
              latestState?.gopayHelperBalance ??
              ''
          ).trim()
          const balanceError = String(
            message.payload.gopayHelperBalanceError ??
              latestState?.gopayHelperBalanceError ??
              ''
          ).trim()
          displayGpcHelperBalance.textContent = balanceError
            ? `余额查询失败：${balanceError}`
        ...
        const stepDefinitionState =
          typeof resolveStepDefinitionCapabilityState === 'function'
            ...
            : {
                ...
                signupMethod: normalizeSignupMethod(
                  latestState?.signupMethod || DEFAULT_SIGNUP_METHOD
                )
              }
        syncStepDefinitionsForMode(
          stepDefinitionState.plusModeEnabled,
      ...
      if (
        message.payload.currentPayPalAccountId !== undefined ||
        message.payload.paypalAccounts !== undefined
      ) {
        renderPayPalAccounts()
      }
      if (
        message.payload.currentMail2925AccountId !== undefined ||
        message.payload.mail2925Accounts !== undefined
      ) {
        renderMail2925Accounts()
      ...
      if (
        message.payload.customEmailPoolEntries !== undefined ||
        message.payload.customEmailPool !== undefined
      ) {
      ...
      if (message.payload.luckmailBaseUrl !== undefined) {
        inputLuckmailBaseUrl.value = normalizeLuckmailBaseUrl(
          message.payload.luckmailBaseUrl
        )
      }
      if (message.payload.luckmailEmailType !== undefined) {
        selectLuckmailEmailType.value = normalizeLuckmailEmailType(
          message.payload.luckmailEmailType
        )
      }
      ...
      if (
        message.payload.luckmailUsedPurchases !== undefined &&
        isLuckmailProvider()
      ) {
        queueLuckmailPurchaseRefresh()
      }
      if (
        message.payload.currentLuckmailPurchase !== undefined &&
        isLuckmailProvider()
      ) {
        inputEmail.value = getCurrentLuckmailEmail()
        queueLuckmailPurchaseRefresh()
      ...
      if (
        message.payload.autoDeleteUsedIcloudAlias !== undefined &&
        checkboxAutoDeleteIcloud
      ) {
        checkboxAutoDeleteIcloud.checked = Boolean(
          message.payload.autoDeleteUsedIcloudAlias
        )
      }
      if (
        message.payload.accountRunHistoryHelperBaseUrl !== undefined &&
        inputAccountRunHistoryHelperBaseUrl
      ) {
        inputAccountRunHistoryHelperBaseUrl.value =
          normalizeAccountRunHistoryHelperBaseUrlValue(
            message.payload.accountRunHistoryHelperBaseUrl
          )
        updateAccountRunHistorySettingsUI()
      }
      if (
        message.payload.icloudHostPreference !== undefined &&
        selectIcloudHostPreference
      ) {
        const hostPreference = String(
          message.payload.icloudHostPreference || ''
        )
          .trim()
          .toLowerCase()
        selectIcloudHostPreference.value =
          hostPreference === 'icloud.com'
            ? 'icloud.com'
            : hostPreference === 'icloud.com.cn'
              ? 'icloud.com.cn'
              : 'auto'
        updateMailProviderUI()
      }
      if (
        message.payload.icloudTargetMailboxType !== undefined &&
        selectIcloudTargetMailboxType
      ) {
        selectIcloudTargetMailboxType.value = normalizeIcloudTargetMailboxType(
          message.payload.icloudTargetMailboxType
        )
        updateMailProviderUI()
      }
      if (
        message.payload.icloudForwardMailProvider !== undefined &&
        selectIcloudForwardMailProvider
      ) {
        selectIcloudForwardMailProvider.value =
          normalizeIcloudForwardMailProvider(
            message.payload.icloudForwardMailProvider
          )
        updateMailProviderUI()
      }
      if (
        message.payload.icloudFetchMode !== undefined &&
        selectIcloudFetchMode
      ) {
        selectIcloudFetchMode.value = normalizeIcloudFetchMode(
          message.payload.icloudFetchMode
        )
      }
      if (message.payload.autoRunSkipFailures !== undefined) {
        inputAutoSkipFailures.checked = Boolean(
          message.payload.autoRunSkipFailures
        )
        updateFallbackThreadIntervalInputState()
      }
      if (message.payload.autoRunDelayEnabled !== undefined) {
        inputAutoDelayEnabled.checked = Boolean(
          message.payload.autoRunDelayEnabled
        )
        updateAutoDelayInputState()
      }
      if (
        ...
        inputStep6CookieCleanupEnabled.checked = Boolean(
          message.payload.step6CookieCleanupEnabled
        )
      }
      if (message.payload.autoRunDelayMinutes !== undefined) {
        inputAutoDelayMinutes.value = String(
          normalizeAutoDelayMinutes(message.payload.autoRunDelayMinutes)
        )
      }
      if (message.payload.autoRunFallbackThreadIntervalMinutes !== undefined) {
        inputAutoSkipFailuresThreadIntervalMinutes.value = String(
          normalizeAutoRunThreadIntervalMinutes(
            message.payload.autoRunFallbackThreadIntervalMinutes
          )
        )
        updateFallbackThreadIntervalInputState()
      }
      if (message.payload.autoStepDelaySeconds !== undefined) {
        inputAutoStepDelaySeconds.value = formatAutoStepDelayInputValue(
          message.payload.autoStepDelaySeconds
        )
      }
      if (
        message.payload.oauthFlowTimeoutEnabled !== undefined &&
        typeof inputOAuthFlowTimeoutEnabled !== 'undefined' &&
        inputOAuthFlowTimeoutEnabled
      ) {
        inputOAuthFlowTimeoutEnabled.checked = Boolean(
          message.payload.oauthFlowTimeoutEnabled
        )
      }
      if (
        ...
        const nextVerificationResendCount =
          message.payload.verificationResendCount !== undefined
            ? message.payload.verificationResendCount
            : (message.payload.signupVerificationResendCount ??
              message.payload.loginVerificationResendCount)
        inputVerificationResendCount.value = String(
          normalizeVerificationResendCount(
      ...
      if (
        ...
        inputHeroSmsApiKey.value =
          getSelectedPhoneSmsProvider() === PHONE_SMS_PROVIDER_FIVE_SIM
            ? message.payload.fiveSimApiKey !== undefined
              ? message.payload.fiveSimApiKey || ''
              : latestState?.fiveSimApiKey || ''
            : message.payload.heroSmsApiKey !== undefined
              ? message.payload.heroSmsApiKey || ''
              : latestState?.heroSmsApiKey || ''
      }
      if (message.payload.fiveSimApiKey !== undefined && inputFiveSimApiKey) {
        inputFiveSimApiKey.value = String(
          message.payload.fiveSimApiKey || ''
        ).trim()
      }
      if (message.payload.nexSmsApiKey !== undefined && inputNexSmsApiKey) {
        inputNexSmsApiKey.value = String(
          message.payload.nexSmsApiKey || ''
        ).trim()
      }
      if (
        message.payload.fiveSimCountryOrder !== undefined &&
        typeof applyFiveSimCountrySelection === 'function'
      ) {
        applyFiveSimCountrySelection(
          Array.isArray(message.payload.fiveSimCountryOrder)
      ...
      if (
        ...
        typeof applyNexSmsCountrySelection === 'function'
      ) {
        applyNexSmsCountrySelection(
          Array.isArray(message.payload.nexSmsCountryOrder)
            ? message.payload.nexSmsCountryOrder
            : []
        )
      }
      if (
        message.payload.fiveSimOperator !== undefined &&
        inputFiveSimOperator
      ) {
        inputFiveSimOperator.value = normalizeFiveSimOperatorValue(
          message.payload.fiveSimOperator
        )
      }
      if (message.payload.fiveSimProduct !== undefined && inputFiveSimProduct) {
        inputFiveSimProduct.value = normalizeFiveSimProductValue(
          message.payload.fiveSimProduct
        )
      }
      if (
        message.payload.nexSmsServiceCode !== undefined &&
        inputNexSmsServiceCode
      ) {
        inputNexSmsServiceCode.value = normalizeNexSmsServiceCodeValue(
          message.payload.nexSmsServiceCode
        )
      }
      if (message.payload.smsbowerApiKey !== undefined && inputSmsbowerApiKey) {
        inputSmsbowerApiKey.value = String(message.payload.smsbowerApiKey || '')
      }
      if (message.payload.smsbowerBaseUrl !== undefined && inputSmsbowerBaseUrl) {
        inputSmsbowerBaseUrl.value = normalizeSmsbowerBaseUrlValue(
          message.payload.smsbowerBaseUrl || DEFAULT_SMSBOWER_BASE_URL
        )
      }
      if (
        ...
        inputSmsbowerCountryOrder.value = formatSmsbowerCountryOrderValue(
          message.payload.smsbowerCountryOrder || DEFAULT_SMSBOWER_COUNTRY_ORDER
        )
      }
      if (
        message.payload.smsbowerServiceCode !== undefined &&
        inputSmsbowerServiceCode
      ) {
        inputSmsbowerServiceCode.value = normalizeSmsbowerServiceCodeValue(
          message.payload.smsbowerServiceCode || DEFAULT_SMSBOWER_SERVICE_CODE
        )
      }
      if (message.payload.smsbowerMaxPrice !== undefined && inputSmsbowerMaxPrice) {
        inputSmsbowerMaxPrice.value = normalizeSmsbowerMaxPriceValue(
          message.payload.smsbowerMaxPrice || ''
        )
      }
      if (
      ...
      if (
        message.payload.freePhoneReuseEnabled !== undefined &&
        inputFreePhoneReuseEnabled
      ) {
      ...
      if (
        ...
        selectHeroSmsAcquirePriority.value = normalizeHeroSmsAcquirePriority(
          message.payload.heroSmsAcquirePriority
        )
      }
      if (
        ...
        inputHeroSmsMaxPrice.value =
          getSelectedPhoneSmsProvider() === PHONE_SMS_PROVIDER_FIVE_SIM
            ? normalizeFiveSimMaxPriceValue(
                message.payload.fiveSimMaxPrice !== undefined
                  ? message.payload.fiveSimMaxPrice
                  : latestState?.fiveSimMaxPrice
              )
            : normalizeHeroSmsMaxPriceValue(
                message.payload.heroSmsMaxPrice !== undefined
                  ? message.payload.heroSmsMaxPrice
                  : latestState?.heroSmsMaxPrice
              )
      }
      if (
      ...
      if (
        ...
        inputHeroSmsPreferredPrice.value = normalizeHeroSmsMaxPriceValue(
          message.payload.heroSmsPreferredPrice
        )
      }
      if (
        message.payload.phoneVerificationReplacementLimit !== undefined &&
        typeof inputPhoneReplacementLimit !== 'undefined' &&
        inputPhoneReplacementLimit
      ) {
        inputPhoneReplacementLimit.value = String(
      ...
      if (
        message.payload.phoneCodeWaitSeconds !== undefined &&
        inputPhoneCodeWaitSeconds
      ) {
        inputPhoneCodeWaitSeconds.value = String(
          normalizePhoneCodeWaitSecondsValue(
            message.payload.phoneCodeWaitSeconds,
            DEFAULT_PHONE_CODE_WAIT_SECONDS
          )
        )
      }
      if (
        message.payload.phoneCodeTimeoutWindows !== undefined &&
        inputPhoneCodeTimeoutWindows
      ) {
        inputPhoneCodeTimeoutWindows.value = String(
          normalizePhoneCodeTimeoutWindowsValue(
            message.payload.phoneCodeTimeoutWindows,
            DEFAULT_PHONE_CODE_TIMEOUT_WINDOWS
          )
        )
      }
      if (
        message.payload.phoneCodePollIntervalSeconds !== undefined &&
        inputPhoneCodePollIntervalSeconds
      ) {
        inputPhoneCodePollIntervalSeconds.value = String(
          normalizePhoneCodePollIntervalSecondsValue(
      ...
      if (
        message.payload.phoneCodePollMaxRounds !== undefined &&
        inputPhoneCodePollMaxRounds
      ) {
        inputPhoneCodePollMaxRounds.value = String(
          normalizePhoneCodePollMaxRoundsValue(
            message.payload.phoneCodePollMaxRounds,
            DEFAULT_PHONE_CODE_POLL_MAX_ROUNDS
          )
        )
      }
      ...
      if (
        ...
        inputPhoneVerificationEnabled.checked = Boolean(
          message.payload.phoneVerificationEnabled
        )
      }
      ...
      if (activePhoneSmsProvider === PHONE_SMS_PROVIDER_FIVE_SIM) {
        ...
        const nextPrimary =
          activeProvider === PHONE_SMS_PROVIDER_FIVE_SIM
            ? {
                id: normalizeFiveSimCountryId(
                  message.payload.fiveSimCountryId !== undefined
        ...
        applyHeroSmsFallbackSelection([nextPrimary, ...nextFallback], {
          includePrimary: true
        })
        updateHeroSmsPlatformDisplay()
      }
      if (
        ...
        message.payload.currentPhoneVerificationCountdownWindowIndex !==
          undefined ||
        message.payload.currentPhoneVerificationCountdownWindowTotal !==
          undefined ||
    ...
    case 'AUTO_RUN_STATUS': {
      syncLatestState({
        autoRunning: [
          ...
          'retrying',
          'waiting_interval'
        ].includes(message.payload.phase),
...
document.addEventListener('click', (event) => {
  const clickedInsideConfigMenu = Boolean(
    configMenuShell?.contains(event.target)
  )
  const clickedInsideCountryMenu = Boolean(
    heroSmsCountryMenuShell?.contains(event.target)
  )
  const clickedInsideFiveSimCountryMenu = Boolean(
    fiveSimCountryMenuShell?.contains(event.target)
  )
  const clickedInsideNexSmsCountryMenu = Boolean(
    nexSmsCountryMenuShell?.contains(event.target)
  )
  const clickedInsideProviderOrderMenu = Boolean(
    phoneSmsProviderOrderMenuShell?.contains(event.target)
  )
  const clickedInsideEditableListPicker = isClickInsideEditableListPicker(
    event.target
  )
  ...
  const countryMenuOpen =
    btnHeroSmsCountryMenu?.getAttribute('aria-expanded') === 'true'
  if (countryMenuOpen && !clickedInsideCountryMenu) {
    setHeroSmsCountryMenuOpen(false)
  }
  const fiveSimCountryMenuOpen =
    btnFiveSimCountryMenu?.getAttribute('aria-expanded') === 'true'
  if (fiveSimCountryMenuOpen && !clickedInsideFiveSimCountryMenu) {
    setFiveSimCountryMenuOpen(false)
  }
  const nexSmsCountryMenuOpen =
    btnNexSmsCountryMenu?.getAttribute('aria-expanded') === 'true'
  if (nexSmsCountryMenuOpen && !clickedInsideNexSmsCountryMenu) {
    setNexSmsCountryMenuOpen(false)
  }
  const providerOrderMenuOpen =
    btnPhoneSmsProviderOrderMenu?.getAttribute('aria-expanded') === 'true'
  ...
  return restoreState()
    .then(() => {
      ...
      return refreshContributionContentHint()
        .catch((error) => {
          console.warn(
            'Failed to refresh contribution content hint during initialization:',
            error
          )
          return null
        })
